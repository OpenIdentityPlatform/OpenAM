...
/**
 * <code>PWResetSuccessModel</code> defines a set of methods that are required
 * by password reset success message.
 */
public interface PPResetSuccessModel extends PPResetModel {
	/**
