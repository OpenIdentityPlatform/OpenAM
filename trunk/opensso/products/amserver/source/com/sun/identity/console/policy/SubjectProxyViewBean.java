 ...
 *
 * $Id: SubjectProxyViewBean.java,v 1.2 2008/06/25 05:43:06 qcheng Exp $
 *
 */
...
public class SubjectProxyViewBean
    extends AMViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/policy/SubjectProxy.jsp";
    ...
    public View createChild(String name) {
        ...
        if (name.equals(TF_URL) ||
            name.equals(TF_OP) ||
            name.equals(TF_SUBJECT_TYPE_NAME) ||
            name.equals(TF_SUBJECT_NAME) ||
