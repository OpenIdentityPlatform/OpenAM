<%--
   ...
   $Id: RealmResourceOfferingAdd.jsp,v 1.3 2008/06/25 05:44:48 qcheng Exp $
...
<%@ page info="RealmResourceOfferingAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.realm.RealmResourceOfferingAddViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('RealmResourceOfferingAdd',
	    'RealmResourceOfferingAdd.SecurityMechID',
	    'securityMechIDCount',
	    'RealmResourceOfferingAdd.tblSecurityMechIDButtonDelete',
	    obj);
    }
</script>

<cc:form name="RealmResourceOfferingAdd" method="post" defaultCommandChild="/button1" >
