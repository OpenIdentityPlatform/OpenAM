...
public class AMSessionRepositoryEncodingTest {
    ...
    public void testEncoding() throws Exception {
        ...
        MockInternalSession mockInternalSession = new MockInternalSession();
        mockInternalSession.setAmRecord(new AMRecord());
        //mockInternalSession.setFamRecord(new FAMRecord());
