 ...
 * <br/>
 * This allows for multiple Scope implementations to be configured for a single OAuth2 Provider server.
...
public interface ScopeFactory {
    ...
    /**
     * Gets the Scope instance based on the content of the specified context map.
     *
     ...
     */
    Scope create(@Assisted("context") Map<String, Object> context);
}
