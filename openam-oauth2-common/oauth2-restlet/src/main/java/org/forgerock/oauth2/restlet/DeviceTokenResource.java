...
public class DeviceTokenResource extends ServerResource {
    ...
    @Post
    public Representation issueTokens() throws BadRequestException, NotFoundException, InvalidClientException,
            ServerException, InvalidGrantException, ExpiredTokenException, AuthorizationDeclinedException, AuthorizationPendingException {
