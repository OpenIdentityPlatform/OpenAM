 ...
 *
 * $Id: BankingViewSubject.java,v 1.3 2009/07/31 21:53:48 farble1670 Exp $
 */
...
public class BankingViewSubject extends ViewSubject {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof BankingViewSubject)) {
            return false;
        }
        BankingViewSubject bvs = (BankingViewSubject)o;
        return bvs.getName().equals(getName());
    }
