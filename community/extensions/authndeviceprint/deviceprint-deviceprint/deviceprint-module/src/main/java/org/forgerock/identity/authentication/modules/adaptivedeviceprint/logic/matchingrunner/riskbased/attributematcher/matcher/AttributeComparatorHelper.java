...
public final class AttributeComparatorHelper {
	
	private AttributeComparatorHelper() {
		super();
	}

	public static ComparisonResult compareAttribute(Object currentValue, Object storedValue, Long differencePenaltyPoints) {
		if(storedValue != null) {
