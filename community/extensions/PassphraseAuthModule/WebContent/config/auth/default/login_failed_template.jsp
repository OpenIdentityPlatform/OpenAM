					...
					<div id="inner">						
						<div id="logo"><a href="/"><img src="<%=serviceURL%>/images/logo150.gif" alt=". Logo" /></a></div>			
							<div id="messagebox">
								<div id="message">
									<div class="indented">
										<span id="title"><auth:resBundle bundleName="amAuthUI" resourceKey="auth.failed" /></span>
										<!-- warning message -->
									</div>
									<div class="indented">
										<jato:content name="ContentStaticWarning">
											<span id="body" style="color:red"><jato:getDisplayFieldValue name='StaticTextWarning' defaultValue='' fireDisplayEvents='true' escape='false'/></span>
										</jato:content><br>
									</div>
									<div class="indented">
										<!-- hyperlink -->
