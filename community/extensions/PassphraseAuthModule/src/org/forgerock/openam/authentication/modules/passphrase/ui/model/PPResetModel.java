 ...
 * used by view beans.
 */
public interface PPResetModel {
	/**
	 * Default resource bundle name
	 */
	String DEFAULT_RB = "amPassphraseResetModuleMsgs";
	 ...
	 * @param e <code>printStackTrace</code> will be invoked to print the stack trace.
	 */
	 ...
	 */
	String getPassphraseResetMessage();
	...
	/**
	 * Return a localized error message from an exception. If the exception is
	...
	/**
	 * Returns <code>true</code> if the user is locked out from resetting password.
	 * 
