...
/**
 * <code>PassphraseGenerator</code> defines a set of methods
 * that are required to generate a new passphrase for a user.
 */
public interface PassphraseGenerator{   
    /**
     * Returns new passphrase for user.
     *
     * @param user User object.
     * @return new passphrase for user.
     * @throws PWResetException if passphrase cannot be generated.
     */
    String generatePassphrase(AMIdentity user) throws PPResetException;
}