 ...
 *
 * $Id: PPResetViewBeanBase.java,v 1.2 2008/06/25 05:43:42 qcheng Exp $
 *
...
/**
 * <code>PPResetViewBeanBase</code> is the base class for password reset.
 */
public abstract class PPResetViewBeanBase extends ViewBeanBase implements Constants {
	...
	/**
	 * Name of organization DN that is entered in the URL or the one where to
	 * look for initial template.
	 */
	 ...
	 */
	protected PPResetModel model = null;
	 ...
	 */
	public PPResetViewBeanBase(String pageName) {
		super(pageName);
	}
	 ...
	 */
	protected boolean isPPResetEnabled() {
