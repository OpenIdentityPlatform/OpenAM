 ...
 *
 * $Id: PPResetQuestionModel.java,v 1.2 2008/06/25 05:43:42 qcheng Exp $
 *
...
/**
 * <code>PPResetQuestionModel</code> defines a set of methods that are
 * required by password reset question viewbean.
 */
public interface PPResetQuestionModel extends PPResetModel {
	/**
	 ...
	 * @throws PPResetException if unable to reset the password
	 */
	public void resetPassphrase(String userDN, String orgDN, Map<String, String> map) throws PPResetException;
	 ...
	 */
	public Map<String, String> getSecretQuestions(String userDN, String orgDN);
