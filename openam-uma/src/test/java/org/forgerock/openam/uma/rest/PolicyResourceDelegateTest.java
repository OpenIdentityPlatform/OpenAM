...
public class PolicyResourceDelegateTest {
    ...
    public void shouldCreatePolicies() throws ResourceException {
        ...
        given(policyResource.handleCreate(eq(context), ArgumentMatchers.<CreateRequest>anyObject()))
        ...
        //Then
        verify(policyResource, never()).handleDelete(eq(context), ArgumentMatchers.<DeleteRequest>anyObject());
    ...
    public void shouldHandleFailureToCreatePoliciesByDeletingCreatedPolicies() throws ResourceException {
        ...
        given(policyResource.handleCreate(eq(context), ArgumentMatchers.<CreateRequest>anyObject()))
                .willReturn(createPolicyOnePromise)
                .willReturn(createPolicyTwoPromise);
        given(policyResource.handleDelete(eq(context), ArgumentMatchers.<DeleteRequest>anyObject()))
    ...
    public void shouldUpdatePolicies() throws ResourceException {
        ...
        given(policyResource.handleUpdate(eq(context), ArgumentMatchers.<UpdateRequest>anyObject()))
