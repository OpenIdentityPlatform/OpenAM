 ...
 *
 * $Id: IServerValidate.java,v 1.1 2008/11/22 02:41:22 ak138937 Exp $
 *
 */
...
/**
 * Serverconfiguration interface for validation. All server-side validations 
 * are required to implement this interface.
 */
public interface IServerValidate {
    /**
