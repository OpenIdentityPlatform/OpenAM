...
/**
 * Migrator for migrating old policy subject conditions to new entitlement environment conditions.
 *
 * @since 12.0.0
 */
interface EntitlementConditionMigrator {
     ...
     */
    EntitlementCondition migrate(PolicyCondition condition, MigrationReport migrationReport);
}