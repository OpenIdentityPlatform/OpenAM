...
/**
 * An Upgrade step for updating the validation in the SessionPropertyWhitelistService Service.
 */
@UpgradeStepInfo(dependsOn = "org.forgerock.openam.upgrade.steps.UpgradeServiceSchemaStep")
public class SessionPropertyWhiteListValidationUpgradeStep extends AbstractNewRequiredAttributeUpgradeStep {

    private static final String SERVICE_NAME = "SessionPropertyWhitelistService";
    private static final String NEW_VALIDATOR_NAME = "RequiredValueValidator";

    @Inject
    public SessionPropertyWhiteListValidationUpgradeStep(
    ...
    private enum Default implements DefaultPropertyValue {
        SESSION_PROPERTY_WHITE_LIST("forgerock-session-property-whitelist", null);
