...
/**
 * An Upgrade step for updating the validation in the OAuth2Provider Service.
 */
@UpgradeStepInfo(dependsOn = "org.forgerock.openam.upgrade.steps.UpgradeOAuth2ProviderStep")
public class OAuth2ProviderRequiredAttributeValidationUpgradeStep extends AbstractNewRequiredAttributeUpgradeStep {
    ...
    private enum Default implements DefaultPropertyValue {
        SUPPORTED_SCOPES("forgerock-oauth2-provider-supported-scopes", "profile");
    ...
    @Inject
    public OAuth2ProviderRequiredAttributeValidationUpgradeStep(
