...
/**
 * An Upgrade step for updating the validation in the validationService Service.
 */
@UpgradeStepInfo(dependsOn = "org.forgerock.openam.upgrade.steps.UpgradeServiceSchemaStep")
public class ValidationServiceValidationUpgradeStep extends AbstractNewRequiredAttributeUpgradeStep {

    private static final String SERVICE_NAME = "validationService";
    ...
    private enum Default implements DefaultPropertyValue {
        MAIL_SERVER_HOST_NAME("openam-auth-valid-goto-resources", null);
    ...
    @Inject
    public ValidationServiceValidationUpgradeStep(
