 ...
 */
public class RestSTSInstanceConfigStore extends STSInstanceConfigStoreBase<RestSTSInstanceConfig> {

    @Inject
    RestSTSInstanceConfigStore(InstanceConfigMarshaller<RestSTSInstanceConfig> instanceConfigMarshaller, Logger logger) {
        super(instanceConfigMarshaller, AMSTSConstants.REST_STS_SERVICE_NAME, logger);
    }
}
