...
public class RestCertificateTokenTransformValidator implements RestTokenTransformValidator<X509Certificate[]> {
     ...
     */
    public RestCertificateTokenTransformValidator(AuthenticationHandler<X509Certificate[]> authenticationHandler,
    ...
    @Override
    public RestTokenTransformValidatorResult validateToken(RestTokenTransformValidatorParameters<X509Certificate[]> tokenParameters) throws TokenValidationException {
