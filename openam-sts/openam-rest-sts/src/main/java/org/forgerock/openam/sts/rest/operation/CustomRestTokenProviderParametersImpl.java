 ...
 */
class CustomRestTokenProviderParametersImpl implements CustomRestTokenProviderParameters {
    ...
    CustomRestTokenProviderParametersImpl(JsonValue tokenCreationState, TokenTypeId inputTokenType, JsonValue inputToken) {
