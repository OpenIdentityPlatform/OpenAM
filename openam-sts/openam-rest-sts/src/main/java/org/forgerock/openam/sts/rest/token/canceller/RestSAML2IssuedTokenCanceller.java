 ...
 */
public class RestSAML2IssuedTokenCanceller implements RestIssuedTokenCanceller<SAML2TokenState> {
     ...
     */
    public RestSAML2IssuedTokenCanceller(CTSTokenIdGenerator ctsTokenIdGenerator, TokenServiceConsumer tokenServiceConsumer) {
    ...
    @Override
    public void cancelToken(RestIssuedTokenCancellerParameters<SAML2TokenState> cancellerParameters) throws TokenCancellationException {
        tokenServiceConsumer.cancelToken(generateIdFromValidateTarget(cancellerParameters.getInputToken()), getAdminToken());
    }

    private String generateIdFromValidateTarget(SAML2TokenState validateTarget) throws TokenCancellationException {
        try {
