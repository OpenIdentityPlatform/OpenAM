 ...
 */
class OpenIdConnectRestTokenProviderParameters implements RestTokenProviderParameters<OpenIdConnectTokenCreationState>{
    ...
    OpenIdConnectRestTokenProviderParameters(OpenIdConnectTokenCreationState openIdConnectTokenCreationState,
