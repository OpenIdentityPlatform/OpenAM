 ...
 */
class Saml2RestTokenProviderParameters implements RestTokenProviderParameters<Saml2TokenCreationState> {
    ...
    Saml2RestTokenProviderParameters(Saml2TokenCreationState saml2TokenCreationState, TokenTypeId inputTokenType, JsonValue inputToken) {
