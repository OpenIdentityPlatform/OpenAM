...
public class RestUsernameTokenTransformValidator implements RestTokenTransformValidator<RestUsernameToken> {
     ...
     */
    public RestUsernameTokenTransformValidator(AuthenticationHandler<RestUsernameToken> authenticationHandler,
    ...
    @Override
    public RestTokenTransformValidatorResult validateToken(RestTokenTransformValidatorParameters<RestUsernameToken> restTokenTransformValidatorParameters) throws TokenValidationException {
        final String sessionId = authenticationHandler.authenticate(restTokenTransformValidatorParameters.getInputToken(), TokenType.USERNAME);
