...
public class RestSTSInstanceConfigMarshaller implements InstanceConfigMarshaller<RestSTSInstanceConfig> {
    ...
    @Override
    public Map<String, Set<String>> toMap(RestSTSInstanceConfig instance) throws STSPublishException {
        try {
    ...
    @Override
    public RestSTSInstanceConfig fromMapAttributes(Map<String, Set<String>> attributes) throws STSPublishException {
        try {
    ...
    @Override
    public RestSTSInstanceConfig fromJsonAttributeMap(JsonValue jsonMapAttributes) throws STSPublishException {
        try {
            return RestSTSInstanceConfig.marshalFromJsonAttributeMap(jsonMapAttributes);
        } catch (RuntimeException e) {
            /*
            The marshalToAttributeMap method may throw a IllegalStateException or IllegalArgument exception if marshalling
            functionality fails.
             */
            throw new STSPublishException(ResourceException.INTERNAL_ERROR,
                    "Exception caught marshalling RestSTSInstanceConfig from json: " + e, e);
        }
    }

    @Override
    public RestSTSInstanceConfig fromJson(JsonValue json) throws STSPublishException {
        try {
            return RestSTSInstanceConfig.fromJson(json);
        } catch (RuntimeException e) {
            /*
            The marshalToAttributeMap method may throw a IllegalStateException or IllegalArgument exception if marshalling
            functionality fails.
