...
public class TokenGenerationServiceHttpRouteProvider implements HttpRouteProvider {
    ...
    public Set<HttpRoute> get() {
        return Collections.singleton(HttpRoute.newHttpRoute(STARTS_WITH, "sts-tokengen",
                CrestHttp.newHttpHandler(TokenGenerationServiceConnectionFactoryProvider.getConnectionFactory(authenticationFilterProvider.get()))));
    }
}
