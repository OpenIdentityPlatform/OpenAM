 ...
 */
public class OpenAMSessionTokenClientInterceptorProvider extends AbstractPolicyInterceptorProvider {
    public OpenAMSessionTokenClientInterceptorProvider() {
        super(Arrays.asList(AMSTSConstants.AM_SESSION_TOKEN_ASSERTION_QNAME));
        getOutInterceptors().add(new OpenAMSessionTokenClientInterceptor());
        getInInterceptors().add(new OpenAMSessionTokenClientInterceptor());
