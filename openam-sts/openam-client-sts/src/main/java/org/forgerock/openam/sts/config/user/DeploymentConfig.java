...
public class DeploymentConfig {
    ...
    SMS persistence.
     */
    static final String REALM = SharedSTSConstants.DEPLOYMENT_REALM;
    static final String URI_ELEMENT = SharedSTSConstants.DEPLOYMENT_URL_ELEMENT;
    static final String AUTH_TARGET_MAPPINGS = AuthTargetMapping.AUTH_TARGET_MAPPINGS;
    static final String OFFLOADED_TWO_WAY_TLS_HEADER_KEY = SharedSTSConstants.OFFLOADED_TWO_WAY_TLS_HEADER_KEY;
    static final String TLS_OFFLOAD_ENGINE_HOSTS = SharedSTSConstants.TLS_OFFLOAD_ENGINE_HOSTS;

    public abstract static class DeploymentConfigBuilderBase<T extends DeploymentConfigBuilderBase<T>> {
        ...
        public T uriElement(String uriElement)  {
        ...
        public T offloadedTwoWayTLSHeaderKey(String offloadedTLSHeaderKey)  {
            this.offloadedTwoWayTLSHeaderKey = offloadedTLSHeaderKey;
            return self();
        }

        public T tlsOffloadEngineHostIpAddrs(Set<String> tlsOffloadEngineHostIpAddrs) {
    ...
    public static class DeploymentConfigBuilder extends DeploymentConfigBuilderBase<DeploymentConfigBuilder> {
        @Override
        protected DeploymentConfigBuilder self() {
            return this;
        }
    }
    ...
    protected DeploymentConfig(DeploymentConfigBuilderBase<?> builder) {
    ...
    public boolean equals(Object other) {
        if (other instanceof DeploymentConfig) {
            ...
            return  uriElement.equals(otherConfig.getUriElement()) &&
                    ...
                    Objects.equal(offloadedTwoWayTLSHeaderKey, otherConfig.getOffloadedTwoWayTlsHeaderKey()) &&
                    Objects.equal(tlsOffloadEngineHostIpAddrs, otherConfig.getTlsOffloadEngineHostIpAddrs());
        }
        return false;
    }
    ...
    public static DeploymentConfig marshalFromAttributeMap(Map<String, Set<String>> attributeMap) {
