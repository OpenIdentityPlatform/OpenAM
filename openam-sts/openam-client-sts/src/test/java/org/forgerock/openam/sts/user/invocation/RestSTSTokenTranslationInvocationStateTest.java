...
public class RestSTSTokenTranslationInvocationStateTest {
    ...
    public void testRountTripWithUntAndSaml() throws TokenMarshalException {
        SAML2TokenCreationState saml2TokenCreationState =
        ...
        RestSTSTokenTranslationInvocationState invocationState =
                RestSTSTokenTranslationInvocationState.builder()
                        .inputTokenState(usernameTokenState.toJson())
                        .outputTokenState(saml2TokenCreationState.toJson())
                        .build();
        RestSTSTokenTranslationInvocationState roundTripInvocationState = RestSTSTokenTranslationInvocationState.fromJson(invocationState.toJson());
        assertEquals(usernameTokenState, UsernameTokenState.fromJson(roundTripInvocationState.getInputTokenState()));
        assertEquals(saml2TokenCreationState, SAML2TokenCreationState.fromJson(roundTripInvocationState.getOutputTokenState()));
    }
