...
public class SAML2TokenCreationStateTest {
    @Test
    public void testJsonRoundTripNoProofTokenState() throws Exception {
        SAML2TokenCreationState tokenState = SAML2TokenCreationState.builder()
                .saml2SubjectConfirmation(SAML2SubjectConfirmation.BEARER)
                .build();
        assertEquals(tokenState, SAML2TokenCreationState.fromJson(tokenState.toJson()));
    }
