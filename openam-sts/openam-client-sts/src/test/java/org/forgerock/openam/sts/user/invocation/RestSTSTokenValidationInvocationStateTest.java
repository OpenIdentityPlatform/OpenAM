...
public class RestSTSTokenValidationInvocationStateTest {
    ...
    public void testEquals() throws TokenMarshalException {
        ...
        RestSTSTokenValidationInvocationState invocationState =
                RestSTSTokenValidationInvocationState.builder().validatedTokenState(saml2TokenState.toJson()).build();
        RestSTSTokenValidationInvocationState invocationState2 =
                RestSTSTokenValidationInvocationState.builder().validatedTokenState(saml2TokenState.toJson()).build();
        ...
        invocationState =
                RestSTSTokenValidationInvocationState.builder().validatedTokenState(openIdConnectTokenState.toJson()).build();
        invocationState2 =
                RestSTSTokenValidationInvocationState.builder().validatedTokenState(openIdConnectTokenState.toJson()).build();
        assertEquals(invocationState, invocationState2);
    ...
    public void testJsonRoundTrip() throws TokenMarshalException {
        ...
        RestSTSTokenValidationInvocationState invocationState =
                RestSTSTokenValidationInvocationState.builder().validatedTokenState(saml2TokenState.toJson()).build();
        assertEquals(invocationState, RestSTSTokenValidationInvocationState.fromJson(invocationState.toJson()));
