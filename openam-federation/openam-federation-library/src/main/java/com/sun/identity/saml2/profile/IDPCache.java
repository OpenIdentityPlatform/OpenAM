...
public class IDPCache {
    ...
    /** 
      ...
      * value : IDPSession
      */
    public static Hashtable<String, IDPSession> idpSessionsBySessionID = new Hashtable<String, IDPSession>();
    ...
    /**
      ...
      */
    public static Hashtable<String, String> spSessionPartnerBySessionID = new Hashtable<String, String>();
