...
set CLASSPATH="%CLASSPATH%;%TOOLS_HOME%/lib/opendj-server-2.4.6-SNAPSHOT.jar"
...
set CLASSPATH="%CLASSPATH%;%TOOLS_HOME%/lib/openam-cli-definitions-10.1.0-SNAPSHOT.jar"
set CLASSPATH="%CLASSPATH%;%TOOLS_HOME%/lib/openam-cli-impl-10.1.0-SNAPSHOT.jar"
...
set CLASSPATH="%CLASSPATH%;%TOOLS_HOME%/lib/openam-locale-10.1.0-SNAPSHOT.jar"
