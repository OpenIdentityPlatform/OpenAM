<%--
   ...
   $Id: FSSAMLService.jsp,v 1.2 2008/06/25 05:50:21 qcheng Exp $ 

--%>

<%@ page info="FSSAMLService" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>

<jato:useViewBean
    className="com.sun.identity.console.federation.FSSAMLServiceViewBean"
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.SAML.profile" 
