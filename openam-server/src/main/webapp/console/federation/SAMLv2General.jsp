<%--
   ...
   $Id: SAMLv2General.jsp,v 1.2 2008/06/25 05:50:23 qcheng Exp $
   
--%>

<%@ page info="SAMLv2General" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2GeneralViewBean"
...
<cc:form name="SAMLv2General" method="post" defaultCommandChild="/button1">
