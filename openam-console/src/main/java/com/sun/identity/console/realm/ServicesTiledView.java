 ...
 *
 * $Id: ServicesTiledView.java,v 1.2 2008/06/25 05:43:12 qcheng Exp $
 *
 */
...
public class ServicesTiledView
    ...
    public void handleTblDataActionHrefRequest(RequestInvocationEvent event) {
        String name = (String)getDisplayFieldValue(
            ServicesViewBean.TBL_DATA_ACTION_HREF);
        ServicesViewBean parentViewBean = (ServicesViewBean)getParentViewBean();
