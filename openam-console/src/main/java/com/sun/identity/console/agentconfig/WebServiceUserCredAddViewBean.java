    ...
    extends AMPrimaryMastHeadViewBean
{
    ...
    /**
     * Creates a add user credential view bean.
     */
    public WebServiceUserCredAddViewBean() {
        super("WebServiceUserCredAdd");
    ...
    private void createPageTitleModel() {
        ...
        ptModel.setValue("button1", 
            "web.services.profile.username-token-add-btn");
    ...
    protected String getBreadCrumbDisplayName() {
        return "breadcrumbs.add-web-service-usercred";
    }
