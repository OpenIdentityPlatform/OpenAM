 ...
 */
public class ServerEditUMAViewBean extends ServerEditViewBeanBase {

    private static final String DEFAULT_DISPLAY_URL = "/console/service/ServerEditUMA.jsp";

    /**
     * Creates a modify server view bean.
     */
    public ServerEditUMAViewBean() {
        super("ServerEditUMA", DEFAULT_DISPLAY_URL);
    }

    protected String getPropertyXML() {
        return "com/sun/identity/console/propertyServerEditUMA.xml";
    }
