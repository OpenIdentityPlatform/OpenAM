 ...
 *
 * $Id: CreateFedletWarningViewBean.java,v 1.2 2008/06/25 05:49:47 qcheng Exp $
 *
 */
 ...
 * Create Fedlet UI.
 */
public class CreateFedletWarningViewBean
    extends AMPrimaryMastHeadViewBean
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/task/CreateFedletWarning.jsp";
    
    public CreateFedletWarningViewBean() {
        super("CreateFedletWarning");
