 ...
 *
 * $Id: SCConfigGlobalViewBean.java,v 1.3 2008/06/25 05:43:15 qcheng Exp $
 *
 */
...
public class SCConfigGlobalViewBean extends SCConfigViewBean {
    ...
    public SCConfigGlobalViewBean() {
        super("SCConfigGlobal", DEFAULT_DISPLAY_URL);
    }

    protected void createPropertyModel() {
        psModel = new CCPropertySheetModel(
            getClass().getClassLoader().getResourceAsStream(
            "com/sun/identity/console/propertySCGlobalConfig.xml"));
        createTableModels();
