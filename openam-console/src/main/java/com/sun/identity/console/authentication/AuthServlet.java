 ...
 *
 * $Id: AuthServlet.java,v 1.2 2008/06/25 05:42:45 qcheng Exp $
 *
 */
...
{
    public static final String DEFAULT_MODULE_URL = "../authentication";
    public static String PACKAGE_NAME=
        getPackageName(AuthServlet.class.getName());
