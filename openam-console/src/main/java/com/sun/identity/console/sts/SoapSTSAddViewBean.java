 ...
 */
public class SoapSTSAddViewBean extends STSAddViewBeanBase {
    public static final String DEFAULT_DISPLAY_URL = "/console/sts/SoapSTSAdd.jsp";
    private static final String PROPERTY_MODEL_XML_FILE_LOCATION = "com/sun/identity/console/propertySoapSecurityTokenService.xml";

    public SoapSTSAddViewBean() {
        super("SoapSTSAdd", DEFAULT_DISPLAY_URL, AMAdminConstants.SOAP_STS_SERVICE, STSType.SOAP);
    }
