 ...
 *
 * $Id: SMServlet.java,v 1.2 2008/06/25 05:43:21 qcheng Exp $
 *
 */
 ...
 */
public class SMServlet 
    extends ConsoleServletBase 
{
    public static final String DEFAULT_MODULE_URL = "../session";
    public static String PACKAGE_NAME=
        getPackageName(SMServlet.class.getName());
