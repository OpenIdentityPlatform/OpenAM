 ...
 *
 * $Id: RMServlet.java,v 1.2 2008/06/25 05:43:11 qcheng Exp $
 *
 */
 ...
 */
public class RMServlet 
    extends ConsoleServletBase 
{
    public static final String DEFAULT_MODULE_URL = "../realm";
    public static String PACKAGE_NAME=
        getPackageName(RMServlet.class.getName());
