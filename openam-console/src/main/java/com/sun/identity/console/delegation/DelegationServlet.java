 ...
 *
 * $Id: DelegationServlet.java,v 1.2 2008/06/25 05:42:51 qcheng Exp $
 *
 */
 ...
 */
public class DelegationServlet 
    extends ConsoleServletBase 
{
    public static final String DEFAULT_MODULE_URL = "../delegation";
    public static String PACKAGE_NAME=
        getPackageName(DelegationServlet.class.getName());
