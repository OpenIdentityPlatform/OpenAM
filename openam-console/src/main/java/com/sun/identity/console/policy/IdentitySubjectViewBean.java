 ...
 *
 * $Id: IdentitySubjectViewBean.java,v 1.2 2008/06/25 05:43:02 qcheng Exp $
 *
 */
...
public class IdentitySubjectViewBean
    extends PolicySubjectPluginViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/policy/IdentitySubject.jsp";

    public IdentitySubjectViewBean() {
        super("IdentitySubject", DEFAULT_DISPLAY_URL);
    }
