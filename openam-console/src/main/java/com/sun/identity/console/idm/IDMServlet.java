 ...
 *
 * $Id: IDMServlet.java,v 1.2 2008/06/25 05:42:59 qcheng Exp $
 *
 */
 ...
 */
public class IDMServlet 
    extends ConsoleServletBase 
{
    public static final String DEFAULT_MODULE_URL = "../idm";
    public static String PACKAGE_NAME=
        getPackageName(IDMServlet.class.getName());
