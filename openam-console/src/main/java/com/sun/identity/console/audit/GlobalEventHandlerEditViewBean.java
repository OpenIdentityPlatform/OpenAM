 ...
 * @since 13.0.0
 */
public class GlobalEventHandlerEditViewBean extends AbstractEventHandlerEditViewBean {

    private static final String DEFAULT_DISPLAY_URL = "/console/audit/GlobalEventHandlerEdit.jsp";
    private static final String PAGE_NAME = "GlobalEventHandlerEdit";

    /**
     * Create a new {@code GlobalEventHandlerEditViewBean}.
     */
    public GlobalEventHandlerEditViewBean() {
