 ...
 * @since 13.0.0
 */
public class GlobalEventHandlerAddViewBean extends AbstractEventHandlerAddViewBean {

    private static final String DEFAULT_DISPLAY_URL = "/console/audit/GlobalEventHandlerAdd.jsp";
    private static final String PAGE_NAME = "GlobalEventHandlerAdd";

    /**
     * Create a new {@code GlobalEventHandlerAddViewBean}.
     */
    public GlobalEventHandlerAddViewBean() {
