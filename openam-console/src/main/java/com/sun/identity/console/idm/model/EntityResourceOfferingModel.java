 ...
 *
 * $Id: EntityResourceOfferingModel.java,v 1.2 2008/06/25 05:49:41 qcheng Exp $
 *
 */
...
public interface EntityResourceOfferingModel
    extends AMModel
{
    /**
     ...
     */
    SMDiscoveryServiceData getEntityDiscoEntry(String universalId)
     ...
     */
    void setEntityDiscoEntry(String universalId, SMDiscoveryServiceData smData)
	throws AMConsoleException;
}
