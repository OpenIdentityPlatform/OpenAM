<%--
   ...
   $Id: EntityDiscoveryDescriptionAdd.jsp,v 1.1 2008/11/19 17:24:01 veiming Exp $

--%>


<%@ page info="EntityDiscoveryDescriptionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.idm.EntityDiscoveryDescriptionAddViewBean"
...
<cc:form name="EntityDiscoveryDescriptionAdd" method="post" defaultCommandChild="/button1" >
