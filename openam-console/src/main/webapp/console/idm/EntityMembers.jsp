<%--
   ...
   $Id: EntityMembers.jsp,v 1.3 2008/06/25 05:44:40 qcheng Exp $
...
<%@ page info="EntityMembers" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.idm.EntityMembersViewBean"
...
<cc:form name="EntityMembers" method="post">
