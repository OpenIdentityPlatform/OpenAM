<%--
   ...
   $Id: WSAuthNServicesHandlersAdd.jsp,v 1.2 2008/06/25 05:50:59 qcheng Exp $
--%>


<%@ page info="WSAuthNServicesHandlersAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.webservices.WSAuthNServicesHandlersAddViewBean"
...
<cc:form name="WSAuthNServicesHandlersAdd" method="post" defaultCommandChild="/button1" >
