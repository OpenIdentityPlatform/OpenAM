<%--
   ...
   $Id: WSAuthNServices.jsp,v 1.2 2008/06/25 05:50:59 qcheng Exp $
--%>


<%@ page info="WSAuthNServices" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.webservices.WSAuthNServicesViewBean"
...
<cc:form name="WSAuthNServices" method="post" defaultCommandChild="/button1" >
