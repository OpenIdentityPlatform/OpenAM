<%--
   ...
   $Id: UMUserResourceOfferingEdit.jsp,v 1.2 2008/06/25 05:50:59 qcheng Exp $

--%>

<%@ page info="UMUserResourceOfferingEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.user.UMUserResourceOfferingEditViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('UMUserResourceOfferingEdit',
	    'UMUserResourceOfferingEdit.SecurityMechID',
	    'securityMechIDCount',
	    'UMUserResourceOfferingEdit.tblSecurityMechIDButtonDelete',
	    obj);
    }
</script>

<cc:form name="UMUserResourceOfferingEdit" method="post" defaultCommandChild="/button1" >
