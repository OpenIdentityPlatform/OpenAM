<%--
   ...
   $Id: UMUserDiscoveryDescriptionEdit.jsp,v 1.2 2008/06/25 05:50:58 qcheng Exp $

--%>

<%@ page info="UMUserDiscoveryDescriptionEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.user.UMUserDiscoveryDescriptionEditViewBean"
...
<cc:form name="UMUserDiscoveryDescriptionEdit" method="post" defaultCommandChild="/button1" >
