<%--
   ...
   $Id: UMUserResourceOfferingAdd.jsp,v 1.2 2008/06/25 05:50:59 qcheng Exp $

--%>

<%@ page info="UMUserResourceOfferingAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.user.UMUserResourceOfferingAddViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('UMUserResourceOfferingAdd',
	    'UMUserResourceOfferingAdd.SecurityMechID',
	    'securityMechIDCount',
	    'UMUserResourceOfferingAdd.tblSecurityMechIDButtonDelete',
	    obj);
    }
</script>

<cc:form name="UMUserResourceOfferingAdd" method="post" defaultCommandChild="/button1" >
