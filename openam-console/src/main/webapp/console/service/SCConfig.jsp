<%--
   ...
   $Id: SCConfig.jsp,v 1.3 2008/06/25 05:44:52 qcheng Exp $
...
<%@ page info="SCConfig" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SCConfigViewBean"
...
<cc:form name="SCConfig" method="post">
