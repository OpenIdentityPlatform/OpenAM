<%--
   ...
   $Id: SCPlatform30.jsp,v 1.3 2008/06/25 05:44:53 qcheng Exp $
...
<%@ page info="SCPlatform30" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SCPlatform30ViewBean"
...
<cc:form name="SCPlatform30" method="post" defaultCommandChild="/button1" >
