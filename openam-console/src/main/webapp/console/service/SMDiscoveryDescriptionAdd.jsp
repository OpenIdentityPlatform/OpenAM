<%--
   ...
   $Id: SMDiscoveryDescriptionAdd.jsp,v 1.2 2008/06/25 05:50:57 qcheng Exp $
--%>

<%@ page info="SMDiscoveryDescriptionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SMDiscoveryDescriptionAddViewBean"
...
<cc:form name="SMDiscoveryDescriptionAdd" method="post" defaultCommandChild="/button1" >
