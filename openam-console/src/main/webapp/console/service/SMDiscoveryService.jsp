<%--
   ...
   $Id: SMDiscoveryService.jsp,v 1.2 2008/06/25 05:50:57 qcheng Exp $
--%>


<%@ page info="SMDiscoveryService" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SMDiscoveryServiceViewBean"
...
<cc:form name="SMDiscoveryService" method="post" defaultCommandChild="/button1" >
