<%--
   ...
   $Id: ServerConfigInherit.jsp,v 1.4 2008/07/02 17:54:36 asyhuang Exp $

--%>

<%@ page info="ServerConfigInherit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.ServerConfigInheritViewBean"
...
<cc:form name="ServerConfigInherit" method="post" defaultCommandChild="/button1">
    ...
    <tr>
        <td>
            <cc:helpinline type="page">
                ...
                bundleID="amConsole"  
                defaultValue="table.server.inherit.inline.help" />
            </cc:helpinline>
        </td>      
    </tr>
</table>
...
<cc:actiontable
    ...
    title="table.server.inherit.title.name"
    bundleID="amConsole"
    summary="table.server.inherit.summary"
    empty="table.server.inherit.empty.message"
