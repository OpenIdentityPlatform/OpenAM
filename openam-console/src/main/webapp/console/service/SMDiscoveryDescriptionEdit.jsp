<%--
   ...
   $Id: SMDiscoveryDescriptionEdit.jsp,v 1.2 2008/06/25 05:50:57 qcheng Exp $
--%>


<%@ page info="SMDiscoveryDescriptionEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SMDiscoveryDescriptionEditViewBean"
...
<cc:form name="SMDiscoveryDescriptionEdit" method="post" defaultCommandChild="/button1" >
