<%--
   ...
   $Id: G11NCharsetAliasAdd.jsp,v 1.3 2008/06/25 05:44:52 qcheng Exp $
...
<%@ page info="G11NCharsetAliasAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.G11NCharsetAliasAddViewBean"
...
<cc:form name="G11NCharsetAliasAdd" method="post" defaultCommandChild="/button1" >
