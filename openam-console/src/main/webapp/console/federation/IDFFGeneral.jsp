<%--
   ...
   $Id: IDFFGeneral.jsp,v 1.2 2008/06/25 05:50:22 qcheng Exp $

--%>

<%@ page info="IDFFGeneral" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>

<jato:useViewBean
    className="com.sun.identity.console.federation.IDFFGeneralViewBean"
...
<cc:form name="IDFFGeneral" method="post" defaultCommandChild="/btnSearch">
