<%--
   ...
   $Id: WSFedSP.jsp,v 1.3 2008/06/25 05:50:25 qcheng Exp $
   
--%>

<%@ page info="WSFedSP" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.WSFedSPViewBean"
...
<cc:form name="WSFedSP" method="post" defaultCommandChild="/button1">
