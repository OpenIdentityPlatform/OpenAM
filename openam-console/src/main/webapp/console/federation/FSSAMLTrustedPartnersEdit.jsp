<%--
   ...
   $Id: FSSAMLTrustedPartnersEdit.jsp,v 1.2 2008/06/25 05:50:22 qcheng Exp $ 

--%>

<%@ page info="FSSAMLTrustedPartnersEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>

<jato:useViewBean
    className="com.sun.identity.console.federation.FSSAMLTrustedPartnersEditViewBean"
...
<cc:form name="FSSAMLTrustedPartnersEdit" 
    method="post" 
