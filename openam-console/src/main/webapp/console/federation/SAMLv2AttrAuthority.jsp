<%--
   ...
   $Id: SAMLv2AttrAuthority.jsp,v 1.2 2008/06/25 05:50:23 qcheng Exp $
   
--%>
 
<%@ page info="SAMLv2AttrAuthority" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2AttrAuthorityViewBean"
...
<cc:form name="SAMLv2Authority" method="post" defaultCommandChild="/button1">
