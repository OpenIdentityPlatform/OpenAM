<%--
   DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS HEADER.
     ...
     *
     * $Id: SAMLv2Affiliate.jsp,v 1.2 2008/06/25 05:50:23 qcheng Exp $
     *
     */
 --%>
 
<%@ page info="SAMLv2Affiliate" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2AffiliateViewBean"
...
<cc:form name="SAMLv2Affil" method="post" defaultCommandChild="/button1">
