<%--
   ...
   $Id: WSFedGeneral.jsp,v 1.2 2008/06/25 05:50:25 qcheng Exp $
   
--%>

<%@ page info="WSFedGeneral" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.WSFedGeneralViewBean"
...
<cc:header name="hdrCommon" pageTitle="webconsole.title" bundleID="amConsole" 
    copyrightYear="2007" fireDisplayEvents="true">

<script language="javascript" src="../console/js/am.js">
</script>

<cc:form name="WSFedGeneral" method="post" defaultCommandChild="/btnSearch">
