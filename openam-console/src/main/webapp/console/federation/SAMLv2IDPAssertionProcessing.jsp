<%--
   ...
   $Id: SAMLv2IDPAssertionProcessing.jsp,v 1.2 2008/06/25 05:50:24 qcheng Exp $
   
--%>

<%@ page info="SAMLv2IDPAssertionProcessing" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2IDPAssertionProcessingViewBean"
...
<cc:form name="SAMLv2IDPAssertionProcessing" method="post" defaultCommandChild="/button1">
