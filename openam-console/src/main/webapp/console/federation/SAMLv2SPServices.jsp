<%--
   ...
   $Id: SAMLv2SPServices.jsp,v 1.2 2008/06/25 05:50:25 qcheng Exp $
   
--%>

<%@ page info="SAMLv2SPServices" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2SPServicesViewBean"
...
<cc:form name="SAMLv2SPServices" method="post" defaultCommandChild="/button1">
