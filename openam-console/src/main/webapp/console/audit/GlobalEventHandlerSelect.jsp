...
<%@ page info="GlobalEventHandlerSelect" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
        className="com.sun.identity.console.audit.GlobalEventHandlerSelectViewBean"
    ...
    <cc:header name="hdrCommon" pageTitle="webconsole.title" bundleID="amConsole" copyrightYear="2015"
        ...
        <cc:form name="GlobalEventHandlerSelect" method="post" defaultCommandChild="/button1">
