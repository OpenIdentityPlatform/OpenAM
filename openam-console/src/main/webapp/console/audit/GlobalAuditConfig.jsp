...
<%@ page info="GlobalAuditConfig" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
        className="com.sun.identity.console.audit.GlobalAuditConfigViewBean"
    ...
    <cc:header name="hdrCommon"
        ...
        <cc:form name="GlobalAuditConfig" method="post" defaultCommandChild="/button1">
