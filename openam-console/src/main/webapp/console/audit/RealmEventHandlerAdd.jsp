...
<%@ page info="RealmEventHandlerAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
        className="com.sun.identity.console.audit.RealmEventHandlerAddViewBean"
    ...
    <cc:header name="hdrCommon" pageTitle="webconsole.title" bundleID="amConsole" copyrightYear="2015"
        ...
        <cc:form name="RealmEventHandlerAdd" method="post" defaultCommandChild="/button1">
