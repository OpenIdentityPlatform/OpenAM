...
<%@ page info="GlobalEventHandlerAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
        className="com.sun.identity.console.audit.GlobalEventHandlerAddViewBean"
    ...
    <cc:header name="hdrCommon" pageTitle="webconsole.title" bundleID="amConsole" copyrightYear="2015"
        ...
        <cc:form name="GlobalEventHandlerAdd" method="post" defaultCommandChild="/button1">
            ...
            <%-- PAGE CONTENT --------------------------------------------------------- --%>
            <cc:pagetitle name="pgtitleTwoBtns" bundleID="audit" pageTitleText="event.handler.page.title.add"
