...
<%@ page info="RealmProperties" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.realm.RealmPropertiesViewBean"
...
<cc:form name="RealmProperties" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle 
    name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.realms.properties" 
...
<cc:propertysheet name="realmProperties" bundleID="amConsole" />
</cc:form>
