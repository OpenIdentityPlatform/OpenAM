<%--
   ...
   $Id: RealmDiscoveryDescriptionAdd.jsp,v 1.3 2008/06/25 05:44:48 qcheng Exp $
...
<%@ page info="RealmDiscoveryDescriptionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.realm.RealmDiscoveryDescriptionAddViewBean"
...
<cc:form name="RealmDiscoveryDescriptionAdd" method="post" defaultCommandChild="/button1" >
