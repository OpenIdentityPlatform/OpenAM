<%--
   ...
   $Id: SubjectNoneAdd.jsp,v 1.3 2008/06/25 05:44:45 qcheng Exp $

--%>



<%@ page info="SubjectNoneAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.SubjectNoneAddViewBean"
...
<cc:form name="SubjectNoneAdd" method="post" defaultCommandChild="/button1">
