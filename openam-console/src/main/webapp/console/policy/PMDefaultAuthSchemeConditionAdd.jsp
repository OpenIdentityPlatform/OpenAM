...
<%@ page info="PMDefaultAuthSchemeConditionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PMDefaultAuthSchemeConditionAddViewBean"
...
<script language="javascript">
	...
	var sel = frm.elements['PMDefaultAuthSchemeConditionAdd.AuthScheme'];
	...
	var frm = document.forms['PMDefaultAuthSchemeConditionAdd'];
	var sel = frm.elements['PMDefaultAuthSchemeConditionAdd.AuthScheme'];
