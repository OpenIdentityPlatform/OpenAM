<%--
   ...
   $Id: SubjectAdd.jsp,v 1.3 2008/06/25 05:44:45 qcheng Exp $

--%>



<%@ page info="SubjectAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.SubjectAddViewBean"
...
<cc:form name="SubjectAdd" method="post" defaultCommandChild="/btnFilter">
