<%--
   ...
   $Id: Policy.jsp,v 1.5 2008/09/04 00:04:21 asyhuang Exp $
...
<%@ page info="Policy" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PolicyViewBean"
...
<cc:form name="Policy" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle 
    name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.policy" 
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<td><cc:label name ="lblFilter" elementName="tfFilter" /><cc:textfield name="tfFilter" defaultValue="*" onKeyDown="if (event.keyCode == 13) { document.forms['Policy'].submit(); return false;}" /></td>
...
<cc:actiontable
    name="tblSearch"
    title="table.policy.title.name"
    bundleID="amConsole"
    summary="table.policy.summary"
    empty="table.policy.empty.message"
