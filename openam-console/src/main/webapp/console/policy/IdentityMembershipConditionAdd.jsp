...
<%@ page info="IdentityMembershipConditionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.IdentityMembershipConditionAddViewBean"
...
<cc:form name="IdentityMembershipConditionAdd" method="post" defaultCommandChild="/btnFilter">
