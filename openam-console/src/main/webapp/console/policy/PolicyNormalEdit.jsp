<%--
   ...
   $Id: PolicyNormalEdit.jsp,v 1.2 2008/06/25 05:44:43 qcheng Exp $

--%>



<%@ page info="PolicyNormalEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PolicyNormalEditViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('PolicyNormalEdit', 'PolicyNormalEdit.' + tblName,
	    counterName, 'PolicyNormalEdit.' + btn, trigger);
    }
</script>

<cc:form name="PolicyNormalEdit" method="post" defaultCommandChild="/button1">
<script language="javascript">
