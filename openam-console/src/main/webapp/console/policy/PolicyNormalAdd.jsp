<%--
   ...
   $Id: PolicyNormalAdd.jsp,v 1.2 2008/06/25 05:44:43 qcheng Exp $

--%>



<%@ page info="PolicyNormalAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PolicyNormalAddViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('PolicyNormalAdd', 'PolicyNormalAdd.' + tblName,
	    counterName, 'PolicyNormalAdd.' + btn, trigger);
    }
</script>

<cc:form name="PolicyNormalAdd" method="post" defaultCommandChild="/button1">
<script language="javascript">
