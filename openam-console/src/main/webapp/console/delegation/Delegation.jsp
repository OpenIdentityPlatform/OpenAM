<%--
   ...
   $Id: Delegation.jsp,v 1.5 2008/09/04 00:04:45 asyhuang Exp $
...
<%@ page info="Delegation" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.delegation.DelegationViewBean"
...
<cc:form name="Delegation" method="post" defaultCommandChild="/btnSearch">
