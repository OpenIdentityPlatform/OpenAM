...
import static org.forgerock.openam.authentication.modules.deviceprint.DevicePrintPersist.NAME_PROFILE_STATE;
import static org.forgerock.openam.authentication.modules.deviceprint.DevicePrintPersist.SAVE_PROFILE_STATE;

/**
 * Handles the processing of state of the {@link DevicePrintPersist} login module.
 *
 * @since 12.0.0
 */
public class PersistModuleProcessor {

    private static final String BUNDLE_NAME = "amAuthDevicePrintPersistModule";
