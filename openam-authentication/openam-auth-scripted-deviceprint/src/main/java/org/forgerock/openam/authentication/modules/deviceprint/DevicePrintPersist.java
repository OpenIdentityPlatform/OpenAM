 ...
 * @since 12.0.0
 */
public class DevicePrintPersist extends AMLoginModule {

    private static final String AUTO_STORE_PROFILES_KEY = "iplanet-am-auth-device-print-persist-auto-store-profile";
    private static final String MAX_PROFILES_ALLOWED_KEY = "iplanet-am-auth-device-print-persist-max-profiles-allowed";
    ...
    private static final String DEBUG_NAME = "amAuthDevicePrintPersist";
