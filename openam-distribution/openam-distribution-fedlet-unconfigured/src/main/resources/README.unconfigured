...
%% 2. How to configure and test Fedlet 
   ...
   2.1 Steps to configure Fedlet     
     ...
     * SAMLv2 Service Provider and Identity Provider Customization link-
       https://forgerock.org/openam/doc/bootstrap/saml2-guide/index.html#saml2-providers-and-cots
...
==========
      ...
      a) The Attribute Query needs to be signed. Please follow the links
         ...
         https://forgerock.org/openam/doc/bootstrap/saml2-guide/index.html#fedlet-signing-encryption
