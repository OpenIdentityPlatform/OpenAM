...
java -classpath resources;lib/openam-clientsdk-${project.version}.jar;lib/openam-example-clientsdk-cli-${project.version}.jar;lib/servlet-api-2.5.jar;lib/jaxb-libs-1.0.6.jar;lib/jaxb-impl-1.0.6.jar samples.xacml.XACMLClientSample xacmlClientSample
