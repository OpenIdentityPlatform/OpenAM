 ...
 *
 * $Id: ModifyService.java,v 1.3 2008/06/25 05:42:15 qcheng Exp $
 *
 */
    ...
    public void handleRequest(RequestContext rc) 
        ...
        try {
            ...
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "ATTEMPT_IDREPO_MODIFY_SERVICE", params);
            ...
            outputWriter.printlnMessage(MessageFormat.format(
                getResourceString("idrepo-modify-service-succeed"), 
                (Object[])params));
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "SUCCEED_IDREPO_MODIFY_SERVICE", params);
        } catch (IdRepoException e) {
            String[] args = {realm, type, idName, serviceName, e.getMessage()};
            debugError("ModifyService.handleRequest", e);
            writeLog(LogWriter.LOG_ERROR, Level.INFO,
                "FAILED_IDREPO_MODIFY_SERVICE", args);
