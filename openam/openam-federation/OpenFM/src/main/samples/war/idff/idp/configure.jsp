            ...
            if ((proto.length() > 0) && (host.length() > 0) && 
                ...
                try {
                    ...
                    extendedXML = extendedXML.substring(0, exValueIdx + 7) +
                        baseURL + "/samples/idff/idp/index.jsp" +
                    ...
                    metaManager.createEntityDescriptor(REALM, spDescriptor);
                    ...
                    providers.add(hostedIDPEntityID + COTConstants.DELIMITER +
                        COTConstants.IDFF);
                    providers.add(remoteSPEntityID + COTConstants.DELIMITER +
                        COTConstants.IDFF);
