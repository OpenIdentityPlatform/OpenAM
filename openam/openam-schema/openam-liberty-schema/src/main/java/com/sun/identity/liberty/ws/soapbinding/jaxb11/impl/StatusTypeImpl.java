                ...
                switch (state) {
                    case  9 :
                        if (("Status" == ___local)&&("urn:liberty:sb:2004-04" == ___uri)) {
                            _getStatus().add(((com.sun.identity.liberty.ws.soapbinding.jaxb11.impl.StatusElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.soapbinding.jaxb11.impl.StatusElementImpl.class), 12, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Status" == ___local)&&("urn:liberty:sb:2004-04" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _getStatus().add(((com.sun.identity.liberty.ws.soapbinding.jaxb11.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.soapbinding.jaxb11.impl.StatusTypeImpl.class), 11, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
