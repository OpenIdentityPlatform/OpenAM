...
public class SessionContextTypeImpl implements com.sun.identity.liberty.ws.common.jaxb.security.SessionContextType, com.sun.xml.bind.JAXBObject, com.sun.identity.federation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.federation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.federation.jaxb.entityconfig.impl.runtime.ValidatableObject
{

    protected java.util.Calendar _AssertionIssueInstant;
    ...
    protected com.sun.identity.liberty.ws.common.jaxb.ps.SubjectType _SessionSubject;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.liberty.ws.common.jaxb.security.SessionContextType.class);
    }

    public java.util.Calendar getAssertionIssueInstant() {
        return _AssertionIssueInstant;
    }

    public void setAssertionIssueInstant(java.util.Calendar value) {
        _AssertionIssueInstant = value;
    }
    ...
    public com.sun.identity.liberty.ws.common.jaxb.ps.SubjectType getSessionSubject() {
        return _SessionSubject;
    }

    public void setSessionSubject(com.sun.identity.liberty.ws.common.jaxb.ps.SubjectType value) {
        _SessionSubject = value;
    }

    public com.sun.identity.federation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.federation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.liberty.ws.common.jaxb.security.impl.SessionContextTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.federation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("urn:liberty:sec:2003-08", "SessionSubject");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _SessionSubject), "SessionSubject");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _SessionSubject), "SessionSubject");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _SessionSubject), "SessionSubject");
        context.endElement();
        context.startElement("urn:liberty:sec:2003-08", "ProviderID");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
    ...
    public void serializeAttributes(com.sun.identity.federation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startAttribute("", "AssertionIssueInstant");
        try {
            context.text(com.sun.msv.datatype.xsd.DateTimeType.theInstance.serializeJavaObject(((java.util.Calendar) _AssertionIssueInstant), null), "AssertionIssueInstant");
        } catch (java.lang.Exception e) {
            com.sun.identity.federation.jaxb.entityconfig.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
...
+"paceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u00006com.sun.identity.liberty.ws.common.jaxb"
+".ps.SubjectTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-element"
...
+"www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000eSessionSubje"
+"ctt\u0000\u0017urn:liberty:sec:2003-08sq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\'ppsr\u0000\'com"
...
+"\u0000\u001curn:liberty:metadata:2003-08t\u0000\fentityIDTypeq\u0000~\u00005\u0000\u0000sr\u0000#com."
+"sun.msv.datatype.xsd.AnyURIType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000,q\u0000~\u00001t\u0000\u0006anyU"
+"RIq\u0000~\u00005q\u0000~\u0000Lt\u0000\tmaxLength\u0000\u0000\u0004\u0000q\u0000~\u00007sq\u0000~\u00008q\u0000~\u0000Jq\u0000~\u0000Isq\u0000~\u0000\u000fppsq\u0000"
+"~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\nProviderIDq\u0000~\u0000?sq\u0000~\u0000\u000fppsq\u0000~"
+"\u0000\u000fq\u0000~\u0000\u0015psq\u0000~\u0000\tq\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000"
+"~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000>com.sun.identity.liberty.ws.common.jaxb.ps."
+"AuthnContextElementq\u0000~\u0000$sq\u0000~\u0000\tq\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u000f"
+"ppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000;com.sun.id"
+"entity.liberty.ws.common.jaxb.ps.AuthnContextTypeq\u0000~\u0000$sq\u0000~\u0000\u000f"
+"ppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\fAuthnContextt\u0000\u0017urn:lib"
+"erty:iff:2003-08q\u0000~\u0000\u001fsq\u0000~\u0000\u0016ppsq\u0000~\u0000\'ppsr\u0000%com.sun.msv.datatyp"
+"e.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype.xsd.Da"
+"teTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000,q\u0000~\u00001t\u0000\bdateTimeq\u0000~\u00005q\u0000~\u00007sq\u0000"
+"~\u00008q\u0000~\u0000nq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0015AssertionIssueInstantt\u0000\u0000sq\u0000~\u0000\u0016ppq\u0000~\u0000js"
+"q\u0000~\u0000 t\u0000\u0015AuthenticationInstantq\u0000~\u0000rsr\u0000\"com.sun.msv.grammar.Ex"
...
+"\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0012\u0001pq\u0000~\u0000\u0013q\u0000~\u0000Xq\u0000~\u0000"
+"`q\u0000~\u0000\u0010q\u0000~\u0000Wq\u0000~\u0000_q\u0000~\u0000Aq\u0000~\u0000\rq\u0000~\u0000]q\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\u0006q\u0000~\u0000Tq\u0000~\u0000%q\u0000~\u0000"
+"Pq\u0000~\u0000dq\u0000~\u0000\u0007q\u0000~\u0000Ux"));
        }
        ...
        extends com.sun.identity.federation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.liberty.ws.common.jaxb.security.impl.SessionContextTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        if (("SessionSubject" == ___local)&&("urn:liberty:sec:2003-08" == ___uri)) {
                    ...
                    case  7 :
                        if (("EncryptableNameIdentifier" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
                            _SessionSubject = ((com.sun.identity.liberty.ws.common.jaxb.ps.impl.SubjectTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ps.impl.SubjectTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  13 :
                        if (("AuthnContextClassRef" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
                            _AuthnContext = ((com.sun.identity.liberty.ws.common.jaxb.ps.impl.AuthnContextTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ps.impl.AuthnContextTypeImpl.class), 14, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  12 :
                        if (("AuthnContext" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
                            _AuthnContext = ((com.sun.identity.liberty.ws.common.jaxb.ps.impl.AuthnContextElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ps.impl.AuthnContextElementImpl.class), 15, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("AuthnContext" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  0 :
                        ...
                        break;
                    case  9 :
                        if (("ProviderID" == ___local)&&("urn:liberty:sec:2003-08" == ___uri)) {
        ...
        {
            try {
                _AssertionIssueInstant = ((java.util.Calendar) com.sun.msv.datatype.xsd.DateTimeType.theInstance.createJavaObject(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value), null));
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
