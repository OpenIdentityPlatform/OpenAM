...
package com.sun.identity.saml2.jaxb.metadataidpdiscovery.impl;

public class DiscoveryResponseElementImpl
    ...
    implements com.sun.identity.saml2.jaxb.metadataidpdiscovery.DiscoveryResponseElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallableObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.XMLSerializable, com.sun.identity.saml2.jaxb.assertion.impl.runtime.ValidatableObject
{
    ...
    public com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.saml2.jaxb.metadataidpdiscovery.impl.DiscoveryResponseElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.saml2.jaxb.assertion.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol", "DiscoveryResponse");
...
+"/2001/XMLSchema-instanceq\u0000~\u0000,sq\u0000~\u0000At\u0000\u0011DiscoveryResponset\u0000;ur"
+"n:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocolsr\u0000"
        ...
        extends com.sun.identity.saml2.jaxb.assertion.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("DiscoveryResponse" == ___local)&&("urn:oasis:names:tc:SAML:profiles:SSO:idp-discovery-protocol" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("index" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.sun.identity.saml2.jaxb.metadata.impl.IndexedEndpointTypeImpl)com.sun.identity.saml2.jaxb.metadataidpdiscovery.impl.DiscoveryResponseElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                }
