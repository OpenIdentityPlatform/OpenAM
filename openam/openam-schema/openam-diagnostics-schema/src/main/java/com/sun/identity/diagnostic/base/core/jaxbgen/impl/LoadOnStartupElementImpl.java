    ...
    implements com.sun.identity.diagnostic.base.core.jaxbgen.LoadOnStartupElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallableObject, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.XMLSerializable, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.diagnostic.base.core.jaxbgen.LoadOnStartupElement.class);
    }
    ...
    public com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.Unmarshaller(context);
    }
...
+"oad-on-startupt\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u0002\u0001pq\u0000~\u0000\tq\u0000~\u0000\u000fx"));
        ...
        extends com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromEnterElement((((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupTypeImpl)com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupTypeImpl)com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupTypeImpl)com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupTypeImpl)com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupTypeImpl)com.sun.identity.diagnostic.base.core.jaxbgen.impl.LoadOnStartupElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
