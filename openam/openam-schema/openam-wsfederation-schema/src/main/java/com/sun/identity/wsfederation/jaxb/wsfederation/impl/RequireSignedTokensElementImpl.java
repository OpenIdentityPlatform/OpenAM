...
public class RequireSignedTokensElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsfederation.RequireSignedTokensElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsfederation.RequireSignedTokensElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://schemas.xmlsoap.org/ws/2006/12/federation", "RequireSignedTokens");
...
+"chema-instanceq\u0000~\u0000\u001fsq\u0000~\u00005t\u0000\u0013RequireSignedTokenst\u00000http://sch"
...
+"q\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("RequireSignedTokens" == ___local)&&("http://schemas.xmlsoap.org/ws/2006/12/federation" == ___uri)) {
                    ...
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.AssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RequireSignedTokensElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
