...
public class AllElementImpl
    extends com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wspolicy.AllElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wspolicy.AllElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://schemas.xmlsoap.org/ws/2004/09/policy", "All");
...
+"p://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000!sq\u0000~\u0000\"t\u0000\u0003Allq\u0000~\u0000C"
...
+"\u0000\u0011q\u0000~\u0000\u0017q\u0000~\u0000)q\u0000~\u0000/q\u0000~\u00005q\u0000~\u0000\tq\u0000~\u0000\u0012x"));
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Policy" == ___local)&&("http://schemas.xmlsoap.org/ws/2004/09/policy" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("All" == ___local)&&("http://schemas.xmlsoap.org/ws/2004/09/policy" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("All" == ___local)&&("http://schemas.xmlsoap.org/ws/2004/09/policy" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wspolicy.impl.OperatorContentTypeImpl)com.sun.identity.wsfederation.jaxb.wspolicy.impl.AllElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
