    ...
    implements com.sun.identity.wsfederation.jaxb.wsse.TransformationParametersElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsse.TransformationParametersElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", "TransformationParameters");
...
+"chema-instanceq\u0000~\u0000\u001fsq\u0000~\u00005t\u0000\u0018TransformationParameterst\u0000Qhttp:"
+"//docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurit"
+"y-secext-1.0.xsdsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000"
...
+"mmar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000 q\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  0 :
                        if (("TransformationParameters" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.TransformationParametersElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
