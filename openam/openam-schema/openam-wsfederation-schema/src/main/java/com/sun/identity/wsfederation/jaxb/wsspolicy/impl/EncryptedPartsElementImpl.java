...
public class EncryptedPartsElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsspolicy.EncryptedPartsElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsspolicy.EncryptedPartsElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512", "EncryptedParts");
...
+"\u0000Wq\u0000~\u0000%q\u0000~\u0000 sq\u0000~\u0000\fppsq\u0000~\u0000\u0017q\u0000~\u0000\u0010pq\u0000~\u0000+q\u0000~\u0000;q\u0000~\u0000 sq\u0000~\u0000!t\u0000\u000eEncr"
+"yptedPartsq\u0000~\u0000@sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000"
...
+"mar/ExpressionPool;xp\u0000\u0000\u0000\u0011\u0001pq\u0000~\u0000\tq\u0000~\u0000\rq\u0000~\u0000\u0011q\u0000~\u0000Dq\u0000~\u0000&q\u0000~\u0000Kq\u0000~"
+"\u0000\\q\u0000~\u0000\u000bq\u0000~\u0000\u0013q\u0000~\u0000Fq\u0000~\u0000Oq\u0000~\u0000\nq\u0000~\u0000\u0016q\u0000~\u0000Gq\u0000~\u0000Bq\u0000~\u0000Pq\u0000~\u0000Ax"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("EncryptedParts" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                    ...
                    case  1 :
                        if (("Body" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SePartsTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.EncryptedPartsElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
