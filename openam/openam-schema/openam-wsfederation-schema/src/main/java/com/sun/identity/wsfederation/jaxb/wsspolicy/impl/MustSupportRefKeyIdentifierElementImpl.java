    ...
    implements com.sun.identity.wsfederation.jaxb.wsspolicy.MustSupportRefKeyIdentifierElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsspolicy.MustSupportRefKeyIdentifierElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512", "MustSupportRefKeyIdentifier");
...
+"efKeyIdentifiert\u00009http://docs.oasis-open.org/ws-sx/ws-securi"
...
+"mar/ExpressionPool;xp\u0000\u0000\u0000\u0001\u0001pq\u0000~\u0000\tx"));
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("MustSupportRefKeyIdentifier" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.QNameAssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.QNameAssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.QNameAssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.QNameAssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.QNameAssertionTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.MustSupportRefKeyIdentifierElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
