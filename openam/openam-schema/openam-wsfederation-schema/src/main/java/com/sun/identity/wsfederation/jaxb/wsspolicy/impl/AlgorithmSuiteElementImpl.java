...
public class AlgorithmSuiteElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsspolicy.impl.NestedPolicyTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsspolicy.AlgorithmSuiteElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsspolicy.AlgorithmSuiteElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsspolicy.impl.AlgorithmSuiteElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512", "AlgorithmSuite");
...
+"sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u00000q\u0000~\u0000@q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000eAlgorithmSuiteq\u0000"
+"~\u0000Rsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bexpTa"
...
+"onPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000Gq\u0000~\u0000$q\u0000~\u0000+q\u0000~\u0000Tq\u0000~\u0000\u000eq\u0000~\u0000&q\u0000~\u0000Fq\u0000~\u0000\tq\u0000~\u0000\u0011"
+"q\u0000~\u0000\'q\u0000~\u0000\fq\u0000~\u0000\nx"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsspolicy.impl.AlgorithmSuiteElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("AlgorithmSuite" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                    ...
                    case  1 :
                        if (("Policy" == ___local)&&("http://schemas.xmlsoap.org/ws/2004/09/policy" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.NestedPolicyTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.AlgorithmSuiteElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Policy" == ___local)&&("http://schemas.xmlsoap.org/ws/2004/09/policy" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.NestedPolicyTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.AlgorithmSuiteElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
