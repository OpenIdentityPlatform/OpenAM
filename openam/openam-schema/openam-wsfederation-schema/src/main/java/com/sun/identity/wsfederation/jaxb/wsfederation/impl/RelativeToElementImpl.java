...
public class RelativeToElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsfederation.RelativeToElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsfederation.RelativeToElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.Unmarshaller(context);
    }
...
+"chema-instanceq\u0000~\u0000\u001fsq\u0000~\u00005t\u0000\nRelativeTot\u00000http://schemas.xmls"
...
+"\u000ex"));
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.RelativeToElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
