...
public class TokenSigningKeyInfoElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenKeyInfoTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsfederation.TokenSigningKeyInfoElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsfederation.TokenSigningKeyInfoElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenSigningKeyInfoElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://schemas.xmlsoap.org/ws/2006/12/federation", "TokenSigningKeyInfo");
...
+"ppsq\u0000~\u0000\u0013q\u0000~\u0000\u0012pq\u0000~\u0000/q\u0000~\u0000?q\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\u0013TokenSigningKeyInfot\u00000"
+"http://schemas.xmlsoap.org/ws/2006/12/federationsr\u0000\"com.sun."
...
+"q\u0000~\u0000#q\u0000~\u0000*q\u0000~\u0000Eq\u0000~\u0000\rq\u0000~\u0000%q\u0000~\u0000\u0010q\u0000~\u0000&q\u0000~\u0000\tq\u0000~\u0000\u000bx"));
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenSigningKeyInfoElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("SecurityTokenReference" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenKeyInfoTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenSigningKeyInfoElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("SecurityTokenReference" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenKeyInfoTypeImpl)com.sun.identity.wsfederation.jaxb.wsfederation.impl.TokenSigningKeyInfoElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        ...
                        break;
                    case  0 :
                        if (("TokenSigningKeyInfo" == ___local)&&("http://schemas.xmlsoap.org/ws/2006/12/federation" == ___uri)) {
