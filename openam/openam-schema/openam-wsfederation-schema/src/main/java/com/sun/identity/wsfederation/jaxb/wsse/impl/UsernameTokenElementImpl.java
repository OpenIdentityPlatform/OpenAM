...
public class UsernameTokenElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsse.UsernameTokenElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsse.UsernameTokenElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd", "UsernameToken");
...
+"spaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u00008com.sun.identity.wsfederation.jaxb.wss"
+"e.AttributedStringt\u0000+http://java.sun.com/jaxb/xjc/dummy-elem"
...
+"ww.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\bUsernamet\u0000Qht"
+"tp://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecu"
+"rity-secext-1.0.xsdsq\u0000~\u0000\u000fppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0016pp"
+"q\u0000~\u0000\u0019q\u0000~\u0000\u001dsr\u0000&com.sun.msv.grammar.NamespaceNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
+"\u0002\u0000\u0001L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001cq\u0000~\u0000$q\u0000~\u0000\u001fsq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015ps"
...
+".StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000,q\u0000~\u00001t\u0000\u0002IDq\u0000~\u00005\u0000"
+"q\u0000~\u00007sq\u0000~\u00008q\u0000~\u0000Nq\u0000~\u00001sq\u0000~\u0000 t\u0000\u0002Idt\u0000Rhttp://docs.oasis-open.or"
+"g/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsdq\u0000~"
+"\u0000\u001fsq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\rUsernameTokenq"
...
+"ionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u000bq\u0000~\u0000\rq\u0000~\u0000%q\u0000~\u0000Sq\u0000~\u0000Fq\u0000~\u0000\u0010q\u0000~\u0000@q\u0000~\u0000\nq\u0000~\u0000"
+"\tq\u0000~\u0000Aq\u0000~\u0000\u0013x"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenElementImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        ...
                        if (("Username" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  0 :
                        if (("UsernameToken" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("Id" == ___local)&&("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsse.impl.UsernameTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
