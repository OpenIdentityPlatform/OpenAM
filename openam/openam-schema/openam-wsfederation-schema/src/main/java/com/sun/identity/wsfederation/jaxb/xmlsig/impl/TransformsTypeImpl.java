...
+"msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\"q\u0000~\u0000)q\u0000~\u0000\rq\u0000~\u0000$q\u0000~\u0000\u0005"
+"q\u0000~\u0000\u000eq\u0000~\u0000%q\u0000~\u0000\bx"));
        }
                ...
                switch (state) {
                    case  3 :
                        if (("Transform" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getTransform().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.TransformElementImpl) spawnChildFromEnterElement((com.sun.identity.wsfederation.jaxb.xmlsig.impl.TransformElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Transform" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Algorithm" == ___local)&&("" == ___uri)) {
                            _getTransform().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.TransformTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.wsfederation.jaxb.xmlsig.impl.TransformTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
