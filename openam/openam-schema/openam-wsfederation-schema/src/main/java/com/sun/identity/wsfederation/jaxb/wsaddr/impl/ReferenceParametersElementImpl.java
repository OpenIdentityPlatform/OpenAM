...
public class ReferenceParametersElementImpl
    extends com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl
    implements com.sun.identity.wsfederation.jaxb.wsaddr.ReferenceParametersElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsaddr.ReferenceParametersElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.Unmarshaller(context);
    }
...
+"chema-instanceq\u0000~\u0000\u001fsq\u0000~\u00005t\u0000\u0013ReferenceParameterst\u0000$http://www"
+".w3.org/2005/08/addressingsr\u0000\"com.sun.msv.grammar.Expression"
...
+"un/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000 q\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersTypeImpl)com.sun.identity.wsfederation.jaxb.wsaddr.impl.ReferenceParametersElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
