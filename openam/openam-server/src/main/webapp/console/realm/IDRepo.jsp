<%--
   ...
   $Id: IDRepo.jsp,v 1.3 2008/06/25 05:44:48 qcheng Exp $
...
<%@ page info="IDRepo" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.realm.IDRepoViewBean"
...
<cc:form name="IDRepo" method="post" defaultCommandChild="/tblButtonAdd">
...
<cc:pagetitle 
    name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.idrepo" 
...
<cc:actiontable
    name="tblSearch"
    title="table.idrepo.title.name"
    bundleID="amConsole"
    summary="table.idrepo.summary"
    empty="table.idrepo.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('IDRepo', 'IDRepo.tblSearch', 'tblButton', 'IDRepo.tblButtonDelete', this)"
