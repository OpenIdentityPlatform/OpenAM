 ...
 *
 * $Id: LogInfoMap.java,v 1.3 2008/06/25 05:43:39 qcheng Exp $
 *
 */
 ...
 * log information map. This class is registered with the SAX parser.
 */
public class LogInfoMap implements ParseOutput {
    ...
    String pcdata) {
        for (int i=0; i < elems.size(); i++) {
            logInfoMap.put(((LogInfo)elems.elementAt(i)).infoKey,
            ((LogInfo)elems.elementAt(i)).infoValue);
        }
        this.name = name;
    }
} //end of LogInfoMap
