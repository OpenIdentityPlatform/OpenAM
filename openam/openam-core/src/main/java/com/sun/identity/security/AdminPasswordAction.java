 ...
 *
 * $Id: AdminPasswordAction.java,v 1.5 2008/08/19 19:09:21 veiming Exp $
 *
 */
 ...
 * </code> when using
 * <code> com.iplanet.am.util.AdminUtils</code> to obtain Administrator
 * passwords. Ths class implements the interface <code>PrivilegedAction</code>
 * with a non-default constructor. * This class should be used in order to
 * perform the privileged operation of
 * <code> com.iplanet.am.util.AdminUtils.getAdminPassword()</code>.
 * 
 * <PRE>
 * 
