 ...
 *
 * $Id: ParamIndex.java,v 1.3 2008/06/25 05:43:39 qcheng Exp $
 *
 */
 ...
 * log parameter index. This class is registered with the SAX parser.
 */
public class ParamIndex implements ParseOutput {
    /**
    ...
    String pcdata) {
        intValue = Integer.parseInt(pcdata);
    }
} //end of ParamIndex
