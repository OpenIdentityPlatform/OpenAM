 ...
 *
 * $Id: PolicyReferralEditViewBean.java,v 1.2 2008/06/25 05:43:04 qcheng Exp $
 *
 */
    ...
    extends PolicyReferralViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/policy/PolicyReferralEdit.jsp";
    ...
    public void handleButton2Request(RequestInvocationEvent event) {
        ...
        try {
            ...
            debug.warning(
                "PolicyReferralEditViewBean.handleButton2Request", e);
            redirectToStartURL();
        }
    }
        ...
        throws ModelControlException
    {
        ...
        try {
            ...
            debug.warning(
                "PolicyReferralEditViewBean.handleButton1Request", e);
            redirectToStartURL();
        }
    }
    ...
    protected String getBreadCrumbDisplayName() {
        ...
        try {
            ...
            debug.warning(
                "PolicyReferralEditViewBean.getBreadCrumbDisplayName", e);
            // NO-OP
