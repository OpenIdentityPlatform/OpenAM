 ...
 *
 * $Id: UMUserDiscoveryDescriptionEditViewBean.java,v 1.2 2008/06/25 05:49:48 qcheng Exp $
 *
 */
...
public class UMUserDiscoveryDescriptionEditViewBean
    extends UMUserDiscoveryDescriptionViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
	"/console/user/UMUserDiscoveryDescriptionEdit.jsp";
    protected static final String PGATTR_INDEX = "descriptionTblIndex";
    private boolean populateValues = false;

    public UMUserDiscoveryDescriptionEditViewBean() {
	super("UMUserDiscoveryDescriptionEdit", DEFAULT_DISPLAY_URL);
    }
    ...
    protected String getBackButtonLabel() {
        String[] arg = {
            getModel().getLocalizedString("previous.view") };
    ...
    private void returnToCallingViewBean() {
