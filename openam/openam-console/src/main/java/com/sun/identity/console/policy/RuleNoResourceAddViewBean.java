 ...
 *
 * $Id: RuleNoResourceAddViewBean.java,v 1.3 2008/12/18 20:49:32 veiming Exp $
 *
 */

package com.sun.identity.console.policy;

public class RuleNoResourceAddViewBean
    extends RuleAddViewBean
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/policy/RuleNoResourceAdd.jsp";

    /**
     * Creates a policy creation view bean.
     */
    public RuleNoResourceAddViewBean() {
        super("RuleNoResourceAdd", DEFAULT_DISPLAY_URL);
    }
