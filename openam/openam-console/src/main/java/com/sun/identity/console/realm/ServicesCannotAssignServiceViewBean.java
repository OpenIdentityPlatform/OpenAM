    ...
    extends AMPrimaryMastHeadViewBean
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/realm/ServicesCannotAssignService.jsp";
    ...
    public ServicesCannotAssignServiceViewBean() {
        super("ServicesCannotAssignService");
    ...
    public void beginDisplay(DisplayEvent event)
        ...
        setInlineAlertMessage(CCAlert.TYPE_ERROR,
            "realm.services.not.assign.service", message);
