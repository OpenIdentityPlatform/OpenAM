 ...
 *
 * $Id: EntityDiscoveryDescriptionAddViewBean.java,v 1.2 2008/06/25 05:49:41 qcheng Exp $
 *
 */
...
public class EntityDiscoveryDescriptionAddViewBean
    extends EntityDiscoveryDescriptionViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
	"/console/idm/EntityDiscoveryDescriptionAdd.jsp";

    public EntityDiscoveryDescriptionAddViewBean() {
	super("EntityDiscoveryDescriptionAdd", DEFAULT_DISPLAY_URL);
    }
	...
	setPageSessionAttribute(EntityResourceOfferingViewBeanBase.
