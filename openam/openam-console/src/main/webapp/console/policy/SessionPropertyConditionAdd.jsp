<%--
   ...
   $Id: SessionPropertyConditionAdd.jsp,v 1.3 2008/06/25 05:44:44 qcheng Exp $
...
<%@ page info="SessionPropertyConditionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.SessionPropertyConditionAddViewBean"
...
<script language="javascript">
    function toggleTblButtonStateLocal(obj) {
        toggleTblButtonState('SessionPropertyConditionAdd',
            'SessionPropertyConditionAdd.Values',
            'propertyCount',
            'SessionPropertyConditionAdd.tblPolicySessionButtonDelete',
            obj);
    }
</script>

<cc:form name="SessionPropertyConditionAdd" method="post" defaultCommandChild="/btnFilter">
<script language="javascript">
