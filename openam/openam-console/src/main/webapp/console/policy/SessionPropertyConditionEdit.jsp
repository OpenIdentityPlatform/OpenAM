...
<jato:useViewBean
    className="com.sun.identity.console.policy.SessionPropertyConditionEditViewBean"
...
<script language="javascript">
    function toggleTblButtonStateLocal(obj) {
        toggleTblButtonState('SessionPropertyConditionEdit',
            ...
            'propertyCount',
            'SessionPropertyConditionEdit.tblPolicySessionButtonDelete',
            obj);
    }
</script>

<cc:form name="SessionPropertyConditionEdit" method="post" defaultCommandChild="/btnFilter">
<script language="javascript">
