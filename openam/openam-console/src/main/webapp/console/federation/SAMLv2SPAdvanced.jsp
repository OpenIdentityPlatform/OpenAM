...
<%@ page info="SAMLv2SPAdvanced" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2SPAdvancedViewBean"
...
<cc:form name="SAMLv2SPAdvanced" method="post" defaultCommandChild="/button1">
