<%--
   ...
   $Id: SAMLv2AuthnAuthority.jsp,v 1.2 2008/06/25 05:50:23 qcheng Exp $
   
--%>
 
<%@ page info="SAMLv2AuthnAuthority" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2AuthnAuthorityViewBean"
...
<cc:form name="SAMLv2AuthnAuthority" method="post" defaultCommandChild="/button1">
