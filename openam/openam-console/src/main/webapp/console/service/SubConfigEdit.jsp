<%--
   ...
   $Id: SubConfigEdit.jsp,v 1.2 2008/06/25 05:44:54 qcheng Exp $
...
<%@ page info="SubConfigEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SubConfigEditViewBean"
...
<cc:form name="SubConfigEdit" method="post" defaultCommandChild="/button1">
