<%--
   ...
   $Id: SCServiceProfile.jsp,v 1.3 2008/06/25 05:44:53 qcheng Exp $
...
<jato:useViewBean
    className="com.sun.identity.console.service.SCServiceProfileViewBean"
...
<cc:form name="SCServiceProfile" method="post" defaultCommandChild="/button1" >
