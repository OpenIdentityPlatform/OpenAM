...
/**
 * Extracts Device Print information from the Http Headers.
 */
public class HttpHeadersExtractor implements Extractor {
     ...
     * {@inheritDoc}
     *
	 * Extracts user-agent header param to DevicePrint.
	 */
	public void extractData(DevicePrint devicePrint, HttpServletRequest request) {
		devicePrint.setUserAgent(request.getHeader(USER_AGENT));
	}
}
