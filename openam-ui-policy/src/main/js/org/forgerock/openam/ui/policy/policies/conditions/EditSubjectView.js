...
define("org/forgerock/openam/ui/policy/policies/conditions/EditSubjectView", [
    ...
    var EditSubjectView = AbstractView.extend({
        ...
        render: function (schema, callback, element, itemID, itemData) {
            ...
            this.$el.append(uiUtils.fillTemplateWithData("templates/policy/policies/conditions/EditSubjectTemplate.html", this.data));
