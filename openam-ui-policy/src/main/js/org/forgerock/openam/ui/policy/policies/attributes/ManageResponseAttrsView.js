...
define("org/forgerock/openam/ui/policy/policies/attributes/ManageResponseAttrsView", [
    ...
    var ManageResponseAttrsView = AbstractView.extend({
        element: "#staticAttrs",
        template: "templates/policy/policies/attributes/ResponseAttrsStatic.html",
        noBaseTemplate: true,
        events: {
