...
define([
    ...
    "text!css/editor/jqgrid-override.less",
    "text!css/editor/main.less",
    "text!css/common/bootstrap-clockpicker.min.css",
    "text!css/common/selectize/selectize.less",
    "text!css/common/selectize/plugins/drag_drop.less",
    "text!css/common/selectize/plugins/dropdown_header.less",
    "text!css/common/selectize/plugins/optgroup_columns.less",
    "text!css/common/selectize/plugins/remove_button.less",
    ...
    var staticFiles = [
            ...
            "css/editor/jqgrid-override.less",
            "css/editor/main.less",
            "css/common/bootstrap-clockpicker.min.css",
            "css/common/selectize/selectize.less",
            "css/common/selectize/plugins/drag_drop.less",
            "css/common/selectize/plugins/dropdown_header.less",
            "css/common/selectize/plugins/optgroup_columns.less",
            "css/common/selectize/plugins/remove_button.less",
