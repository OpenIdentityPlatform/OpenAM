...
public class CallerStationIdAttribute extends Attribute {
     ...
     */
    public CallerStationIdAttribute(byte[] octets) {
        super(octets);
     ...
     *
     * @param calledStationId the id of the station being called
     */
    public CallerStationIdAttribute(String calledStationId) {
        super(OctetUtils.toOctets(AttributeType.CALLER_STATION_ID, calledStationId));
        this.str = calledStationId;
    }
