 ...
 *
 * $Id: ModifyAttributeSchemaI18nKey.java,v 1.3 2008/12/04 06:32:05 veiming Exp $
 *
 */
...
/**
 * Modifies attribute schema's <code>i18n</code> Key.
 */
    ...
    public void handleRequest(RequestContext rc) 
        ...
        try {
            String[] params = {serviceName, schemaType, subSchemaName,
                attributeSchemaName, i18nkey};
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "ATTEMPT_MODIFY_ATTRIBUTE_SCHEMA_I18N_KEY", params);
            ...
            if (attrSchema == null) {
                ...
                attributeSchemaNoExist(attributeSchemaName,
                    "FAILED_MODIFY_ATTRIBUTE_SCHEMA_I18N_KEY", args);
            }

            attrSchema.setI18NKey(i18nkey);
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "SUCCEED_MODIFY_ATTRIBUTE_SCHEMA_I18N_KEY", params);
            outputWriter.printlnMessage(MessageFormat.format(
                getResourceString(
                    "attribute-schema-modify-i18n-key-succeed"),
                (Object[])params));
        } catch (SSOException e) {
            String[] args = {serviceName, schemaType, subSchemaName,
                attributeSchemaName, i18nkey, e.getMessage()};
