 ...
 *
 * $Id: ModifyAttributeSchemaUIType.java,v 1.3 2008/12/04 06:32:06 veiming Exp $
 *
 */
 ...
 */
public class ModifyAttributeSchemaUIType extends SchemaCommand {
    ...
    public void handleRequest(RequestContext rc) 
        ...
        try {
            String[] params = {serviceName, schemaType, subSchemaName,
                attributeSchemaName, uitype};
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "ATTEMPT_MODIFY_ATTRIBUTE_SCHEMA_UI_TYPE", params);
            ...
            if (attrSchema == null) {
                ...
                attributeSchemaNoExist(attributeSchemaName,
                    "FAILED_MODIFY_ATTRIBUTE_SCHEMA_UI_TYPE", args);
            }

            attrSchema.setUIType(uitype);
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "SUCCEED_MODIFY_ATTRIBUTE_SCHEMA_UI_TYPE", params);
            outputWriter.printlnMessage(MessageFormat.format(
                getResourceString(
                    "attribute-schema-modify-type-succeed"),
                (Object[])params));
        } catch (SSOException e) {
            String[] args = {serviceName, schemaType, subSchemaName,
                attributeSchemaName, uitype, e.getMessage()};
