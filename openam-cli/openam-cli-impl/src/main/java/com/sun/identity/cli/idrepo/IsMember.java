 ...
 *
 * $Id: IsMember.java,v 1.2 2008/06/25 05:42:15 qcheng Exp $
 *
 */
    ...
    public void handleRequest(RequestContext rc) 
        ...
        try {
            ...
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "ATTEMPT_IDREPO_IS_MEMBER", params);
            ...
            if (memberAmid.isMember(amid)) {
                String msg = getResourceString(
                    "idrepo-ismembers-positive-result");
                outputWriter.printlnMessage(
                    MessageFormat.format(msg, (Object[])args));
            } else {
                String msg = getResourceString(
                    "idrepo-ismembers-negative-result");
                outputWriter.printlnMessage(MessageFormat.format(msg, 
                    (Object[])args));
            }

            outputWriter.printlnMessage(MessageFormat.format(
                getResourceString("idrepo-get-ismember-succeed"), 
                (Object[])params));
            writeLog(LogWriter.LOG_ACCESS, Level.INFO, 
                "SUCCEED_IDREPO_IS_MEMBER", params);
        } catch (IdRepoException e) {
            String[] args = {realm, type, idName, memberIdName, memberType,
                e.getMessage()};
            debugError("IsMember.handleRequest", e);
            writeLog(LogWriter.LOG_ERROR, Level.INFO,
                "FAILED_IDREPO_IS_MEMBER", args);
