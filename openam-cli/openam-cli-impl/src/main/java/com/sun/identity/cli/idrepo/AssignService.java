 ...
 *
 * $Id: AssignService.java,v 1.3 2008/06/25 05:42:14 qcheng Exp $
 *
 */
 ...
 */
public class AssignService extends IdentityCommand {
    /**
    ...
    public void handleRequest(RequestContext rc) 
        ...
        try {
            ...
            outputWriter.printlnMessage(MessageFormat.format(
                getResourceString("idrepo-assign-service-succeed"), 
                    (Object[])params));
            writeLog(LogWriter.LOG_ACCESS, Level.INFO,
                "SUCCEED_IDREPO_ASSIGN_SERVICE", params);
        } catch (IdRepoException e) {
            String[] args = {realm, type, idName, serviceName, e.getMessage()};
            debugError("AssignService.handleRequest", e);
            writeLog(LogWriter.LOG_ERROR, Level.INFO,
                "FAILED_IDREPO_ASSIGN_SERVICE", args);
