...
<!--
   ...
   $Id: protectedejbservletresult.jsp,v 1.1 2008/12/11 14:54:14 naghaon Exp $
      ...
      <table style="text-align: left; width: 572px; height: 394px;" border="0" cellpadding="2" cellspacing="2">
		...
		<% } %>
          ...
          <tr>
            ...
            <td style="vertical-align: top;"> 
		<% if (success) { %>
			<br>This page was dispatched by an Protected Servlet which invokes an EJB that is protected by a
			...
			<% } %>
		<% } else { %>
		       <br> The dispatched page was not routed via the Protected Servlet. This
			condition can happen if the page was accessed directly instead of being
			routed via the Protected Servlet.<br>
		<% } %>
