...
<!--
   ...
   $Id: urlpolicyservletresult.jsp,v 1.11 2008/08/19 19:14:13 veiming Exp $
      ...
      <table style="text-align: left; width: 572px; height: 394px;" border="0" cellpadding="2" cellspacing="2">
		...
		<% } %>
          ...
          <tr>
            ...
            <td style="vertical-align: top;"> 
		<% if (success) { %>
			<br>This page was dispatched
			by a Servlet which is protected by a URL Policy that requires the user
			to be in the LDAP Group called <code>customer</code>.<br>
		<% } else { %>
			<br> The dispatched page was not routed via the URL Policy Servlet. This
			condition can happen if the page was accessed directly instead of being
			routed via the URL Policy Servlet.<br>
		<% } %>
	        <br> You can return to 
		<a href="/agentsample/public/urlpolicy.html">URL Policy Enforcement </a> page to try again.<br>
	    </td>
            <td style="vertical-align: top; width: 75px;">&nbsp;<br>
            </td>
          </tr>
