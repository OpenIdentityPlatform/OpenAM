...
<!--
   ...
   $Id: protectedservletresult.jsp,v 1.11 2008/08/19 19:13:42 veiming Exp $
    ...
    <tr>
      ...
      <table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
	    ...
	    <a href="/agentsample/public/urlpolicy.html">URL Policy Enforcement</a>
          ...
          <tr>
            <td style="vertical-align: top;"><a href="http://openam.forgerock.org/docs.html">J2EE Agents Guide</a><br>
            <hr class="faint">
      ...
      <table style="text-align: left; width: 572px; height: 394px;" border="0" cellpadding="2" cellspacing="2">
		...
		<% } %>
          ...
          <tr>
            ...
            <td style="vertical-align: top;"> 
		<% if (success) { %>
			<br>This page was dispatched by the Protected Servlet which requires the user to 
			be in the role <code>manager</code>.<br>
		<% } else { %>
