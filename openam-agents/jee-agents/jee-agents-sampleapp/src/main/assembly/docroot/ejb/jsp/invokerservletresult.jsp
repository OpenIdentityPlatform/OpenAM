...
<!--
   ...
   $Id: invokerservletresult.jsp,v 1.11 2008/08/19 19:13:41 veiming Exp $
      ...
      <table style="text-align: left; width: 572px; height: 394px;" border="0" cellpadding="2" cellspacing="2">
		...
		<% } %>
          ...
          <tr>
            ...
            <td style="vertical-align: top;"> 
		<% if (success) { %>
			<br>This page was dispatched by a Servlet which invokes an EJB that in turn calls 
			the security APIs as available in the EJB-tier.<br><br>
			<% if (access) { %>
			...
			<% } %>
		<% } else { %>
			<br> The dispatched page was not routed via the Invoker Servlet. This 
			condition can happen if the page was accessed directly instead of 
			being routed via the Invoker Servlet.<br>
		<% } %>
		<br> You can return to 
		<a href="/agentsample/public/programmaticsecurity.html">J2EE Security API</a> 
		page to try again.<br>
            </td>
            <td style="vertical-align: top; width: 75px;">&nbsp;<br>
            </td>
          </tr>
