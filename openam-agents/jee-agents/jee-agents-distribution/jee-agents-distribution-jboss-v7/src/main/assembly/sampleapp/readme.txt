...
------------------------------
   ...
   file OpenAMAgentConfiguration.properties located at the directory
    ...
    * Form List:
     ...
     * WebAuthentication :
      ...
      com.sun.identity.agents.config.jboss.webauth.available=true in the OpenAMAgentConfiguration.properties.
