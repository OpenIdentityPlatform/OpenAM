...
public class UpdateJettyServerClasspath extends ServerClasspathBase implements ITask {

    public boolean execute(String name, IStateAccess stateAccess, Map properties) {

        Debug.log("UpdateJettyServerClasspath.execute(): start updating classpath.");
    ...
    public boolean rollBack(String name, IStateAccess state, Map properties) throws InstallException {
        ...
        Debug.log("UpdateJettyServerClasspath.rollBack(): Rollback");
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess, Map properties) {
        ...
        Debug.log("UpdateJettyServerClasspath.getExecutionMessage(): Execution message.");
        Object[] args = {JETTY_CLASSPATH_CONF_FILE};
        return LocalizedMessage.get(TSK_MSG_UPDATE_SET_CLASSPATH_EXECUTE, STR_JETTY_GROUP, args);
    }

    public LocalizedMessage getRollBackMessage(IStateAccess stateAccess, Map properties) {

        Debug.log("UpdateJettyServerClasspath.getRollBackMessage(): Rollback message.");
        Object[] args = {JETTY_CLASSPATH_CONF_FILE};
        return LocalizedMessage.get(TSK_MSG_UPDATE_SET_CLASSPATH_ROLLBACK, STR_JETTY_GROUP, args);
    }
}