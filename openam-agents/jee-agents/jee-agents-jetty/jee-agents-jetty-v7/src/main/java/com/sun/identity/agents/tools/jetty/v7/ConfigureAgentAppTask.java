 ...
 *
 * $Id: ConfigureAgentAppTask.java,v 1.1 2009/01/21 18:43:53 kanduls Exp $
 */
...
public class ConfigureAgentAppTask extends AgentAppBase implements ITask {
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess, Map properties) {
        ...
        LocalizedMessage message = LocalizedMessage.get(TSK_MSG_CONFIGURE_AGENT_APP_EXECUTE, STR_JETTY_GROUP, args);
        return message;
    }
    ...
    public LocalizedMessage getRollBackMessage(IStateAccess stateAccess,
            Map properties) {
        Object[] args = { STR_AGENT_APP_WAR_FILE };
        LocalizedMessage message = LocalizedMessage.get(TSK_MSG_CONFIGURE_AGENT_APP_ROLLBACK, STR_JETTY_GROUP, args);
        return message;
    }
