...
public final class AMAuthenticationAuditEventBuilder extends AuthenticationAuditEventBuilder<AMAuthenticationAuditEventBuilder> {
     ...
     */
    public AMAuthenticationAuditEventBuilder extraInfo(String... values) {
     ...
     * @return this builder for method chaining.
     */
    public AMAuthenticationAuditEventBuilder contextId(String value) {
     ...
     * @return this builder for method chaining.
     */
    public AMAuthenticationAuditEventBuilder domain(String value) {
     ...
     * @return this builder for method chaining.
     */
    public AMAuthenticationAuditEventBuilder component(String value) {
     ...
     * @return this builder
     */
    public AMAuthenticationAuditEventBuilder contextIdFromSSOToken(SSOToken ssoToken) {
     ...
     * @return this builder
     */
    public AMAuthenticationAuditEventBuilder domainFromSSOToken(SSOToken ssoToken) {
