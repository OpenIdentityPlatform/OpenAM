...
define("org/forgerock/openam/ui/policy/policies/conditions/LegacyListItemView", [
    ...
    var LegacyListItemView = AbstractView.extend({
        ...
        render: function( itemData, callback, element, itemID ) {
            ...
            this.$el.append(uiUtils.fillTemplateWithData("templates/policy/policies/conditions/LegacyListItem.html", this.data));
