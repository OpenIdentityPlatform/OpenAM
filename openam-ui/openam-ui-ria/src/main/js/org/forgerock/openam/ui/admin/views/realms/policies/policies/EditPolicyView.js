...
define("org/forgerock/openam/ui/admin/views/realms/policies/policies/EditPolicyView", [
    "jquery",
    "underscore",
    "backbone",
    "bootstrap-dialog",
    ...
    "org/forgerock/openam/ui/admin/views/realms/policies/common/ReviewInfoView",
    "org/forgerock/openam/ui/admin/views/realms/policies/common/StripedListView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/PolicyActionsView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/ResourcesView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/attributes/StaticResponseAttributesView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/attributes/SubjectResponseAttributesView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ManageSubjectsView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ManageEnvironmentsView"
    ...
    var EditPolicyView = AbstractView.extend({
        template: "templates/admin/views/realms/policies/policies/EditPolicyTemplate.html",
        reviewTemplate: "templates/admin/views/realms/policies/policies/ReviewPolicyStepTemplate.html",
        ...
        renderPolicy: function () {
            ...
            this.dialog = BootstrapDialog.show({
                ...
                title: this.model.id ?
                    ...
                    $.t("console.policies.policies.edit.createNew"),
                message: $("<div></div>"),
                onshow: function () {
                    var dialog = this;
