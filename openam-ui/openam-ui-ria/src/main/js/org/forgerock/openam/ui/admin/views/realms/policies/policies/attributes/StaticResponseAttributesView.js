...
define("org/forgerock/openam/ui/admin/views/realms/policies/policies/attributes/StaticResponseAttributesView", [
    "jquery",
    "underscore",
    ...
    StaticResponseAttributesView.prototype.render = function (entity, staticAttributes, el, callback) {
        ...
        this.baseRender(this.data, "templates/admin/views/realms/policies/policies/attributes/StaticAttributesTemplate.html", el, callback);
    };
