...
define("org/forgerock/openam/ui/admin/views/realms/policies/resourceTypes/ResourceTypePatternsView", [
    "jquery",
    "underscore",
    ...
    ResourceTypePatternsView.prototype.render = function (entity, actions, el, callback) {
        ...
        this.baseRender(this.data, "templates/admin/views/realms/policies/resourceTypes/ResourceTypesPatternsTemplate.html", el, callback);
    };
