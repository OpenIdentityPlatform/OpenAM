...
define("org/forgerock/openam/ui/admin/views/realms/policies/common/StripedListView", [
    ...
    return AbstractView.extend({
        noBaseTemplate: true,
        template: "templates/admin/views/realms/policies/common/StripedListWrapperTemplate.html",
        events: {
        ...
        render: function (data, el, callback) {
            ...
            if (!this.data.itemTpl) {
                this.data.itemTpl = "templates/admin/views/realms/policies/common/StripedListItemTemplate.html";
            }
