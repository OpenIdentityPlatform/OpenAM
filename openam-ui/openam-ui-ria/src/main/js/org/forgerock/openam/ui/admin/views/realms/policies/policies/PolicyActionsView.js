...
define("org/forgerock/openam/ui/admin/views/realms/policies/policies/PolicyActionsView", [
    "jquery",
    "underscore",
    ...
    var PolicyActionsView = AbstractView.extend({
        element: "#actions",
        template: "templates/admin/views/realms/policies/policies/PolicyActionsTemplate.html",
        noBaseTemplate: true,
        events: {
        ...
        render: function (data, callback) {
            ...
            var availableActions = _.cloneDeep(data.options.availableActions),
                selectedActions = [],
                itemTpl = "templates/admin/views/realms/policies/policies/StripedListActionItemTemplate.html";
            ...
            this.parentRender(function () {
                ...
                this.actionsListView.render({
                    ...
                    title: $.t("console.policies.policies.edit.availableActions"),
                ...
                this.actionsListSelectedView.render({
                    ...
                    title: $.t("console.policies.policies.edit.selectedActions"),
                    created: true,
