...
define([
    ...
    obj.getTrustedDevices = function () {
        return obj.serviceCall({
            url: fetchUrl.legacy(`/users/${Configuration.loggedUser.get("uid")}/devices/trusted/?_queryId=*`),
    ...
    obj.deleteTrustedDevice = function (id) {
        return obj.serviceCall({
            url: fetchUrl.legacy(`/users/${Configuration.loggedUser.get("uid")}/devices/trusted/${id}`),
            type: "DELETE",
