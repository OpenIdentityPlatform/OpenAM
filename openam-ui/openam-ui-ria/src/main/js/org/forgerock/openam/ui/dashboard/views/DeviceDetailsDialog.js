...
define("org/forgerock/openam/ui/dashboard/views/DeviceDetailsDialog", [
    "jquery",
    "lodash",
    ...
    return function (uuid, device) {
        UIUtils.compileTemplate("templates/openam/dashboard/EditDeviceDialogTemplate.html", device)
        .then(function (tpl) {
