...
define("org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrDayView", [
    "jquery",
    "underscore",
    ...
    return ConditionAttrBaseView.extend({
        template: "templates/admin/views/realms/policies/policies/conditions/ConditionAttrDay.html",
        i18n: {
            "weekdays": { "key": "console.policies.common.weekdays.", "full": ".full", "short": ".short" }
        },
