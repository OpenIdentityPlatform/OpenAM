...
define("org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/EditEnvironmentView", [
    ...
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrBooleanView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrArrayView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrStringView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrObjectView",
    "org/forgerock/openam/ui/admin/views/realms/policies/policies/conditions/ConditionAttrEnumView",
    ...
    return AbstractView.extend({
        ...
        data: {},
        i18n: {
            "condition": { "key": "console.policies.policies.edit.conditionTypes.", "title": ".title", "props": ".props." }
        },
        ...
        getHelperText: function (schema) {
            ...
            switch (schema.title) {
                ...
                case "IPv6":
                    helperText.title = Handlebars.helpers.t("console.policies.policies.edit.conditionTypes.ipHelperTitle");
                    helperText.content = Handlebars.helpers.t("console.policies.policies.edit.conditionTypes.ipHelperContent");
                    break;
                case "SimpleTime":
                    helperText.title = Handlebars.helpers.t("console.policies.policies.edit.conditionTypes.SimpleTime.helperTitle");
                    helperText.content = Handlebars.helpers.t("console.policies.policies.edit.conditionTypes.SimpleTime.helperContent");
                    break;
                default:
                    break;
            }
