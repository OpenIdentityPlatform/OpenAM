...
define("org/forgerock/openam/ui/admin/views/realms/policies/common/ReviewInfoView", [
    "jquery",
    "underscore",
        ...
        renderParent: function (callback) {
            this.parentRender(function () {
                ...
                this.$el.find("#toggleAdvanced").text(this.data.advancedMode ?
                    $.t("console.policies.policies.edit.summaryReview.minimized") :
                    $.t("console.policies.policies.edit.summaryReview.maximized"));
