...
define("org/forgerock/openam/ui/admin/views/realms/authorization/policies/ResourcesView", [
    "jquery",
    "underscore",
    ...
    var ResourcesView = AbstractView.extend({
        ...
        template: "templates/admin/views/realms/authorization/policies/ResourcesStepTemplate.html",
        noBaseTemplate: true,
        ...
        render: function (data, callback) {
            ...
            this.parentRender(function () {
                ...
                this.availablePatternsView.render({
                    ...
                    title: $.t("console.authorization.common.availablePatterns"),
