...
<body class="LogBdy"
    onLoad="setFocus('PWResetUserValidation','PWResetUserValidation.tfUserAttr');">
          ...
          <tr>
            ...
            border="0" />
		      ...
		      <img src="<%= passwordUrl %>/images/dot.gif" width="1" height="25" alt="" />		    	    
                ...
                <jato:text name="userValidationTitle"/>
                </div></td>
                </tr>
                ...
                <td><div class="logInp">
                <jato:textField name="tfUserAttr" size="30" /></div>
                </td>
                </tr>        
                <tr>
                ...
                <script language="javascript">
		markupButton('<jato:text name="btnNext" />',"PWResetUserValidation.btnNext");		    
                </script> 
                </tr>
                </jato:form>
                </jato:content>
