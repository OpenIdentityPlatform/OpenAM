<%--
   ...
   $Id: AuthToServiceEdit.jsp,v 1.3 2008/06/25 05:44:41 qcheng Exp $

--%>



<%@ page info="AuthToServiceEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.AuthToServiceEditViewBean"
...
<script language="javascript">
	...
	frm.action += '?AuthToServiceEdit.btnRealm=';
	frm.submit();
    }
</script>

<cc:form name="AuthToServiceEdit" method="post" defaultCommandChild="/btnFilter">
<script language="javascript">
