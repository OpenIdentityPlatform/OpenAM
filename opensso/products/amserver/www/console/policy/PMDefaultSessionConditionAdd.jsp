<%--
   ...
   $Id: PMDefaultSessionConditionAdd.jsp,v 1.3 2008/06/25 05:44:43 qcheng Exp $

--%>



<%@ page info="PMDefaultSessionConditionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PMDefaultSessionConditionAddViewBean"
...
<cc:form name="PMDefaultSessionConditionAdd" method="post" defaultCommandChild="/btnFilter">
