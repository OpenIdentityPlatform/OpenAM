<%--
   ...
   $Id: IdentitySubjectAdd.jsp,v 1.3 2008/06/25 05:44:42 qcheng Exp $

--%>



<%@ page info="IdentitySubjectAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.IdentitySubjectAddViewBean"
...
<cc:form name="IdentitySubjectAdd" method="post" defaultCommandChild="/btnFilter">
