<%--
   ...
   $Id: AuthToRealmEdit.jsp,v 1.3 2008/06/25 05:44:41 qcheng Exp $

--%>



<%@ page info="AuthToRealmEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.AuthToRealmEditViewBean"
...
<cc:form name="AuthToRealmEdit" method="post" defaultCommandChild="/btnFilter">
