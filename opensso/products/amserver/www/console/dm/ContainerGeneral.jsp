<%--
   ...
   $Id: ContainerGeneral.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="ContainerGeneral" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.ContainerGeneralViewBean"
...
<cc:form name="ContainerGeneral" method="post" defaultCommandChild="/button1">
