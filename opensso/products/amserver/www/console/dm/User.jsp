<%--
   ...
   $Id: User.jsp,v 1.5 2008/07/22 21:41:02 babysunil Exp $

--%>

<%@ page info="User" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.UserViewBean"
...
<cc:form name="User" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.users" 
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><cc:button name="btnSearch" bundleID="amConsole" defaultValue="button.search" type="primary" onClick="document.forms['User'].submit();" /></td>
    </tr>
</table>
...
<cc:actiontable
    name="tblSearch"
    title="table.user.title.name"
    bundleID="amConsole"
    summary="table.user.summary"
    empty="table.user.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('User', 'User.tblSearch', 'tblButton', 'User.tblButtonDelete', this)"
