<%--
   ...
   $Id: GroupContainer.jsp,v 1.5 2008/07/22 21:39:20 babysunil Exp $

--%>

<%@ page info="GroupContainer" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.GroupContainerViewBean"
...
<cc:form name="GroupContainer" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.group.container" 
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><cc:button name="btnSearch" bundleID="amConsole" defaultValue="button.search" type="primary" onClick="document.forms['GroupContainer'].submit();" /></td>
    </tr>
</table>
...
<cc:actiontable
    name="tblSearch"
    title="table.group.container.title.name"
    bundleID="amConsole"
    summary="table.group.container.summary"
    empty="table.group.container.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('GroupContainer', 'GroupContainer.tblSearch', 'tblButton', 'GroupContainer.tblButtonDelete', this)"
