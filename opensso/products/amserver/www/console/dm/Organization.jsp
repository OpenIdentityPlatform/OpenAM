<%--
   ...
   $Id: Organization.jsp,v 1.5 2008/07/22 21:39:57 babysunil Exp $

--%>

<%@ page info="Organization" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.OrganizationViewBean"
...
<cc:form name="Organization" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.organizations" 
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><cc:button name="btnSearch" bundleID="amConsole" defaultValue="button.search" type="primary" onClick="document.forms['Organization'].submit();" /></td>
    </tr>
</table>
...
<cc:actiontable
    name="tblSearch"
    title="table.organization.title.name"
    bundleID="amConsole"
    summary="table.organization.summary"
    empty="table.organization.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('Organization', 'Organization.tblSearch', 'tblButton', 'Organization.tblButtonDelete', this)"
