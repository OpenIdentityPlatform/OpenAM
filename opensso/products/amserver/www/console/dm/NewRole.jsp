<%--
   ...
   $Id: NewRole.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="NewRole" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.NewRoleViewBean"
...
<cc:form name="NewRole" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitleTwoBtns" 
    bundleID="amConsole" 
    pageTitleText="page.title.role.create" 
