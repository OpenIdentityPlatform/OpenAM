...
<%@ page info="Agent" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.AgentViewBean"
...
<cc:form name="Agent" method="post" defaultCommandChild="/btnSearch">
...
<cc:actiontable
    name="tblSearch"
    title="table.agent.title.name"
    bundleID="amConsole"
    summary="table.agent.summary"
    empty="table.agent.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('Agent', 'Agent.tblSearch', 'tblButton', 'Agent.tblButtonDelete', this)"
