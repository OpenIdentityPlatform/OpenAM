<%--
   ...
   $Id: UserRoles.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="UserRoles" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.UserRolesViewBean"
...
<cc:form name="UserRoles" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.user.roles"
