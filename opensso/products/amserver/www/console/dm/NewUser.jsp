<%--
   ...
   $Id: NewUser.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="NewUser" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.NewUserViewBean"
...
<cc:form name="NewUser" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitleTwoBtns" 
    bundleID="amConsole" 
    pageTitleText="page.title.user.create" 
