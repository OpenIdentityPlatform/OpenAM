<%--
   ...
   $Id: GroupGeneral.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="GroupGeneral" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.GroupGeneralViewBean"
...
<cc:form name="GroupGeneral" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.group.edit" 
