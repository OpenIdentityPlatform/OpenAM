<%--
   ...
   $Id: NewDynamicGroup.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="NewDynamicGroup" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.NewDynamicGroupViewBean"
...
<cc:form name="NewDynamicGroup" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitleTwoBtns" 
    bundleID="amConsole" 
    pageTitleText="page.title.dynamic.group.create" 
