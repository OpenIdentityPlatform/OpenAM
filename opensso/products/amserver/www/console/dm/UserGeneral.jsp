<%--
   ...
   $Id: UserGeneral.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="UserGeneral" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.UserGeneralViewBean"
...
<cc:form name="UserGeneral" method="post" defaultCommandChild="/button1">
