<%--
   ...
   $Id: RoleServices.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="RoleServices" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.RoleServicesViewBean"
...
<cc:form name="RoleServices" method="post" defaultCommandChild="/button1">
...
<cc:actiontable
    ...
    empty="role.services.empty.table.message"
    ...
    selectionJavascript="toggleTblButtonState('RoleServices', 'RoleServices.tblSearch', 'tblButton', 'RoleServices.tblButtonDelete', this)"
