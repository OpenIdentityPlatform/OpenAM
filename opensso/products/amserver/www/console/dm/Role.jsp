<%--
   ...
   $Id: Role.jsp,v 1.5 2008/07/22 21:40:28 babysunil Exp $

--%>

<%@ page info="Role" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.RoleViewBean"
...
<cc:form name="Role" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.roles" 
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><cc:button name="btnSearch" bundleID="amConsole" defaultValue="button.search" type="primary" onClick="document.forms['Role'].submit();" /></td>
    </tr>
</table>
...
<cc:actiontable
    name="tblSearch"
    title="table.role.title.name"
    bundleID="amConsole"
    summary="table.role.summary"
    empty="table.role.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('Role', 'Role.tblSearch', 'tblButton', 'Role.tblButtonDelete', this)"
