<%--
   ...
   $Id: SearchUsers.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="SearchUsers" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.SearchUsersViewBean"
...
<cc:form name="SearchUsers" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitleTwoBtns" 
    bundleID="amConsole" 
    pageTitleText="page.title.search.users" 
