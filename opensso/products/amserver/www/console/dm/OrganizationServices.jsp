<%--
   ...
   $Id: OrganizationServices.jsp,v 1.4 2008/06/25 05:44:39 qcheng Exp $

--%>

<%@ page info="OrganizationServices" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.OrganizationServicesViewBean"
...
<cc:form name="OrganizationServices" method="post" defaultCommandChild="/button1">
...
<cc:actiontable
    ...
    selectionJavascript="toggleTblButtonState('OrganizationServices', 'OrganizationServices.tblSearch', 'tblButton', 'OrganizationServices.tblButtonDelete', this)"
