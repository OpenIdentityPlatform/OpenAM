<%--
   ...
   $Id: ContainerServices.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="ContainerServices" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.ContainerServicesViewBean"
...
<cc:form name="ContainerServices" method="post" defaultCommandChild="/button1">
...
<cc:actiontable
    ...
    selectionJavascript="toggleTblButtonState('ContainerServices', 'ContainerServices.tblSearch', 'tblButton', 'ContainerServices.tblButtonDelete', this)"
