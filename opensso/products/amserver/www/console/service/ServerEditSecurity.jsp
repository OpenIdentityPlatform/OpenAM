<%--
   ...
   $Id: ServerEditSecurity.jsp,v 1.3 2008/06/25 05:44:53 qcheng Exp $

--%>

<%@ page info="ServerEditSecurity" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.ServerEditSecurityViewBean"
...
<cc:form name="ServerEditSecurity" method="post" defaultCommandChild="/button1">
