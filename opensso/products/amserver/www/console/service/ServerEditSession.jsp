<%--
   ...
   $Id: ServerEditSession.jsp,v 1.3 2008/06/25 05:44:54 qcheng Exp $

--%>

<%@ page info="ServerEditSession" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.ServerEditSessionViewBean"
...
<cc:form name="ServerEditSession" method="post" defaultCommandChild="/button1">
