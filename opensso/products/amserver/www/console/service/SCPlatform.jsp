<%--
   ...
   $Id: SCPlatform.jsp,v 1.3 2008/06/25 05:44:53 qcheng Exp $
...
<%@ page info="SCPlatform" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SCPlatformViewBean"
...
<cc:form name="SCPlatform" method="post" defaultCommandChild="/button1" >
