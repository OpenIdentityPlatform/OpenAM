...
<html>
<%@page info="AMInvalidURL" language="java"%>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato"%>
<%@taglib uri="/WEB-INF/com_sun_web_ui/cc.tld" prefix="cc"%>
<jato:useViewBean className="com.sun.identity.console.base.AMInvalidURLViewBean">
...
<p>&nbsp;</p>
<cc:form name="AMInvalidURL" method="post" defaultCommandChild="/">
