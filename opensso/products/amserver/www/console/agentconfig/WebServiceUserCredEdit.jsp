<%--
   ...
   $Id: WebServiceUserCredEdit.jsp,v 1.3 2008/06/25 05:44:35 qcheng Exp $

--%>

<%@ page info="WebServiceUserCredEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.agentconfig.WebServiceUserCredEditViewBean"
...
<cc:form name="WebServiceUserCredEdit" method="post" defaultCommandChild="/button1">
