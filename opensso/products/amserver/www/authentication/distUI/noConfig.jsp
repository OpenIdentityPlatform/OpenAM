<%--
   ...
   $Id: noConfig.jsp,v 1.5 2008/08/15 01:05:31 veiming Exp $
      ...
      <td class="LogCntTd" style="background-image: url(<%= ServiceURI %>/images/login-backimage.jpg);
        ...
        width="100%" title="">
          <tr>
            ...
            src="<%= ServiceURI %>/images/PrimaryProductName.png" alt="<auth:resBundle bundleName="amAuthUI" resourceKey="basic_realm" />" border="0" />
