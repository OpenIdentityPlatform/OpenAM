...
/**
 * This class represents the value part stored in the cache. Each IdCacheBlock
 * object would represent a Directory entry. It caches the attributes
 * corresponding to that entry. It also keeps track of red other details such as
 * the Organization DN for the entry.
 * 
 * <p>
 ...
 * principal. A single copy of the attributes is stored in the IdCacheBlock
...
public class IdCacheBlock extends CacheBlockBase {
    ...
    protected static final String ENTRY_USER_EXPIRE_TIME_KEY = 
        "com.sun.identity.idm.cache.entry.user.expire.time";
