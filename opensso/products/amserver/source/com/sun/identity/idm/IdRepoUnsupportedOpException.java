 ...
 *
 * $Id: IdRepoUnsupportedOpException.java,v 1.3 2008/06/25 05:43:29 qcheng Exp $
 *
 */
...
public class IdRepoUnsupportedOpException extends IdRepoException {
    ...
    public IdRepoUnsupportedOpException(String msg, String errorCode) {
        super(msg, errorCode);
    }
     ...
     */
    public IdRepoUnsupportedOpException(String rbName, String errorCode,
            Object[] args) {
