...
public class LEAuthLevelCondition implements Condition {
    ...
    public ConditionDecision getConditionDecision(SSOToken token, Map env) 
        ...
        if (DEBUG.messageEnabled()) {
            DEBUG.message("LEAuthLevelCondition.getConditionDecision():"
                    + "entering"); 
        }
    ...
    private boolean validateProperties() throws PolicyException {
        ...
        if (DEBUG.messageEnabled()) {
            DEBUG.message("LEAuthLevelCondition.setProperties(),"
    ...
    private int getMaxRequestAuthLevel(Map env) 
        ...
        if (DEBUG.messageEnabled()) {
            DEBUG.message("LEAuthLevelCondition.getMaxRequestAuthLevel("
        ...
        if (envAuthLevelObject != null) {
            if(envAuthLevelObject instanceof Integer) {
                ...
                if (!envAuthLevelSet.isEmpty()) {
                    ...
                    while (iter.hasNext()) { 
                        Object envAuthLevelElement 
                                = iter.next();
                        if (!(envAuthLevelElement instanceof String)) {
                            if (DEBUG.warningEnabled()) {
                                DEBUG.warning("LEAuthLevelCondition."
    ...
    private int getAuthLevel(String qualifiedLevel) 
        ...
        try {
            ...
            if (DEBUG.warningEnabled()) {
                DEBUG.warning("LEAuthLevelCondition.getAuthLevel("
