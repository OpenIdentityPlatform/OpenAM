 ...
 *
 * $Id: SearchUsersViewBean.java,v 1.2 2008/06/25 05:42:55 qcheng Exp $
 *
 */
...
public class SearchUsersViewBean
    extends RMRealmOpViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
	"/console/dm/SearchUsers.jsp";
	...
	disableButton("button1", true);
        ptModel.setPageTitleText(
            model.getLocalizedString("page.title.search.users"));
    }
	...
	model = new SearchModelImpl(rc.getRequest(),getPageSessionAttributes());
        return model;
    }
	...
	return "breadcrumbs.directorymanager.users.search";
    }
