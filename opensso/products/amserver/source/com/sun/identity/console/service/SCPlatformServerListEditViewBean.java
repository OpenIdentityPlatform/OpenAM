 ...
 *
 * $Id: SCPlatformServerListEditViewBean.java,v 1.3 2008/06/25 05:43:15 qcheng Exp $
 *
 */
...
public class SCPlatformServerListEditViewBean
    extends SCPlatformServerListViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/service/SCPlatformServerListEdit.jsp";
    private static final String PGATTR_INDEX = "serverListTblIndex";
    private boolean populateValues = false;

    public SCPlatformServerListEditViewBean() {
        super("SCPlatformServerListEdit", DEFAULT_DISPLAY_URL);
    }
    ...
    protected String getPageTitleText() {
        return "platform.service.serverList.edit.page.title";
    }
    ...
    protected void createPropertyModel() {
        ...
        String xmlFile = (canModify) ?
           ...
           "com/sun/identity/console/propertySCPlatformServerList_Readonly.xml";
    ...
    protected String getBreadCrumbDisplayName() {
        return "breadcrumbs.services.platform.instance.edit";
    }
