 ...
 *
 * $Id: NewDynamicGroupViewBean.java,v 1.2 2008/06/25 05:42:54 qcheng Exp $
 *
 */
...
public class NewDynamicGroupViewBean
    extends RMRealmOpViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
	"/console/dm/NewDynamicGroup.jsp";
    ...
    public NewDynamicGroupViewBean() {
	super("NewDynamicGroup");
	...
	propertySheetModel = new AMPropertySheetModel(
	    model.getCreateDynamicGroupXML());
	...
	try {
	    ...
	    Map values = ps.getAttributeValues(model.getDataMap(
                DMConstants.SUB_SCHEMA_FILTERED_GROUP), false, model);

            if (values == null) {
                values = new HashMap();
            }
	    // add the type of group being created. 
            values.put(GroupModel.GROUP_TYPE, 
		Integer.toString(AMObject.DYNAMIC_GROUP));
	...
	return "breadcrumbs.directorymanager.dynamicgroup.add";
    }
