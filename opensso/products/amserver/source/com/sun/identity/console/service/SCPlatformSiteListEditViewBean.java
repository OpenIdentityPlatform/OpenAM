 ...
 *
 * $Id: SCPlatformSiteListEditViewBean.java,v 1.3 2008/06/25 05:43:15 qcheng Exp $
 *
 */
...
public class SCPlatformSiteListEditViewBean
    extends SCPlatformSiteListViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/service/SCPlatformSiteListEdit.jsp";
    private static final String PGATTR_INDEX = "siteListTblIndex";
    private boolean populateValues = false;

    public SCPlatformSiteListEditViewBean() {
        super("SCPlatformSiteListEdit", DEFAULT_DISPLAY_URL);
    }
    ...
    protected String getPageTitleText() {
        return "platform.service.siteList.edit.page.title";
    }
    ...
    protected void handleButton1Request(Map values) {
        ...
        Map mapAttrs = (Map)getPageSessionAttribute(
            SCPlatformViewBean.PROPERTY_ATTRIBUTE);
        OrderedSet siteList = (OrderedSet)mapAttrs.get(
            SCPlatformModelImpl.ATTRIBUTE_NAME_SITE_LIST);
        int index = Integer.parseInt((String)
            getPageSessionAttribute(PGATTR_INDEX));
    ...
    protected void createPropertyModel() {
        ...
        String xmlFile = (canModify) ?
            "com/sun/identity/console/propertySCPlatformSiteList.xml" :
            "com/sun/identity/console/propertySCPlatformSiteList_Readonly.xml";
    ...
    protected String getBreadCrumbDisplayName() {
        return "breadcrumbs.services.platform.site.edit";
    }
