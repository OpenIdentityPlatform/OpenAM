 ...
 *
 * $Id: G11NCharsetAliasEditViewBean.java,v 1.3 2008/06/25 05:43:14 qcheng Exp $
 *
 */
...
public class G11NCharsetAliasEditViewBean
    extends G11NCharsetAliasViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/service/G11NCharsetAliasEdit.jsp";
    private static final String PGATTR_INDEX = "charsetAliasTblIndex";
    private boolean populateValues = false;

    public G11NCharsetAliasEditViewBean() {
        super("G11NCharsetAliasEdit", DEFAULT_DISPLAY_URL);
    }
    ...
    protected String getPageTitleText() {
        return "globalization.service.CharsetAlias.edit.page.title";
    }
    ...
    protected void handleButton1Request(Map values) {
        ...
        Map mapAttrs = (Map)getPageSessionAttribute(
            SMG11NViewBean.PROPERTY_ATTRIBUTE);
        OrderedSet aliases = (OrderedSet)mapAttrs.get(
            SMG11NModelImpl.ATTRIBUTE_NAME_CHARSET_ALIAS);
        int index = Integer.parseInt((String)
            getPageSessionAttribute(PGATTR_INDEX));

        String val = CharsetAliasEntry.toString(
    ...
    protected void createPropertyModel() {
        ...
        String xmlFile = (canModify) ?
            ...
            "com/sun/identity/console/propertyG11NCharsetAlias_Readonly.xml";
