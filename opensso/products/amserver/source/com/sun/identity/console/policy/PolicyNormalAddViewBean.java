...
public class PolicyNormalAddViewBean
    extends PolicyNormalViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/policy/PolicyNormalAdd.jsp";

    /**
     * Creates a policy creation view bean.
     */
    public PolicyNormalAddViewBean() {
        super("PolicyNormalAdd", DEFAULT_DISPLAY_URL);
    }
    ...
    protected String getPropertyXMLFileName(boolean readonly) {
        return "com/sun/identity/console/propertyPMPolicyNormal.xml";
    }

    protected String getBreadCrumbDisplayName() {
        return "breadcrumbs.addPolicy";
    }
