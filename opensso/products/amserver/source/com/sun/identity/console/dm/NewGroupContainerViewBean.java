 ...
 *
 * $Id: NewGroupContainerViewBean.java,v 1.2 2008/06/25 05:42:54 qcheng Exp $
 *
 */
...
public class NewGroupContainerViewBean
    extends RMRealmOpViewBeanBase
{
    public static final String DEFAULT_DISPLAY_URL =
	"/console/dm/NewGroupContainer.jsp";
    ...
    public NewGroupContainerViewBean() {
	super("NewGroupContainer");
	...
	propertySheetModel = new AMPropertySheetModel(
	    model.getCreateGroupContainerXML());
	...
	String name = (String)getDisplayFieldValue(GroupContainerModel.NAME);
	...
	if (name.length() > 0) {
		...
		model.createGroupContainer(location, values);
	        forwardToGCView(event);
    ...
    private void forwardToGCView(RequestInvocationEvent event){
	...
	return "breadcrumbs.directorymanager.groupcontainer.add";
    }
