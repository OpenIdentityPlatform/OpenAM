 ...
 */
public class SsoServerSAML1CacheEntryImpl extends SsoServerSAML1CacheEntry {
     ...
     * Constructor
     */
    public SsoServerSAML1CacheEntryImpl (SnmpMib myMib) {
        super(myMib);
    ...
    public ObjectName
        createSsoServerSAML1CacheEntryObjectName (MBeanServer server)
    {
        String classModule = "SsoServerSAML1CacheEntryImpl." +
            "createSsoServerSAML1CacheEntryObjectName: ";
        String prfx = "ssoServerSAML1CacheEntry.";
