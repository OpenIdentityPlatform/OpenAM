 ...
 */
public class SsoServerWSSAgentsSTSAgtGrpEntryImpl extends
    SsoServerWSSAgentsSTSAgtGrpEntry
{
     ...
     * Constructor
     */
    public SsoServerWSSAgentsSTSAgtGrpEntryImpl (SnmpMib myMib) {
        super(myMib);
    ...
    public ObjectName
        createSsoServerWSSAgentsSTSAgtGrpEntryObjectName (MBeanServer server)
    {
        String classModule = "SsoServerWSSAgentsSTSAgtGrpEntryImpl." +
            "createSsoServerWSSAgentsSTSAgtGrpEntryObjectName: ";
        String prfx = "ssoServerWSSAgentsSTSAgtGrpEntry.";
        ...
        String objname = myMibName +
            ...
            prfx + "WssAgentsSTSAgtGrpName=" + WssAgentsSTSAgtGrpName;
