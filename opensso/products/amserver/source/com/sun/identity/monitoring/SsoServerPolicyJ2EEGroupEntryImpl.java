 ...
 */
public class SsoServerPolicyJ2EEGroupEntryImpl extends
    SsoServerPolicyJ2EEGroupEntry
{
     ...
     * Constructor
     */
    public SsoServerPolicyJ2EEGroupEntryImpl (SnmpMib myMib) {
        super(myMib);
    ...
    public ObjectName
        createSsoServerPolicyJ2EEGroupEntryObjectName (MBeanServer server)
    {
        String classModule = "SsoServerPolicyJ2EEGroupEntryImpl." +
            "createSsoServerPolicyJ2EEGroupEntryObjectName: ";
        String prfx = "ssoServerPolicyJ2EEGroupEntry.";
