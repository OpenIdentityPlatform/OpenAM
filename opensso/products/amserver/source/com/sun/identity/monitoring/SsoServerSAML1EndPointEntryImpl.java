 ...
 */
public class SsoServerSAML1EndPointEntryImpl extends
    SsoServerSAML1EndPointEntry
{
     ...
     * Constructor
     */
    public SsoServerSAML1EndPointEntryImpl (SnmpMib myMib) {
        super(myMib);
    ...
    public ObjectName
        createSsoServerSAML1EndPointEntryObjectName (MBeanServer server)
    {
        String classModule = "SsoServerSAML1EndPointEntryImpl." +
            "createSsoServerSAML1EndPointEntryObjectName: ";
        String prfx = "ssoServerSAML1EndPointEntry.";
