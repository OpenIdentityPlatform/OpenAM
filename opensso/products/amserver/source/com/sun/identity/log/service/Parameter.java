 ...
 * log parameter. This class is registered with the SAX parser.
 */
public class Parameter implements ParseOutput {
    /**
    ...
    String pcdata) {
        ...
        paramIndex = ((ParamIndex)elems.elementAt(0)).intValue;
        paramValue = ((ParamValue)elems.elementAt(1)).str;
    }
} //end of Parameter
