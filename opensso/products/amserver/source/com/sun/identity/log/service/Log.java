 ...
 *
 * $Id: Log.java,v 1.3 2008/06/25 05:43:38 qcheng Exp $
 *
 */
 ...
 */
public class Log implements ParseOutput {
    /**
    ...
    String pcdata) {
        _logname = (String) atts.get("logName");
        _loggedBySid = (String)atts.get("sid");
        _atts = atts;
    }
} //end of Log
