        ...
        extends com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (state) {
                    case  0 :
                        if (("library" == ___local)&&("" == ___uri)) {
                            _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryElementImpl) spawnChildFromEnterElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryElementImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("library" == ___local)&&("" == ___uri)) {
                        ...
                        break;
                    case  2 :
                        _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl) spawnChildFromEnterElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                        return ;
                    case  1 :
                        if (("library" == ___local)&&("" == ___uri)) {
                            _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryElementImpl) spawnChildFromEnterElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryElementImpl.class), 1, ___uri, ___local, ___qname, __atts)));
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl) spawnChildFromLeaveElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl.class), 3, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                        if (("library" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl.class), 3, ___uri, ___local, ___qname)));
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl.class), 3, ___uri, ___local, ___qname)));
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  2 :
                            _getLibrary().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl) spawnChildFromText((com.sun.identity.diagnostic.base.core.jaxbgen.impl.LibraryTypeImpl.class), 3, value)));
                            return ;
                        case  1 :
