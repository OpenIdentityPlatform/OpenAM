...
public class ResourceBundlesTypeImpl implements com.sun.identity.diagnostic.base.core.jaxbgen.ResourceBundlesType, com.sun.xml.bind.JAXBObject, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallableObject, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.XMLSerializable, com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.diagnostic.base.core.jaxbgen.ResourceBundlesType.class);
    }
    ...
    public com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceBundlesTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Resource.get(idx1) instanceof javax.xml.bind.Element) {
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Resource.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Resource.get(idx1 ++)), "Resource");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (_Resource.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Resource.get(idx1 ++)), "Resource");
            } else {
                idx1 += 1;
            }
        }
...
+"\u0000=com.sun.identity.diagnostic.base.core.jaxbgen.ResourceElem"
...
+".sun.identity.diagnostic.base.core.jaxbgen.ResourceTypeq\u0000~\u0000\u001f"
...
+"g/2001/XMLSchema-instanceq\u0000~\u0000\u001asq\u0000~\u0000\u001bt\u0000\bresourcet\u0000\u0000sr\u0000\"com.su"
...
+"\u0001pq\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000$q\u0000~\u0000\u000eq\u0000~\u0000%q\u0000~\u0000\"q\u0000~\u0000)x"));
        ...
        extends com.sun.identity.diagnostic.base.core.jaxbgen.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceBundlesTypeImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("resource" == ___local)&&("" == ___uri)) {
                            _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceElementImpl) spawnChildFromEnterElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceElementImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("resource" == ___local)&&("" == ___uri)) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl) spawnChildFromEnterElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl) spawnChildFromLeaveElement((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            _getResource().add(((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl) spawnChildFromText((com.sun.identity.diagnostic.base.core.jaxbgen.impl.ResourceTypeImpl.class), 2, value)));
                            return ;
                    }
