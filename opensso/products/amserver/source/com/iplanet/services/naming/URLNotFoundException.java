 ...
 *
 * $Id: URLNotFoundException.java,v 1.2 2008/06/25 05:41:39 qcheng Exp $
 *
 */
...
/**
 * A <code>URLNotFoundException</code> is thrown if the Naming Service can not
...
public class URLNotFoundException extends Exception {
     ...
     *            the exception
     */
    public URLNotFoundException(Throwable t) {
        super(t.getMessage());
        fillInStackTrace();
    }
}
