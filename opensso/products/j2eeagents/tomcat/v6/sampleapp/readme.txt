<!--
   ...
   $Id: readme.txt,v 1.2 2008/11/28 12:31:49 saueree Exp $
...
with the tomcat  Server and the J2EE Agent. Please note that 
...
To rebuild the entire application from scratch, follow these steps:
   ...
   2. Replace 'APPSERV_LIB_DIR' in build.xml with the directory where servlet-api.jar is located. 
      For Example: Replace APPSERV_LIB_DIR with /opt/apache-tomcat-6.0.14/lib 
      where /opt/apache-tomcat-6.0.14 is the CATALINA_HOME directory.
   3. Compile and assemble the application.
      ...
      accordingly.  The Universal Id can be verified in opensso console.
