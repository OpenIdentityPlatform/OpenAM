 ...
 */
public class UnconfigureServerEnvTask extends UpdateServerEnvBase implements ITask {
    public static final String
    	LOC_TSK_MSG_UNCONFIGURE_SET_ENV_EXECUTE =
        "TSK_MSG_UNCONFIGURE_SET_ENV_EXECUTE";
