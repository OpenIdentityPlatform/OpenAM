 ...
 *
 */
package org.forgerock.agents.tomcat.v6;
...
public class TomcatLifeCycleListener implements LifecycleListener {
    ...
    public void lifecycleEvent(LifecycleEvent le) {
        String eventType = le.getType();
        if (eventType.equals(Lifecycle.START_EVENT)) {
            CommonLifeCycleListener.startup();
        } else if (le.getType().equals(Lifecycle.STOP_EVENT)) {
