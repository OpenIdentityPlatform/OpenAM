 ...
 *
 * $Id: AmWLCDSSOTaskHandler.java,v 1.2 2008/06/25 05:52:22 qcheng Exp $
 *
 */
 ...
 *
 */
public class AmWLCDSSOTaskHandler extends CDSSOTaskHandler {
    
    public AmWLCDSSOTaskHandler(Manager manager) {
        super(manager);
    }
