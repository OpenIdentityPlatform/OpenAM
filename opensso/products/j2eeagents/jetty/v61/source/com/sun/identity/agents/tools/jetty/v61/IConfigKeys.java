...
public interface IConfigKeys {
     ...
     */
    public static final String STR_KEY_JETTY_SERVER_XML_FILE =
    	"JETTY_SERVER_XML_FILE";
    /*
     * Key for the location of the Jetty start.jar file
     */
    public static final String STR_KEY_JETTY_START_JAR_PATH =
        "JETTY_START_JAR_PATH";
    /*
     * Key for the interaction to lookup config dir
     */
