 ...
 *
 * $Id: UnconfigureServerPolicyTask.java,v 1.1 2008/12/11 14:36:06 naghaon Exp $
 *
 */
...
public class UnconfigureServerPolicyTask extends ServerPolicyBase
        implements ITask {
    
    public static final String LOC_TSK_MSG_UNCONFIGURE_SERVER_POLICY_EXECUTE =
            "TSK_MSG_UNCONFIGURE_SERVER_POLICY_EXECUTE";
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess,
        ...
        LocalizedMessage message = LocalizedMessage.get(
                LOC_TSK_MSG_UNCONFIGURE_SERVER_POLICY_EXECUTE,
                STR_JB_GROUP, args);
        return message;
    }
