 ...
 *
 * $Id: ServerPolicyFinder.java,v 1.1 2008/12/11 14:36:06 naghaon Exp $
 *
 */
...
public class ServerPolicyFinder implements IDefaultValueFinder,
    ...
    public String getDefaultValue(String key, IStateAccess state, String value) {
        ...
        if (value != null) {
            ...
            result = (String) state.get(STR_KEY_JB_SERVER_POLICY_FILE);
        }
