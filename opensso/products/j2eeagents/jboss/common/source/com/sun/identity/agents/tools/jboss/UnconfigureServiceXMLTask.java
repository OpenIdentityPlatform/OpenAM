 ...
 *
 * $Id: UnconfigureServiceXMLTask.java,v 1.1 2008/12/11 14:36:06 naghaon Exp $
 *
 */
...
/**
 * Unconfigures agent's jar files from JBoss server instance's
 * jboss-service.xml.
 */

public class UnconfigureServiceXMLTask extends ServiceXMLBase implements ITask {
    
    public static final String LOC_TSK_MSG_UNCONFIGURE_SERVICE_XML_EXECUTE =
            "TSK_MSG_UNCONFIGURE_SERVICE_XML_EXECUTE";
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess,
        ...
        LocalizedMessage message = LocalizedMessage.get(
                LOC_TSK_MSG_UNCONFIGURE_SERVICE_XML_EXECUTE,
                STR_JB_GROUP, args);
        return message;
    }
