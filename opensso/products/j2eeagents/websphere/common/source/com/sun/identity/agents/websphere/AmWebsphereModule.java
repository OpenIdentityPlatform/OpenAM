 ...
 *
 * $Id: AmWebsphereModule.java,v 1.2 2008/11/21 22:21:45 leiming Exp $
 *
 */
...
/**
 * Webphere specific Module class.
 */
public class AmWebsphereModule implements IAmWebsphereModuleConstants {
    ...
    public static byte getModuleCode() {
        return AM_WEBSPHERE_MODULE_CODE;
    }
    ...
    private static Module _module = new Module(getModuleCode(),
            STR_AM_WEBSPHERE_MODULE, AM_WEBSPHERE_RESOURCE);
}
