 ...
 *
 * $Id: DoctypeToken.java,v 1.2 2008/06/25 05:51:31 qcheng Exp $
 *
 */
...
public class DoctypeToken extends Token {
    ...
    DoctypeToken(String tokenString) {
        super(tokenString);
    }
    ...
    String getDoctypeString() {
        ...
        return innerString.trim().substring(DOCTYPE.length());
    }

    void updateDoctypeString(String newDoctypeString) {
        setTokenString("<!" + DOCTYPE + " " + newDoctypeString + ">");
    }

    protected String getTokenTypeString() {
        return TOKEN_TYPE_DOCTYPE;
    }
}
