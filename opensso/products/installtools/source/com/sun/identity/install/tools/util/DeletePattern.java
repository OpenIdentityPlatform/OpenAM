 ...
 *
 * $Id: DeletePattern.java,v 1.2 2008/06/25 05:51:29 qcheng Exp $
 *
 */
...
public class DeletePattern extends MatchPattern {
    ...
    public DeletePattern(String pattern, int matchType, int numSuccessiveLines)
    {
        ...
        setNumberOfSuccessiveLines(numSuccessiveLines);
    }

    public int getNumberOfSuccessiveLines() {
        return numSuccessiveLines;
    }

    public void setNumberOfSuccessiveLines(int numSuccessiveLines) {
        this.numSuccessiveLines = numSuccessiveLines;
    }
