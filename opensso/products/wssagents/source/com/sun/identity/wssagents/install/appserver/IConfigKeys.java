 ...
 *
 * $Id: IConfigKeys.java,v 1.1 2009/06/12 21:58:04 huacui Exp $
 *
 */
...
public interface IConfigKeys {
    ...
    public static String STR_KEY_AS_INSTALL_DIR = "AS_INSTALL_DIR";    

    public static String STR_KEY_AS_DOMAIN_XML_FILE  = "AS_DOMAIN_XML_FILE";
    public static String STR_KEY_AS_WS_RT_JAR_FILE = "AS_WS_RT_JAR_FILE";
    public static String STR_KEY_AS_WS_TOOLS_JAR_FILE = "AS_WS_TOOLS_JAR_FILE";
    public static String STR_KEY_AS_WS_API_JAR_FILE = "AS_WS_API_JAR_FILE";
