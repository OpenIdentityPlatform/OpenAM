 ...
 *
 * $Id: ConfigureDomainXMLTask.java,v 1.1 2009/06/12 22:03:03 huacui Exp $
 *
 */
            ...
            if (serverXMLFile != null) {
                try {
                    ...
                    if (instanceConfig != null) {
                        status = addAgentJavaConfig(domainXMLDoc, 
                                   instanceConfig, stateAccess);
                        status &= addHttpProvider(domainXMLDoc,
                                   instanceConfig, stateAccess);
