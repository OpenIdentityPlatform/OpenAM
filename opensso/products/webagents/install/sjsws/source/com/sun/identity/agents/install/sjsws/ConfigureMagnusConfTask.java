 ...
 *
 * $Id: ConfigureMagnusConfTask.java,v 1.2 2008/06/25 05:54:40 qcheng Exp $
 *
 */
...
/**
 * Configures SWS server instance's magnus.conf with agent
 * entry.
 */

public class ConfigureMagnusConfTask extends MagnusConfBase implements 
    InstallConstants, ITask, IConstants, IConfigKeys {
    
    private static final String LOC_TSK_MSG_CONFIGURE_MAGNUS_CONF_EXECUTE =
            "TSK_MSG_CONFIGURE_MAGNUS_CONF_EXECUTE";
    private static final String LOC_TSK_MSG_CONFIGURE_MAGNUS_CONF_ROLLBACK =
            "TSK_MSG_CONFIGURE_MAGNUS_CONF_ROLLBACK";
    
    public boolean execute(String name, IStateAccess stateAccess,
            Map properties) throws InstallException {
        return configureMagnusConf(stateAccess);
    }
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess,
        ...
        LocalizedMessage message = LocalizedMessage.get(
                LOC_TSK_MSG_CONFIGURE_MAGNUS_CONF_EXECUTE,
                STR_SWS_GROUP, args);
        return message;
    }
    ...
    public LocalizedMessage getRollBackMessage(IStateAccess stateAccess,
        ...
        Object[] args = { magnusConfFile };
        LocalizedMessage message = LocalizedMessage.get(
                LOC_TSK_MSG_CONFIGURE_MAGNUS_CONF_ROLLBACK,
                STR_SWS_GROUP, args);
        return message;
    }
