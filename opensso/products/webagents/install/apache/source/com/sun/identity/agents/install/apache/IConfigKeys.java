 ...
 *
 * $Id: IConfigKeys.java,v 1.2 2008/06/25 05:54:34 qcheng Exp $
 *
 */
...
public interface IConfigKeys {
     ...
     */
    public static String STR_KEY_APC_INST_CONF_DIR = "CONFIG_DIR";
    
    /**
     * Key to store Apache home dir
     */
    public static String STR_KEY_APC_HOME_DIR = "APC_HOME_DIR";
    
    /**
     * Key to store Apache bin dir
     */
    public static String STR_KEY_APC_BIN_DIR = "APC_BIN_DIR";

    /**
     * Key to store Apache server instance name
     */
    public static String STR_KEY_APC_INST_NAME = "INSTANCE_NAME";
    
    /**
     * Key to apache httpd conf file
     */
    public static String STR_KEY_APC_HTTPD_FILE  = "APC_HTTPD_FILE";
