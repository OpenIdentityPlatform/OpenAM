 ...
 *
 * $Id: ConfigFinder.java,v 1.2 2008/06/25 05:54:34 qcheng Exp $
 *
 */
...
/**
 * Displays default Apache server instance's config directory.
 */
public class ConfigFinder implements IDefaultValueFinder,
    ...
    private String getDefaultConfigDirectoryPath(IStateAccess state) {
        ...
        if (OSChecker.isWindows()) {
            result = STR_APC_CONFIG_DIR_WINDOWS;
        } else {
            result = STR_APC_CONFIG_DIR_UNIX;
        }
        return result;
    }
}
