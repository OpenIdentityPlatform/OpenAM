...
public class ConfigDirValidator extends ValidatorBase
    ...
    private static String LOC_VA_MSG_APC_VAL_CONFIG_DIR =
            "VA_MSG_APC_VAL_CONFIG_DIR";
    private static String LOC_VA_WRN_APC_IN_VAL_CONFIG_DIR =
            "VA_WRN_APC_IN_VAL_CONFIG_DIR";
    ...
    public ValidationResult isConfigDirValid(String configDir, Map props,
        ...
        if((configDir != null) && (configDir.trim().length() >= 0)) {
            ...
            if (FileUtils.isFileValid(apcHttpdFile)) {
                ...
                state.put(STR_KEY_APC_HTTPD_FILE, apcHttpdFile);

                // store Apache home and bin in install state
                String apcHomeDir = (new File(apcHttpdFile)).
                                           getParentFile().getParent();
                state.put(STR_KEY_APC_HOME_DIR, apcHomeDir);
                state.put(STR_KEY_APC_BIN_DIR,
                ...
                returnMessage =
                        LocalizedMessage.get(LOC_VA_MSG_APC_VAL_CONFIG_DIR,
                        STR_APC_GROUP,new Object[] {configDir});
        ...
        if (validRes.getIntValue() ==
            ...
            returnMessage =
                    LocalizedMessage.get(LOC_VA_WRN_APC_IN_VAL_CONFIG_DIR,
                    STR_APC_GROUP,new Object[] {configDir});
        }
    ...
    public void initializeValidatorMap() throws InstallException {
        ...
        try {
            getValidatorMap().put("VALID_APC_CONFIG_DIR",
