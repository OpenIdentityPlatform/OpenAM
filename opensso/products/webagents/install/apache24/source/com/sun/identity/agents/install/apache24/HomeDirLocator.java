...
public class HomeDirLocator implements IServerHomeDirLocator,
    ...
    private static String LOC_APC24_ERR_IN_VALID_HOME_DIR =
            "APC24_ERR_IN_VALID_HOME_DIR";
    ...
    public String getServerDirectory(IStateAccess state)
        ...
        String apacheConfigDir = (String)state.get(STR_KEY_APC24_INST_CONF_DIR);
        if ((apacheConfigDir != null) && (apacheConfigDir.length() > 0)) {
            ...
            // Apache home dir
            String apcHomeDir = (String)state.get(STR_KEY_APC24_HOME_DIR);
        ...
        if(!FileUtils.isDirValid(serverHomeDir)) {
            ...
            throw new InstallException(
                    LocalizedMessage.get(LOC_APC24_ERR_IN_VALID_HOME_DIR,
                    STR_APC24_GROUP));
        }
