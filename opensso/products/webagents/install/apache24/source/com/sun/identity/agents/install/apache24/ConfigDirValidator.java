...
public class ConfigDirValidator extends ValidatorBase
    ...
    private static String LOC_VA_MSG_APC24_VAL_CONFIG_DIR =
            "VA_MSG_APC24_VAL_CONFIG_DIR";
    private static String LOC_VA_WRN_APC24_IN_VAL_CONFIG_DIR =
            "VA_WRN_APC24_IN_VAL_CONFIG_DIR";
    ...
    public ValidationResult isConfigDirValid(String configDir, Map props,
        ...
        if((configDir != null) && (configDir.trim().length() >= 0)) {
            ...
            String apcHttpdFile = configDir + FILE_SEP +
                    STR_APC24_HTTPD_FILE;
            
            if (FileUtils.isFileValid(apcHttpdFile)) {
                
                // store instance's  file locations in install state
                state.put(STR_KEY_APC24_HTTPD_FILE, apcHttpdFile);

                // store Apache home and bin in install state
                String apcHomeDir = (new File(apcHttpdFile)).
                                           getParentFile().getParent();
                state.put(STR_KEY_APC24_HOME_DIR, apcHomeDir);
                state.put(STR_KEY_APC24_BIN_DIR,
                           apcHomeDir + FILE_SEP + STR_APC24_BIN_DIR);
                ...
                returnMessage =
                        LocalizedMessage.get(LOC_VA_MSG_APC24_VAL_CONFIG_DIR,
                        STR_APC24_GROUP,new Object[] {configDir});
        ...
        if (validRes.getIntValue() ==
            ...
            returnMessage =
                    LocalizedMessage.get(LOC_VA_WRN_APC24_IN_VAL_CONFIG_DIR,
                    STR_APC24_GROUP,new Object[] {configDir});
        }
    ...
    public void initializeValidatorMap() throws InstallException {
        ...
        try {
            getValidatorMap().put("VALID_APC24_CONFIG_DIR",
