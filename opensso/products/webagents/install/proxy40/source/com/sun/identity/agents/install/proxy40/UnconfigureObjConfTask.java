 ...
 *
 * $Id: UnconfigureObjConfTask.java,v 1.1 2009/01/12 09:25:27 ranajitgh Exp $
 *
 */
...
/**
 * Unconfigures Proxy instance's obj.conf.  Removes Agent related entries.
 * 
 */
public class UnconfigureObjConfTask extends ObjConfBase
        implements ITask {
    
    private static final String LOC_TSK_MSG_UNCONFIGURE_OBJ_CONF_EXECUTE =
            "TSK_MSG_UNCONFIGURE_OBJ_CONF_EXECUTE";
    ...
    public LocalizedMessage getExecutionMessage(IStateAccess stateAccess,
        ...
        LocalizedMessage message = LocalizedMessage.get(
                LOC_TSK_MSG_UNCONFIGURE_OBJ_CONF_EXECUTE,
                STR_PROXY40_GROUP, args);
        return message;
    }
