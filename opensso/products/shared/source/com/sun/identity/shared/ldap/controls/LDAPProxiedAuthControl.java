 ...
 *     // the DN "uid=charlie,ou=people,o=example,dc=com".
 *     LDAPProxiedAuthControl ctrl =
 *         new LDAPProxiedAuthControl( "uid=charlie,ou=people,dc=example,dc=com",
 *                                     true );
 *
 ...
 *     LDAPSearchResults res = ld.search( "dc=example,dc=com",
...
public class LDAPProxiedAuthControl extends LDAPControl {
    ...
    public int getType() {
        return LDAPControl.LDAP_PROXIED_AUTH_CONTROL;
    }
