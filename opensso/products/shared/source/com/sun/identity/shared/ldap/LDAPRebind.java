 ...
 * referred LDAP server.  If the host and port are "ds.example.com:389", 
 * the directory administrator's name and password are used to authenticate.
 ...
 *  public myLDAPRebind () {
 *    myDN = "cn=admin,cn=Directory Administrators,cn=config";
 *    myPW = "s3creTpwd";
 *  }
 *
