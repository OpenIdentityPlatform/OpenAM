 ...
 * DN "uid=bjensen, ou=People, o=Example.com" has three components:
 * "uid=bjensen", "ou=People", and "o=Example.com".
 * <P>
 *
 * Each DN component consists of an attribute type and a value.
 * For example, in "o=Example.com", the attribute type is "o"
 * and the value is "Example.com".
 * <P>
 *
