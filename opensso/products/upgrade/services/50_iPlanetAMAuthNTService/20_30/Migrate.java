 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:29 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final String SERVICE_DIR = "50_iPlanetAMAuthNTService/20_30";
    final String SCHEMA_FILE = "amAuthNT_mod.xml";
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.importServiceData(file);
            isSuccess = true;
        } catch (Exception e) {
