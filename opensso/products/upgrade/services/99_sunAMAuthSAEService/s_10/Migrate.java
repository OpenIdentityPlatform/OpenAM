...
/**
 * Creates new service schema for <code>sunAMAuthSAEService</code>.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "sunAMAuthSAEService";
    static final String SCHEMA_FILE = "fmAuthSAE.xml";
    static final String AUTH_PREFIX =
            "com.sun.identity.authentication.modules.";
    static final String MODULE_NAME = AUTH_PREFIX + "SAE";

    /**
     * Creates service schema for <code>sunAMAuthSAEService</code> service.
     *
