 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:04 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunFAMLibertyInteractionService</code>
 * service.  This class is invoked during migration from older versions
 * of Access Manager to the latest version.
 */
public class Migrate implements MigrateTasks {

    final String SCHEMA_FILE = "famLibertyInteraction.xml";

    /**
     * Creates service schema for <code>sunFAMLibertyInteractionService</code> 
     * service.
     *
