 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:16 qcheng Exp $
 *
 */
...
/**
 * Upgrades the <code>iPlanetAMAgentService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMAgentService";
    static final String SERVICE_DIR = "50_iPlanetAMAgentService/10_20";
    static final String SCHEMA_FILE = "amAgent_add1.xml";

    /**
     * Upgrades <code>iPlanetAMAgentService</code> service schema. 
     *
