 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:18 qcheng Exp $
 *
 */
...
/**
 * Upgrades the <code>iPlanetAMAuthAnonymousService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMAuthAnonymousService";
    static final String SERVICE_DIR = "50_iPlanetAMAuthAnonymousService/20_30";
    static final String SCHEMA_FILE = "amAuthAnonymous_mod.xml";
