 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:30 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMAuthRadiusService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMAuthRadiusService";
    final static String SERVICE_DIR = "50_iPlanetAMAuthRadiusService/10_20";
    final static String SCHEMA_FILE = "amAuthRadius_mod.xml";

    /**
     * Updates the <code>iPlanetAMAuthRadiusService<code> service schema.
     *
