 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:09 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunIdentityRepositoryService</code>.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SCHEMA_FILE = "idRepoService.xml";

    /**
     * Creates service schema for <code>sunIdentityRepositoryService</code> 
     * service.
     *
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.debug.error("Error loading new service schema", e);
        }
        return isSuccess;
    }
