 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:07 qcheng Exp $
 *
 */
...
/**
 * Updates <code>sunIdentityRepositoryService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR = "99_sunIdentityRepositoryService/10_20";
    final static String SCHEMA_FILE = "idRepoServiceAddAttrSchemaRequest.xml";
    final static String LDIF_FILE = "upgradedit.ldif";
