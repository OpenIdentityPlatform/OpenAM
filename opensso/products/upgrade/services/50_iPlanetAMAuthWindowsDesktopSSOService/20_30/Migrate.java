 ...
 *
 * $Id: Migrate.java,v 1.3 2008/06/25 05:53:37 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    /**
     * Updates the <code>iPlanetAMAuthWindowsDesktopSSOService<code> service 
     * schema.
     *
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.debug.error("Error updating service schema", e);
        }
        return isSuccess;
    }
