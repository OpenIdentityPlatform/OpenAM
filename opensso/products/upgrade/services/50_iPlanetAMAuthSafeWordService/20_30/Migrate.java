...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMAuthSafeWordService";
    static final String SERVICE_DIR = "50_iPlanetAMAuthSafeWordService/20_30";
    static final String SCHEMA_FILE = "amAuthSafeWord_mod.xml";
