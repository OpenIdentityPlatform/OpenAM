 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:48 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMProviderConfigService";
    final static String SERVICE_DIR = "50_iPlanetAMProviderConfigService/20_30";
    final static String SCHEMA_FILE = "amProviderConfig_add.xml";

    /**
     * Updates the <code>iPlanetAMProviderConfigService<code> service schema.
     *
