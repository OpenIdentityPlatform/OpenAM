 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:35 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMAuthUnixService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMAuthUnixService";
    final static String SERVICE_DIR = "50_iPlanetAMAuthUnixService/10_20";
    final static String SCHEMA_FILE = "amAuthUnix_mod.xml";

    /**
     * Updates the <code>iPlanetAMAuthUnixService<code> service schema.
     *
