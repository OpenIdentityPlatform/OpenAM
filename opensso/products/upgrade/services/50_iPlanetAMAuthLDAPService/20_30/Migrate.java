 ...
 *
 * $Id: Migrate.java,v 1.3 2008/06/25 05:53:26 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final String SERVICE_NAME = "iPlanetAMAuthLDAPService";
    final String SERVICE_DIR = "50_iPlanetAMAuthLDAPService/20_30";
    final String SCHEMA_FILE1 = "amAuthLDAP_mod.xml";
    final String SCHEMA_FILE2 = "amAuthLDAP_setBooleanValues.xml";

    /**
     * Updates the <code>iPlanetAMAuthLDAPService<code> service schema.
     *
