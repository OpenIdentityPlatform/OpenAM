 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:25 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMAuthLDAPService";
    static final String SERVICE_DIR = "50_iPlanetAMAuthLDAPService/10_20";
    static final String SCHEMA_FILE = "amAuthLDAP_mod.xml";
