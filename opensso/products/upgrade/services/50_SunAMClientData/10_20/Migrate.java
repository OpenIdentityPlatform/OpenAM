...
/**
 * Migrates the <code>SunAMClientData</code> service.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_DIR = "50_SunAMClientData/10_20";
    static final String SERVICE_NAME = "SunAMClientData";
    static final String SCHEMA_FILE = "amClientData_mod.xml";

    /**
     * Loads the changes for <code>SunAMClientData</code> service schema.
     *
