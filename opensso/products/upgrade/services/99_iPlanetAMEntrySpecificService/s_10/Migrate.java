...
/**
 * Creates new service schema for iPlanetAMEntrySpecificService.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SCHEMA_FILE = "amEntrySpecific.xml";

    /**
     * Creates new service schema for iPlanetAMEntrySpecificService.
     *
     * @return true if service schema creation is successful otherwise false.
     */
