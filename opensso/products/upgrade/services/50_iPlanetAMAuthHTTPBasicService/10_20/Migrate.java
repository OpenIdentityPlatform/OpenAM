 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:22 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMAuthHTTPBasicService";
    static final String SERVICE_DIR = "50_iPlanetAMAuthHTTPBasicService/10_20";
    static final String SCHEMA_FILE = "amAuthHTTPBasic_mod.xml";
