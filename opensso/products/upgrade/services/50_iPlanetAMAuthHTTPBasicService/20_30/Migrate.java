 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:23 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMAuthHTTPBasicService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final String SERVICE_NAME = "iPlanetAMAuthHTTPBasicService";
    final String SERVICE_DIR = "50_iPlanetAMAuthHTTPBasicService/20_30";
    final String SCHEMA_FILE = "amAuthHTTPBasic_mod.xml";

    /**
     * Updates the <code>iPlanetAMAuthHTTPBasicService<code> service schema.
     *
