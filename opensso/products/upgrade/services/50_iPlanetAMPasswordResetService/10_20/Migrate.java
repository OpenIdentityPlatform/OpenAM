 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:41 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMPasswordResetService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMPasswordResetService";
    final static String SERVICE_DIR = "50_iPlanetAMPasswordResetService/10_20";
    final static String SCHEMA_FILE = "amPassword_mod.xml";
    final static String schemaType = "Global";

    /**
     * Updates the <code>iPlanetAMPasswordResetService<code> service schema.
     *
