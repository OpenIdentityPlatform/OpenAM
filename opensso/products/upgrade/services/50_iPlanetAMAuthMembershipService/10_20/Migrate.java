 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:26 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMAuthMembershipService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final String SERVICE_DIR = "50_iPlanetAMAuthMembershipService/10_20";
    final String SCHEMA_FILE = "amAuthMembership_mod.xml";

    /**
     * Updates the <code>iPlanetAMAuthMembershipService<code> service schema.
     *
