 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:10 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunIdentityServerAuthnService</code>.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SCHEMA_FILE = "fmAuthnSvc.xml";
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.debug.error("Error loading new service", e);
        }
        return isSuccess;
    }
