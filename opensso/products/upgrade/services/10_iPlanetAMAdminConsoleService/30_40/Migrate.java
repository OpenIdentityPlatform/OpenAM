...
/**
 * Upgrades the services schema for <code>iPlanetAMAdminConsoleService<code>.
...
public class Migrate implements MigrateTasks {
    ...
    final String SERVICE_DIR = "10_iPlanetAMAdminConsoleService/30_40";
    final String SERVICE_NAME = "iPlanetAMAdminConsoleService";
    final String SERVICE_XML = "amAdminConsole_setBooleanValues.xml";
    ...
    public boolean migrateService() {
        ...
        try {
            UpgradeUtils.importServiceData(
                    UpgradeUtils.getAbsolutePath(SERVICE_DIR, SERVICE_XML));
            isSuccess = true;
