 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:57 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunAMRealmService</code>.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "sunAMRealmService";
    final static String SERVICE_DIR = "90_sunAMRealmService/s_10";
    final static String SCHEMA_FILE = "amRealmService.xml";
    final static String LDIF_FILE = "sunAMRealmService.ldif";

    /**
     * Creates service schema for <code>sunAMRealmService</code> service.
     *
