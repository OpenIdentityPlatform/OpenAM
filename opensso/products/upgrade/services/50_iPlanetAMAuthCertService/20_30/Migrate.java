 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:20 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_DIR = "50_iPlanetAMAuthCertService/20_30";
    static final String SCHEMA_FILE = "amAuthCert_mod.xml";

    /**
     * Updates the <code>iPlanetAMAuthCertService<code> service schema.
     *
