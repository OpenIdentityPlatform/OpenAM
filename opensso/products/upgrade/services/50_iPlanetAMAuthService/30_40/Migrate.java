...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR = "50_iPlanetAMAuthService/30_40";
    final static String SCHEMA_FILE1 = "amAuth_mod.xml";
    final static String SCHEMA_FILE2 = "amAuth_setBooleanValues.xml";
