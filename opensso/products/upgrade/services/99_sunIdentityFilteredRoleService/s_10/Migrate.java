...
/**
 * Creates new service schema for sunIdentityFilteredRoleService.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SCHEMA_FILE = "amFilteredRole.xml";

    /**
     * Creates new service schema for 
     * <code>sunIdentityFilteredRoleService</code>.
     *
     * @return true if service schema creation is successful else false.
     */
