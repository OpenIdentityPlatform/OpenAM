...
/**
 * Creates new service schema for sunIdentityAgentService.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SCHEMA_FILE = "amAgent70.xml";

    /**
     * Creates new service schema for service sunIdentityAgentService
     * 
     * @return true if service creation is successful else false.
     */
