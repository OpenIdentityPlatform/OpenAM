 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:54 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR =
            "50_sunIdentityServerLibertyPPService/10_20";
    final static String SCHEMA_FILE = "amLibertyPersonalProfile_mod.xml";
    final static String LDIF_FILE = "amLibertyPersonalProfile.ldif";
