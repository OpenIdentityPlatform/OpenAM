...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMNamingService";
    final static String SERVICE_DIR = "50_iPlanetAMNamingService/20_30";
    final static String SCHEMA_FILE = "amNaming_addAttrs.xml";
    final static String schemaType = "Global";

    /**
     * Updates the <code>iPlanetAMNamingService<code> service schema.
     *
