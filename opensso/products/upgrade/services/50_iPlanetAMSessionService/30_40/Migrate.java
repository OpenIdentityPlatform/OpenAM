...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "iPlanetAMSessionService";
    static final String SERVICE_DIR = "50_iPlanetAMSessionService/30_40";
    static final String SCHEMA_FILE = "amSession_addAttrs.xml";
