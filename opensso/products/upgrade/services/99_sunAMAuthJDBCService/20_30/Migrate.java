 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:00 qcheng Exp $
 *
 */
...
/**
 * Updates <code>sunAMAuthJDBCService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "sunAMAuthJDBCService";
    final static String SERVICE_DIR = "99_sunAMAuthJDBCService/20_30";
    final static String SCHEMA_FILE = "amAuthJDBC_mod.xml";

    /**
     * Updates the <code>sunAMAuthJDBCService<code> service schema.
     *
