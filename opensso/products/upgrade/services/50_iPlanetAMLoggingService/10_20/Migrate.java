 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:38 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR = "50_iPlanetAMLoggingService/10_20";
    final static String[] files = {"modify_amLogging1.xml",
        "modify_amLogging2.xml", "modify_amLogging3.xml",
        "modify_amLogging4.xml", "modify_amLogging5.xml",
        "modify_amLogging6.xml", "add_amLogging1.xml"
    };
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            for (int i = 0; i < numFiles; i++) {
                String file = 
                        UpgradeUtils.getAbsolutePath(SERVICE_DIR,files[i]);
                fileList[i] = file;
            }
