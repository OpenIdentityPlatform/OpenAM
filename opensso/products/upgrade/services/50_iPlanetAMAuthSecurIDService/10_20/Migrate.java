...
/**
 * Updates <code>iPlanetAMAuthSecurIDService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR = "50_iPlanetAMAuthSecurIDService/10_20";
    final static String SCHEMA_FILE = "amAuthSecurID_mod.xml";
