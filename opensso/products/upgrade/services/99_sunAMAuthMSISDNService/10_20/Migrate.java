 ...
 *
 * $Id: Migrate.java,v 1.3 2008/06/25 05:54:01 qcheng Exp $
 *
 */
...
/**
 * Updates <code>sunAMAuthMSISDNService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "sunAMAuthMSISDNService";
    final static String SERVICE_DIR = "99_sunAMAuthMSISDNService/10_20/";
    final static String SCHEMA_FILE = "amAuthMSISDN_mod.xml";

    /**
     * Updates the <code>sunAMAuthMSISDNService<code> service schema.
     *
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.debug.message("Error loading data :" + SCHEMA_FILE 
                + "for Service " + SERVICE_NAME, e);
        }
        return isSuccess;
    }
