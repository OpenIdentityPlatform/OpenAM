 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:54:02 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunAMAuthMSISDNService</code>.
...
public class Migrate implements MigrateTasks {
    ...
    static final String SERVICE_NAME = "sunAMAuthMSISDNService";
    static final String SCHEMA_FILE = "amAuthMSISDN.xml";

    /**
     * Creates service schema for <code>sunAMAuthMSISDNService</code> service.
     *
