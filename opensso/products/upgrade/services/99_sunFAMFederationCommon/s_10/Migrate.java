 ...
 *
 * $Id: Migrate.java,v 1.3 2008/06/25 05:54:04 qcheng Exp $
 *
 */
...
/**
 * Creates new service schema for <code>sunFAMFederationCommon</code>.
...
public class Migrate implements MigrateTasks {
    ...
    String SERVICE_NAME = "sunAMFederationCommon";
    String SCHEMA_FILE = "famFederationCommon.xml";

    /**
     * Creates service schema for <code>sunFAMFederationCommon</code> service.
     *
    ...
    public boolean migrateService() {
        ...
        try {
            ...
            UpgradeUtils.debug.error("Error create new service " + 
                SERVICE_NAME , e);
        }
        return isSuccess;
    }
