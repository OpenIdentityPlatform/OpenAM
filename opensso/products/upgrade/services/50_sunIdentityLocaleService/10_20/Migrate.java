 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:51 qcheng Exp $
 *
 */
...
/**
 * Updates <code>sunIdentityLocaleService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "sunIdentityLocaleService";
    final static String SERVICE_DIR = "50_sunIdentityLocaleService/10_20";
    final String SCHEMA_FILE = "identityLocaleService_mod.xml";

    /**
     * Updates the <code>sunIdentityLocaleService<code> service schema.
     *
