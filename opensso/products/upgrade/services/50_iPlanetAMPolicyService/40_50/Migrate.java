 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:47 qcheng Exp $
 *
 */
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_DIR = "50_iPlanetAMPolicyService/40_50";
    final static String XML_FILE_NAME = "AddAMIdentityMembershipCondition.xml";

    public boolean migrateService() {
        boolean isSuccess = false;
        try {
            String fileName =
                    UpgradeUtils.getAbsolutePath(SERVICE_DIR, XML_FILE_NAME);
