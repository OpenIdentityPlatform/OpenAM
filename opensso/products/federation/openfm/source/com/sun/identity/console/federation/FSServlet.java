 ...
 *
 * $Id: FSServlet.java,v 1.2 2008/06/25 05:49:35 qcheng Exp $
 *
 */
 ...
 */
public class FSServlet 
    extends ConsoleServletBase 
{
    public static final String DEFAULT_MODULE_URL = "../federation";
    public static String PACKAGE_NAME=
        getPackageName(FSServlet.class.getName());
