...
public class WspCreateServiceSecuritySummary extends WspCreateWizardSummary {

    public WspCreateServiceSecuritySummary(WspCreateWizardBean wizardBean) {
        super(wizardBean);
    }
    ...
    public int getGotoStep() {
        return WspCreateWizardStep.WSP_SECURITY.toInt();
    }
