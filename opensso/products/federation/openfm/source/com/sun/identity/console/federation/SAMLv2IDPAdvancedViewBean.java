 ...
 *
 * $Id: SAMLv2IDPAdvancedViewBean.java,v 1.3 2008/07/30 21:43:41 babysunil Exp $
 *
 */
...
public class SAMLv2IDPAdvancedViewBean extends SAMLv2Base {
    public static final String DEFAULT_DISPLAY_URL =
            "/console/federation/SAMLv2IDPAdvanced.jsp";
    
    public SAMLv2IDPAdvancedViewBean() {
        super("SAMLv2IDPAdvanced");
    ...
    protected void createPropertyModel() {
        ...
        if (isHosted()) {
            psModel = new AMPropertySheetModel(
                ...
                "com/sun/identity/console/propertySAMLv2IDPAdvancedHosted.xml"
                ));
        } else {
            psModel = new AMPropertySheetModel(
                getClass().getClassLoader().getResourceAsStream(
                "com/sun/identity/console/propertySAMLv2IDPAdvancedRemote.xml"
                ));
        }
        psModel.clear();
    }
    ...
    throws ModelControlException {
        try {
            ...
            Map new_idpExtValues = ps.getAttributeValues(
                    model.getIDPEXAdDataMap(), false, model);
