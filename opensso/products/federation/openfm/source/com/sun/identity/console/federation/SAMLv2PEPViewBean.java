 ...
 *
 * $Id: SAMLv2PEPViewBean.java,v 1.4 2008/10/24 00:12:05 asyhuang Exp $
 *
 */
...
public class SAMLv2PEPViewBean extends SAMLv2Base {
    
    public static final String DEFAULT_DISPLAY_URL =
	"/console/federation/SAMLv2PEP.jsp";

    public SAMLv2PEPViewBean() {
	super("SAMLv2PEP");
	...
	if (isHosted()) {
            psModel = new AMPropertySheetModel(
                getClass().getClassLoader().getResourceAsStream(
                    "com/sun/identity/console/propertySAMLv2PEPHosted.xml"));   
        } else {    
            psModel = new AMPropertySheetModel(
                getClass().getClassLoader().getResourceAsStream(
                    "com/sun/identity/console/propertySAMLv2PEPRemote.xml"));
        }
	psModel.clear();
    }
    ...
    {                 
        ...
        try {
            ...
            setInlineAlertMessage(CCAlert.TYPE_INFO,
                "message.information",
                "samlv2.entityDescriptor.provider.pep.updated");
        } catch (AMConsoleException e) {
            setInlineAlertMessage(CCAlert.TYPE_ERROR, "message.error",
                e.getMessage());
        }        
