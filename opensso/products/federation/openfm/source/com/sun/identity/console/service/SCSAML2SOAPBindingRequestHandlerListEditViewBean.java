 ...
 *
 * $Id: SCSAML2SOAPBindingRequestHandlerListEditViewBean.java,v 1.2 2008/06/25 05:49:44 qcheng Exp $
 *
 */
...
public class SCSAML2SOAPBindingRequestHandlerListEditViewBean
    extends SCSAML2SOAPBindingRequestHandlerListViewBeanBase {
    public static final String DEFAULT_DISPLAY_URL =
        "/console/service/SCSAML2SOAPBindingRequestHandlerListEdit.jsp";
    private static final String PGATTR_INDEX = "handlerListTblIndex";
    private boolean populateValues = false;
    
    public SCSAML2SOAPBindingRequestHandlerListEditViewBean() {
        super("SCSAML2SOAPBindingRequestHandlerListEdit", DEFAULT_DISPLAY_URL);
    }
    ...
    {
        SCSAML2SOAPBindingViewBean vb = (SCSAML2SOAPBindingViewBean)getViewBean(
    ...
    protected void createPropertyModel() {
        ...
        String xmlFile = (canModify) ?
            ...
            "com/sun/identity/console/propertySCSAML2SOAPBindingRequestHandlerList_Readonly.xml";
