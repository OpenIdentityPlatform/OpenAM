 ...
 *
 * $Id: StdMetadataNameSamlV2HostedIdpCreateSummary.java,v 1.1 2009/08/19 05:40:55 veiming Exp $
 */
...
public class StdMetadataNameSamlV2HostedIdpCreateSummary
    ...
    public String getValue() {
        ...
        if (hasMeta) {
            filename = getSamlV2HostedIdpCreateWizardBean().getStdMetaFilename();
        } else {
            filename = new String();
        }
