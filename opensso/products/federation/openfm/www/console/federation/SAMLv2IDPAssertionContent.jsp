<%--
   ...
   $Id: SAMLv2IDPAssertionContent.jsp,v 1.2 2008/06/25 05:50:24 qcheng Exp $
   
--%>

<%@ page info="SAMLv2IDPAssertionContent" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2IDPAssertionContentViewBean"
...
<cc:form name="SAMLv2IDPAssertionContent" method="post" defaultCommandChild="/button1">
