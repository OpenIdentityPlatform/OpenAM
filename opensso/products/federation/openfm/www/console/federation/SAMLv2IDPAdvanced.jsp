<%--
   ...
   $Id: SAMLv2IDPAdvanced.jsp,v 1.2 2008/06/25 05:50:23 qcheng Exp $
   
--%>

<%@ page info="SAMLv2IDPAdvanced" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2IDPAdvancedViewBean"
...
<cc:form name="SAMLv2IDPAdvanced" method="post" defaultCommandChild="/button1">
