<%--
   ...
   $Id: UMUserDiscoveryDescriptionAdd.jsp,v 1.2 2008/06/25 05:50:58 qcheng Exp $

--%>

<%@ page info="UMUserDiscoveryDescriptionAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.user.UMUserDiscoveryDescriptionAddViewBean"
...
<cc:form name="UMUserDiscoveryDescriptionAdd" method="post" defaultCommandChild="/button1" >
