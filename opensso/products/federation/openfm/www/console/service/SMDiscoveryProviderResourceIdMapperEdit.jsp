<%--
   ...
   $Id: SMDiscoveryProviderResourceIdMapperEdit.jsp,v 1.2 2008/06/25 05:50:57 qcheng Exp $
--%>


<%@ page info="SMDiscoveryProviderResourceIdMapperEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SMDiscoveryProviderResourceIdMapperEditViewBean"
...
<cc:form name="SMDiscoveryProviderResourceIdMapperEdit" method="post" defaultCommandChild="/button1" >
