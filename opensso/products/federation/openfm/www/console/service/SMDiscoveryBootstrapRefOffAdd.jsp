<%--
   ...
   $Id: SMDiscoveryBootstrapRefOffAdd.jsp,v 1.2 2008/06/25 05:50:57 qcheng Exp $
--%>


<%@ page info="SMDiscoveryBootstrapRefOffAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SMDiscoveryBootstrapRefOffAddViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('SMDiscoveryBootstrapRefOffAdd',
	    'SMDiscoveryBootstrapRefOffAdd.SecurityMechID',
	    'securityMechIDCount',
	    'SMDiscoveryBootstrapRefOffAdd.tblSecurityMechIDButtonDelete',
	    obj);
    }
</script>

<cc:form name="SMDiscoveryBootstrapRefOffAdd" method="post" defaultCommandChild="/button1" >
