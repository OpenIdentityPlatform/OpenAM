<%--
   ...
   $Id: SCSOAPBinding.jsp,v 1.2 2008/06/25 05:50:56 qcheng Exp $
--%>


<%@ page info="SCSOAPBinding" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SCSOAPBindingViewBean"
...
<cc:form name="SCSOAPBinding" method="post" defaultCommandChild="/button1" >
