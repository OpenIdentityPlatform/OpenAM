...
<%@ page info="SCSAML2SOAPBinding" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.service.SCSAML2SOAPBindingViewBean"
...
<cc:form name="SCSAML2SOAPBinding" method="post" defaultCommandChild="/button1" >
