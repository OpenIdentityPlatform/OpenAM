...
public class IPConditionEvalTest {
    ...
    public void positiveTest() throws Exception {
        ...
        if ((entitlements == null) || entitlements.isEmpty()) {
            throw new Exception(
                    "IPConditionEvalTest.positiveTest: no entitlements returned");
        }
        ...
        if ((result == null) || !result) {
            throw new Exception(
                    "IPConditionEvalTest.positiveTest: incorrect decision");
        }

        Map<String, Set<String>> advice = ent.getAdvices();
        if ((advice != null) && !advice.isEmpty()) {
            throw new Exception(
                    "IPConditionEvalTest.positiveTest: do not expect advices.");
        }
    }
    ...
    public void negativeTest() throws Exception {
        ...
        if ((entitlements == null) || entitlements.isEmpty()) {
            throw new Exception(
                    "IPConditionEvalTest.negativeTest: no entitlements returned");
        }
        ...
        if ((result != null) && result) {
            throw new Exception(
                    "IPConditionEvalTest.negativeTest: incorrect decision");
        }
        ...
        if ((advice == null) || advice.isEmpty()) {
            throw new Exception(
                    "IPConditionEvalTest.negativeTest: no advice for IPCondition.");
        }
