...
+"\u0000\u0000\u0000#\u0001pq\u0000~\u0000^q\u0000~\u0000gq\u0000~\u0000fq\u0000~\u0000rq\u0000~\u0000qq\u0000~\u0000zq\u0000~\u0000yq\u0000~\u0000\nq\u0000~\u0000Hq\u0000~\u0000\\q\u0000~\u0000"
+"oq\u0000~\u0000,q\u0000~\u0000Wq\u0000~\u0000jq\u0000~\u0000~q\u0000~\u0000\u0005q\u0000~\u0000Gq\u0000~\u0000[q\u0000~\u0000nq\u0000~\u0000\u0006q\u0000~\u0000\u0007q\u0000~\u0000\tq\u0000~\u0000"
+"%q\u0000~\u0000Pq\u0000~\u0000dq\u0000~\u0000wq\u0000~\u0000\u0014q\u0000~\u0000(q\u0000~\u0000Kq\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000Jq\u0000~\u0000Sq\u0000~\u0000Rq\u0000~\u0000"
+"_x"));
        }
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("OrganizationURL" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            _getOrganizationURL().add(((com.sun.identity.saml2.jaxb.metadata.impl.OrganizationURLElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.metadata.impl.OrganizationURLElementImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("OrganizationURL" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            context.pushAttributes(__atts, true);
                ...
                switch (state) {
                    case  11 :
                        if (("lang" == ___local)&&("http://www.w3.org/XML/1998/namespace" == ___uri)) {
                            _getOrganizationName().add(((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl.class), 12, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  10 :
                    ...
                    case  5 :
                        if (("lang" == ___local)&&("http://www.w3.org/XML/1998/namespace" == ___uri)) {
                            _getOrganizationDisplayName().add(((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl.class), 6, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
                    ...
                    case  8 :
                        if (("lang" == ___local)&&("http://www.w3.org/XML/1998/namespace" == ___uri)) {
                            _getOrganizationURL().add(((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedURITypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedURITypeImpl.class), 9, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
