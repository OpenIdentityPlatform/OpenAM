    ...
    implements com.sun.identity.wsfederation.jaxb.wsspolicy.SecureConversationTokenElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallableObject, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializable, com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.wsfederation.jaxb.wsspolicy.SecureConversationTokenElement.class);
    }
    ...
    public com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512", "SecureConversationToken");
...
+"\u0000\u0017SecureConversationTokenq\u0000~\u0000@sr\u0000\"com.sun.msv.grammar.Expres"
...
+"om/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\f\u0001pq\u0000~\u0000Nq\u0000~\u0000Aq\u0000~\u0000&q\u0000~"
+"\u0000lq\u0000~\u0000\u0016q\u0000~\u0000\u0011q\u0000~\u0000\nq\u0000~\u0000Bq\u0000~\u0000\tq\u0000~\u0000\u0013q\u0000~\u0000\rq\u0000~\u0000\u000bx"));
        }
        ...
        extends com.sun.identity.wsfederation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        ...
                        if (("Issuer" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        ...
                        return ;
                    case  0 :
                        if (("SecureConversationToken" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("IncludeToken" == ___local)&&("http://docs.oasis-open.org/ws-sx/ws-securitypolicy/200512" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        spawnHandlerFromEnterAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            spawnHandlerFromText((((com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenTypeImpl)com.sun.identity.wsfederation.jaxb.wsspolicy.impl.SecureConversationTokenElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
