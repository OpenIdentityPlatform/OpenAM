...
+"com/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u001e\u0001pq\u0000~\u0000`q\u0000~\u0000_q\u0000~\u0000hq\u0000"
+"~\u0000gq\u0000~\u0000\u00a7q\u0000~\u0000\rq\u0000~\u0000Jq\u0000~\u0000]q\u0000~\u0000\bq\u0000~\u0000-q\u0000~\u0000Xq\u0000~\u0000lq\u0000~\u0000\u0007q\u0000~\u0000\u000bq\u0000~\u0000Iq\u0000"
+"~\u0000\\q\u0000~\u0000\u0006q\u0000~\u0000&q\u0000~\u0000Rq\u0000~\u0000eq\u0000~\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000)q\u0000~\u0000Mq\u0000~\u0000\u0012q\u0000~\u0000(q\u0000~\u0000Lq\u0000"
+"~\u0000Uq\u0000~\u0000Tq\u0000~\u0000Hx"));
        }
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("ServiceDescription" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            _getServiceDescription().add(((com.sun.identity.saml2.jaxb.metadata.impl.ServiceDescriptionElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.metadata.impl.ServiceDescriptionElementImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ServiceDescription" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            context.pushAttributes(__atts, true);
                ...
                switch (state) {
                    ...
                    case  11 :
                        if (("isRequired" == ___local)&&("" == ___uri)) {
                            _getRequestedAttribute().add(((com.sun.identity.saml2.jaxb.metadata.impl.RequestedAttributeTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.RequestedAttributeTypeImpl.class), 12, ___uri, ___local, ___qname)));
                            return ;
                        }
                    ...
                    case  14 :
                        if (("lang" == ___local)&&("http://www.w3.org/XML/1998/namespace" == ___uri)) {
                            _getServiceDescription().add(((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.LocalizedNameTypeImpl.class), 15, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  3 :
