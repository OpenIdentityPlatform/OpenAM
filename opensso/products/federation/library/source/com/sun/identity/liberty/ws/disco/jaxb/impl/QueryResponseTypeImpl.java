...
+"$q\u0000~\u0000Pq\u0000~\u0000]q\u0000~\u0000\u000eq\u0000~\u0000&q\u0000~\u0000Jq\u0000~\u0000Rq\u0000~\u0000_q\u0000~\u0000\u0005q\u0000~\u0000+q\u0000~\u0000Wq\u0000~\u0000dq\u0000~\u0000"
+"\u0007q\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000Kq\u0000~\u0000Sq\u0000~\u0000`q\u0000~\u0000\tq\u0000~\u0000Hq\u0000~\u0000hq\u0000~\u0000[q\u0000~\u0000Gq\u0000~\u0000Fq\u0000~\u0000"
+"\u0006x"));
        }
                ...
                switch (state) {
                    case  6 :
                        ...
                        if (("ResourceID" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _getResourceOffering().add(((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ResourceID" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _getResourceOffering().add(((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                    ...
                    case  3 :
                        if (("Status" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusElementImpl.class), 4, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Status" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                    ...
                    case  8 :
                        if (true) {
                            _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                        return ;
                    ...
                    case  4 :
                        if (("ResourceOffering" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _getResourceOffering().add(((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingElementImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ResourceOffering" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            context.pushAttributes(__atts, false);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  9 :
                        ...
                        break;
                    case  8 :
                        _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromLeaveElement((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, ___uri, ___local, ___qname));
                        return ;
                    case  11 :
                        attIdx = context.getAttribute("", "code");
                        if (attIdx >= 0) {
                ...
                switch (state) {
                    case  6 :
                        if (("entryID" == ___local)&&("" == ___uri)) {
                            _getResourceOffering().add(((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 7, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
                        ...
                        continue outer;
                    case  8 :
                        _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, ___uri, ___local, ___qname));
                        return ;
                    case  11 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusTypeImpl.class), 12, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  10 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  8 :
                        _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, ___uri, ___local, ___qname));
                        return ;
                    case  11 :
                        attIdx = context.getAttribute("", "code");
                        if (attIdx >= 0) {
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            continue outer;
                        case  8 :
                            _Credentials = ((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl) spawnChildFromText((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryResponseTypeImpl.CredentialsTypeImpl.class), 9, value));
                            return ;
                        case  11 :
                            attIdx = context.getAttribute("", "code");
                            if (attIdx >= 0) {
