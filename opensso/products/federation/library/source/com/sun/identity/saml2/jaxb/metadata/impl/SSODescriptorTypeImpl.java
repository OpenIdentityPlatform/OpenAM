...
+"\u00a5q\u0000~\u0000\u0090q\u0000~\u0000gq\u0000~\u0000\u00baq\u0000~\u0000\u00cfq\u0000~\u0000\fq\u0000~\u0000{q\u0000~\u0000Qq\u0000~\u0000\u0013q\u0000~\u0001\u0005q\u0000~\u0000kq\u0000~\u0000]q\u0000~\u0000"
+"Uq\u0000~\u00002q\u0000~\u0000\u001eq\u0000~\u0000\u00beq\u0000~\u0000\u0011q\u0000~\u0000\u00b1q\u0000~\u0000\u00a9q\u0000~\u0000\u009cq\u0000~\u0000\u0094q\u0000~\u0000\u0087q\u0000~\u0000\u007fq\u0000~\u0000sq\u0000~\u0000"
+"\u00c6q\u0000~\u0000\u00d3q\u0000~\u0000\u00dbq\u0000~\u0000\nq\u0000~\u0000\u000fq\u0000~\u0000\u0006q\u0000~\u0000\bq\u0000~\u0000\u0010q\u0000~\u0000\u00e5q\u0000~\u0000\u00fcq\u0000~\u0001\u0011q\u0000~\u0000\u00efq\u0000~\u0000"
+"\\q\u0000~\u0000Tq\u0000~\u00001q\u0000~\u0000\u001bq\u0000~\u0000\u00b0q\u0000~\u0000\u00a8q\u0000~\u0000\u009bq\u0000~\u0000\u0093q\u0000~\u0000\u0086q\u0000~\u0000~q\u0000~\u0000rq\u0000~\u0000jq\u0000~\u0000"
+"\u00bdq\u0000~\u0000\u00c5q\u0000~\u0000\u00d2q\u0000~\u0000\u00daq\u0000~\u0000\tq\u0000~\u0000\u00b5q\u0000~\u0000\u00a0q\u0000~\u0000\u008bq\u0000~\u0000wq\u0000~\u0000aq\u0000~\u00006q\u0000~\u0000\u00caq\u0000~\u0000"
+"\u00deq\u0000~\u0000\u000bq\u0000~\u0000\u00ebq\u0000~\u0000\u00e2q\u0000~\u0000\u00a4q\u0000~\u0000\u008fq\u0000~\u0000fq\u0000~\u0000\u00b9q\u0000~\u0000\u00ceq\u0000~\u0000\u0007q\u0000~\u0000\u0005q\u0000~\u0000\u00e3q\u0000~\u0000"
+"\rq\u0000~\u0000\u000eq\u0000~\u0000\u00a6q\u0000~\u0000\u0091q\u0000~\u0000|q\u0000~\u0000hq\u0000~\u0000Rq\u0000~\u0000\u0014q\u0000~\u0000\u00bbq\u0000~\u0000\u00d0q\u0000~\u0000\u00aeq\u0000~\u0000\u0099q\u0000~\u0000"
+"\u0084q\u0000~\u0000pq\u0000~\u0000Zq\u0000~\u0000/q\u0000~\u0000\u00c3q\u0000~\u0000\u00d8x"));
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ArtifactResolutionService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            _getArtifactResolutionService().add(((com.sun.identity.saml2.jaxb.metadata.impl.ArtifactResolutionServiceElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.metadata.impl.ArtifactResolutionServiceElementImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ArtifactResolutionService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            context.pushAttributes(__atts, false);
                ...
                switch (state) {
                    ...
                    case  12 :
                        if (("Binding" == ___local)&&("" == ___uri)) {
                            _getSingleLogoutService().add(((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl.class), 13, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  7 :
                        if (("Binding" == ___local)&&("" == ___uri)) {
                            _getManageNameIDService().add(((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl.class), 8, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
                    ...
                    case  2 :
                        if (("index" == ___local)&&("" == ___uri)) {
                            _getArtifactResolutionService().add(((com.sun.identity.saml2.jaxb.metadata.impl.IndexedEndpointTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.IndexedEndpointTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  1 :
