 ...
 *
 * $Id: SAMLRequestVersionDeprecatedException.java,v 1.2 2008/06/25 05:47:34 qcheng Exp $
 *
 */
    ...
    extends SAMLVersionMismatchException
{
    ...
    /**
     * Constructs an <code>SAMLRequestVersionDeprecatedException</code> with a
     * message.
     *
     * @param s exception message.
     */
    public SAMLRequestVersionDeprecatedException(String s) {
        super(s);
    }
    /**
     * Constructs an <code>SAMLRequestVersionDeprecatedException</code> with
     * given <code>Throwable</code>.
     *
     * @param t Exception nested in the new exception.
     *
     */
    public SAMLRequestVersionDeprecatedException(Throwable t) {
        super(t);
    }

    /**
     * Constructs a new <code>SAMLRequestVersionDeprecatedException</code>
     ...
     *
     */
    public SAMLRequestVersionDeprecatedException(String rbName,
                                                String errorCode,
                                                Object[] args)
    {
