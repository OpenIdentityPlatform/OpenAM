                ...
                switch (state) {
                    case  6 :
                        if (("Attribute" == ___local)&&("urn:sun:fm:wsfederation:1.0:federationconfig" == ___uri)) {
                            _getAttribute().add(((com.sun.identity.wsfederation.jaxb.entityconfig.impl.AttributeElementImpl) spawnChildFromEnterElement((com.sun.identity.wsfederation.jaxb.entityconfig.impl.AttributeElementImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Attribute" == ___local)&&("urn:sun:fm:wsfederation:1.0:federationconfig" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getAttribute().add(((com.sun.identity.wsfederation.jaxb.entityconfig.impl.AttributeTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.wsfederation.jaxb.entityconfig.impl.AttributeTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                }
