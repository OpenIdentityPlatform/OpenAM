...
+"nPool;xp\u0000\u0000\u0000*\u0001pq\u0000~\u0000\\q\u0000~\u0000eq\u0000~\u0000dq\u0000~\u0000rq\u0000~\u0000qq\u0000~\u0000zq\u0000~\u0000yq\u0000~\u0000\nq\u0000~\u0000mq"
+"\u0000~\u0000\u0086q\u0000~\u0000\u0085q\u0000~\u0000\u008dq\u0000~\u0000\u000bq\u0000~\u0000\u008cq\u0000~\u0000\fq\u0000~\u0000oq\u0000~\u0000\u0083q\u0000~\u0000.q\u0000~\u0000Wq\u0000~\u0000iq\u0000~\u0000~q"
+"\u0000~\u0000\u0090q\u0000~\u0000nq\u0000~\u0000\u0082q\u0000~\u0000\tq\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u0000\u0007q\u0000~\u0000\'q\u0000~\u0000Pq\u0000~\u0000bq\u0000~\u0000wq\u0000~\u0000\u008aq"
+"\u0000~\u0000\u0014q\u0000~\u0000*q\u0000~\u0000Kq\u0000~\u0000\u0011q\u0000~\u0000)q\u0000~\u0000Jq\u0000~\u0000Sq\u0000~\u0000Rq\u0000~\u0000]x"));
        }
                ...
                switch (state) {
                    ...
                    case  7 :
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                    ...
                    case  4 :
                        if (("SubjectConfirmation" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getSubjectConfirmation().add(((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationElementImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("SubjectConfirmation" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                    ...
                    case  0 :
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDElementImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                        ...
                        if (("NameID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _NameID = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.NameIDElementImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("NameID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                        ...
                        if (("EncryptedID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedIDElementImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptedID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  11 :
                        ...
                        _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, ___uri, ___local, ___qname, __atts));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  11 :
                        ...
                        _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromLeaveElement((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                switch (state) {
                    case  2 :
                        if (("Method" == ___local)&&("" == ___uri)) {
                            _getSubjectConfirmation().add(((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  4 :
                    ...
                    case  5 :
                        if (("Method" == ___local)&&("" == ___uri)) {
                            _getSubjectConfirmation().add(((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationTypeImpl.class), 6, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  1 :
                    ...
                    case  9 :
                        if (("NameQualifier" == ___local)&&("" == ___uri)) {
                            _NameID = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl.class), 10, ___uri, ___local, ___qname));
                            return ;
                        }
                    ...
                    case  11 :
                        if (("NameQualifier" == ___local)&&("" == ___uri)) {
                            _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, ___uri, ___local, ___qname));
                            return ;
                        }
                        if (("SPNameQualifier" == ___local)&&("" == ___uri)) {
                            _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, ___uri, ___local, ___qname));
            ...
            while (true) {
                switch (state) {
                    ...
                    case  11 :
                        ...
                        _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, ___uri, ___local, ___qname));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  9 :
                            ...
                            _NameID = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl.class), 10, value));
                            return ;
                        case  11 :
                            attIdx = context.getAttribute("", "NameQualifier");
                            if (attIdx >= 0) {
                            ...
                            _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDAbstractTypeImpl.class), 12, value));
                            return ;
                    }
