...
+"mmar/ExpressionPool;xp\u0000\u0000\u0000\u000f\u0001pq\u0000~\u0000Eq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000bq\u0000~\u0000Tq\u0000~\u0000\u0007q\u0000"
+"~\u0000\u0005q\u0000~\u0000\u000fq\u0000~\u0000>q\u0000~\u0000\u0006q\u0000~\u0000\u0015q\u0000~\u0000Aq\u0000~\u0000\u0014q\u0000~\u0000@q\u0000~\u0000&x"));
        }
                ...
                switch (state) {
                    case  9 :
                        if (("AttributeValue" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getAttributeValue().add(((com.sun.identity.saml2.jaxb.assertion.impl.AttributeValueElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.AttributeValueElementImpl.class), 14, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AttributeValue" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                    ...
                    case  10 :
                        ...
                        if (true) {
                            _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, ___uri, ___local, ___qname, __atts)));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        ...
                        _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromLeaveElement((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "FriendlyName");
                        if (attIdx >= 0) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        ...
                        _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        ...
                        _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, ___uri, ___local, ___qname)));
                        return ;
                    case  12 :
                        if (("nil" == ___local)&&("http://www.w3.org/2001/XMLSchema-instance" == ___uri)) {
                            state = 13;
                ...
                try {
                    switch (state) {
                        ...
                        case  10 :
                            ...
                            _getAttributeValue().add(((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.schema.impl.AnyTypeImpl.class), 13, value)));
                            return ;
                        case  0 :
                            attIdx = context.getAttribute("", "FriendlyName");
                            if (attIdx >= 0) {
