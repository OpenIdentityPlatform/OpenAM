...
+"com/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0019\u0001pq\u0000~\u0000&q\u0000~\u0000Oq\u0000~\u0000]q\u0000"
+"~\u0000\u0012q\u0000~\u0000(q\u0000~\u0000Iq\u0000~\u0000Qq\u0000~\u0000_q\u0000~\u0000\u0006q\u0000~\u0000-q\u0000~\u0000Vq\u0000~\u0000dq\u0000~\u0000\fq\u0000~\u0000\u0015q\u0000~\u0000)q\u0000"
+"~\u0000Jq\u0000~\u0000Rq\u0000~\u0000`q\u0000~\u0000\tq\u0000~\u0000\rq\u0000~\u0000hq\u0000~\u0000\bq\u0000~\u0000[q\u0000~\u0000\u0005q\u0000~\u0000Zx"));
        }
...
+"tt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000Eq\u0000~\u00008q\u0000"
+"~\u0000Gq\u0000~\u0000\"q\u0000~\u0000Lq\u0000~\u0000;q\u0000~\u0000Hq\u0000~\u00006q\u0000~\u0000\u0005q\u0000~\u0000\nq\u0000~\u00005x"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
        }
            ...
            extends com.sun.identity.federation.jaxb.entityconfig.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
                    ...
                    switch (state) {
                        case  5 :
                            if (("Option" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                                _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, ___uri, ___local, ___qname, __atts));
                                return ;
                            }
                            _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        ...
                        case  3 :
                            if (("Options" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                                _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsElementImpl.class), 4, ___uri, ___local, ___qname, __atts));
                                return ;
                            }
                            if (("Options" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                ...
                while (true) {
                    switch (state) {
                        case  2 :
                            ...
                            break;
                        case  5 :
                            _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromLeaveElement((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, ___uri, ___local, ___qname));
                            return ;
                        case  4 :
                ...
                throws org.xml.sax.SAXException
            {
                ...
                while (true) {
                    switch (state) {
                        case  5 :
                            _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, ___uri, ___local, ___qname));
                            return ;
                        case  4 :
                ...
                throws org.xml.sax.SAXException
            {
                ...
                while (true) {
                    switch (state) {
                        case  5 :
                            _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, ___uri, ___local, ___qname));
                            return ;
                        case  4 :
                    ...
                    try {
                        switch (state) {
                            case  1 :
                                ...
                                return ;
                            case  5 :
                                _Options = ((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl) spawnChildFromText((com.sun.identity.liberty.ws.disco.jaxb.impl.OptionsTypeImpl.class), 6, value));
                                return ;
                            case  4 :
                ...
                switch (state) {
                    ...
                    case  8 :
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedResourceID = ((com.sun.identity.liberty.ws.disco.jaxb.impl.EncryptedResourceIDTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.EncryptedResourceIDTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedResourceID = ((com.sun.identity.liberty.ws.disco.jaxb.impl.EncryptedResourceIDTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.EncryptedResourceIDTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                    ...
                    case  5 :
                        if (("ServiceType" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _getRequestedServiceType().add(((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryTypeImpl.RequestedServiceTypeTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.QueryTypeImpl.RequestedServiceTypeTypeImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  4 :
