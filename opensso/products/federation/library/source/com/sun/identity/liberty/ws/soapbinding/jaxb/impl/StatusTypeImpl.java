                ...
                switch (state) {
                    case  9 :
                        if (("Status" == ___local)&&("urn:liberty:sb:2003-08" == ___uri)) {
                            _getStatus().add(((com.sun.identity.liberty.ws.soapbinding.jaxb.impl.StatusElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.soapbinding.jaxb.impl.StatusElementImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Status" == ___local)&&("urn:liberty:sb:2003-08" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  11 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _getStatus().add(((com.sun.identity.liberty.ws.soapbinding.jaxb.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.soapbinding.jaxb.impl.StatusTypeImpl.class), 12, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
