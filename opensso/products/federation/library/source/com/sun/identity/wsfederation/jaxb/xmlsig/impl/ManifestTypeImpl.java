                ...
                switch (state) {
                    case  3 :
                        if (("Reference" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceElementImpl) spawnChildFromEnterElement((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceElementImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Reference" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                    ...
                    case  4 :
                        ...
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterElement((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterElement((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getReference().add(((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.wsfederation.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
