...
+"om/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000<\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0088q\u0000~\u0000tq\u0000~"
+"\u0000`q\u0000~\u0000Kq\u0000~\u0000\tq\u0000~\u0000dq\u0000~\u0000Wq\u0000~\u0000Oq\u0000~\u0000,q\u0000~\u0000\u0016q\u0000~\u0000\u00b5q\u0000~\u0000\u00afq\u0000~\u0000\u00a9q\u0000~\u0000\u00a3q\u0000~"
+"\u0000\u0094q\u0000~\u0000\u008cq\u0000~\u0000\u0080q\u0000~\u0000xq\u0000~\u0000lq\u0000~\u0000\u000bq\u0000~\u0000\u009cq\u0000~\u0000\nq\u0000~\u0000\u009fq\u0000~\u0000Vq\u0000~\u0000Nq\u0000~\u0000+q\u0000~"
+"\u0000\u0013q\u0000~\u0000\u00b4q\u0000~\u0000\u00aeq\u0000~\u0000\u00a8q\u0000~\u0000\u00a2q\u0000~\u0000\u0093q\u0000~\u0000\u008bq\u0000~\u0000\u007fq\u0000~\u0000wq\u0000~\u0000kq\u0000~\u0000cq\u0000~\u0000\u0098q\u0000~"
+"\u0000\u0084q\u0000~\u0000pq\u0000~\u0000[q\u0000~\u00000q\u0000~\u0000\fq\u0000~\u0000\u0006q\u0000~\u0000\bq\u0000~\u0000\u009eq\u0000~\u0000\u0089q\u0000~\u0000\u009dq\u0000~\u0000uq\u0000~\u0000aq\u0000~"
+"\u0000Lq\u0000~\u0000\u000eq\u0000~\u0000\u0007q\u0000~\u0000\u0091q\u0000~\u0000}q\u0000~\u0000iq\u0000~\u0000Tq\u0000~\u0000)q\u0000~\u0000\u00a0x"));
        }
                ...
                switch (state) {
                    ...
                    case  24 :
                        ...
                        if (("Condition" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl.class), 25, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  18 :
                        if (("Conditions" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsElementImpl.class), 19, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Conditions" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                    ...
                    case  22 :
                        if (("Statement" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getStatementOrAuthnStatementOrAuthzDecisionStatement().add(((com.sun.identity.saml2.jaxb.assertion.impl.StatementElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.StatementElementImpl.class), 23, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AuthnStatement" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getStatementOrAuthnStatementOrAuthzDecisionStatement().add(((com.sun.identity.saml2.jaxb.assertion.impl.AuthnStatementElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.AuthnStatementElementImpl.class), 23, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AuthzDecisionStatement" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getStatementOrAuthnStatementOrAuthzDecisionStatement().add(((com.sun.identity.saml2.jaxb.assertion.impl.AuthzDecisionStatementElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.AuthzDecisionStatementElementImpl.class), 23, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AttributeStatement" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _getStatementOrAuthnStatementOrAuthzDecisionStatement().add(((com.sun.identity.saml2.jaxb.assertion.impl.AttributeStatementElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.AttributeStatementElementImpl.class), 23, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 23;
                        continue outer;
                    ...
                    case  16 :
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectTypeImpl.class), 17, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectTypeImpl.class), 17, ___uri, ___local, ___qname, __atts));
                    ...
                    case  19 :
                        if (("Advice" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Advice = ((com.sun.identity.saml2.jaxb.assertion.impl.AdviceElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.AdviceElementImpl.class), 22, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Advice" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  15 :
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Subject = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectElementImpl.class), 18, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Subject" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  9 :
                        if (("Issuer" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _Issuer = ((com.sun.identity.saml2.jaxb.assertion.impl.IssuerElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.IssuerElementImpl.class), 12, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Issuer" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  24 :
                        ...
                        _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl) spawnChildFromLeaveElement((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl.class), 25, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "ID");
                        if (attIdx >= 0) {
                ...
                switch (state) {
                    ...
                    case  24 :
                        if (("NotBefore" == ___local)&&("" == ___uri)) {
                            _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl.class), 25, ___uri, ___local, ___qname));
                            return ;
                        }
                    ...
                    case  10 :
                        if (("NameQualifier" == ___local)&&("" == ___uri)) {
                            _Issuer = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  24 :
                        ...
                        _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl.class), 25, ___uri, ___local, ___qname));
                        return ;
                    case  0 :
                        attIdx = context.getAttribute("", "ID");
                        if (attIdx >= 0) {
                ...
                try {
                    switch (state) {
                        ...
                        case  24 :
                            ...
                            _Conditions = ((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.assertion.impl.ConditionsTypeImpl.class), 25, value));
                            return ;
                        case  1 :
                            state = 2;
                            eatText2(value);
                        ...
                        case  10 :
                            ...
                            _Issuer = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.assertion.impl.NameIDTypeImpl.class), 11, value));
                            return ;
                        case  4 :
                            state = 5;
                            eatText1(value);
