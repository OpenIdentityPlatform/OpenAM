                ...
                switch (state) {
                    case  3 :
                        if (("Attribute" == ___local)&&("urn:sun:fm:SAML:2.0:entityconfig" == ___uri)) {
                            _getAttribute().add(((com.sun.identity.saml2.jaxb.entityconfig.impl.AttributeElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.entityconfig.impl.AttributeElementImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Attribute" == ___local)&&("urn:sun:fm:SAML:2.0:entityconfig" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getAttribute().add(((com.sun.identity.saml2.jaxb.entityconfig.impl.AttributeTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.entityconfig.impl.AttributeTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
