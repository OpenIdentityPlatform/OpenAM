...
+"ntt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000$\u0001pq\u0000~\u0000%q\u0000~\u0000Pq"
+"\u0000~\u0000dq\u0000~\u0000yq\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000Jq\u0000~\u0000Rq\u0000~\u0000^q\u0000~\u0000fq\u0000~\u0000sq\u0000~\u0000{q\u0000~\u0000,q\u0000~\u0000Wq"
+"\u0000~\u0000kq\u0000~\u0000\u0080q\u0000~\u0000\u0014q\u0000~\u0000(q\u0000~\u0000Kq\u0000~\u0000Sq\u0000~\u0000_q\u0000~\u0000gq\u0000~\u0000tq\u0000~\u0000|q\u0000~\u0000\nq\u0000~\u0000Hq"
+"\u0000~\u0000\\q\u0000~\u0000qq\u0000~\u0000\u0006q\u0000~\u0000\u0007q\u0000~\u0000\tq\u0000~\u0000Gq\u0000~\u0000[q\u0000~\u0000\u0005q\u0000~\u0000pq\u0000~\u0000ox"));
        }
                ...
                switch (state) {
                    case  4 :
                        if (("KeySharing" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                            _KeySharing = ((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeySharingElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeySharingElementImpl.class), 7, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("KeySharing" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                    ...
                    case  1 :
                        if (("KeyStorage" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                            _KeyStorage = ((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeyStorageElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeyStorageElementImpl.class), 4, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("KeyStorage" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                            context.pushAttributes(__atts, false);
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("medium" == ___local)&&("" == ___uri)) {
                            _KeyStorage = ((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeyStorageTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeyStorageTypeImpl.class), 3, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  5 :
                        if (("sharing" == ___local)&&("" == ___uri)) {
                            _KeySharing = ((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeySharingTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.ac.impl.KeySharingTypeImpl.class), 6, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  10 :
