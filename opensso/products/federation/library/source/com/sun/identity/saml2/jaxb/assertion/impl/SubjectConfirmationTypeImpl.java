...
+"n/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\"\u0001pq\u0000~\u0000]q\u0000~\u0000fq\u0000~\u0000eq\u0000~\u0000rq\u0000~"
+"\u0000qq\u0000~\u0000zq\u0000~\u0000yq\u0000~\u0000\rq\u0000~\u0000\u000eq\u0000~\u0000\u000fq\u0000~\u0000oq\u0000~\u0000/q\u0000~\u0000Xq\u0000~\u0000jq\u0000~\u0000~q\u0000~\u0000\bq\u0000~"
+"\u0000\fq\u0000~\u0000\u0005q\u0000~\u0000\tq\u0000~\u0000nq\u0000~\u0000(q\u0000~\u0000Qq\u0000~\u0000cq\u0000~\u0000wq\u0000~\u0000\u0006q\u0000~\u0000\u0017q\u0000~\u0000+q\u0000~\u0000Lq\u0000~"
+"\u0000\u0014q\u0000~\u0000*q\u0000~\u0000Kq\u0000~\u0000Tq\u0000~\u0000Sq\u0000~\u0000^x"));
        }
                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _BaseID = ((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.BaseIDElementImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("BaseID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                        ...
                        if (("NameID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _NameID = ((com.sun.identity.saml2.jaxb.assertion.impl.NameIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.NameIDElementImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("NameID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                        ...
                        if (("EncryptedID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedIDElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedIDElementImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptedID" == ___local)&&("urn:oasis:names:tc:SAML:2.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  4 :
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptedData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptedID = ((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.EncryptedElementTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                    ...
                    case  8 :
                        ...
                        if (true) {
                            _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  8 :
                        ...
                        _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromLeaveElement((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, ___uri, ___local, ___qname));
                        return ;
                    case  6 :
                        state = 7;
                        continue outer;
                ...
                switch (state) {
                    ...
                    case  8 :
                        if (("Address" == ___local)&&("" == ___uri)) {
                            _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, ___uri, ___local, ___qname));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  8 :
                        ...
                        _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, ___uri, ___local, ___qname));
                        return ;
                    case  6 :
                        state = 7;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  8 :
                            ...
                            _SubjectConfirmationData = ((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl) spawnChildFromText((com.sun.identity.saml2.jaxb.assertion.impl.SubjectConfirmationDataTypeImpl.class), 9, value));
                            return ;
                        case  6 :
                            state = 7;
                            continue outer;
