...
+"t\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\'\u0001pq\u0000~\u0000cq\u0000~\u0000pq\u0000~"
+"\u0000oq\u0000~\u0000xq\u0000~\u0000wq\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\nq\u0000~\u0000Eq\u0000~\u0000Yq\u0000~\u0000mq\u0000~\u0000\u008aq\u0000~\u0000\u0096q\u0000~\u0000)q\u0000~"
+"\u0000Tq\u0000~\u0000hq\u0000~\u0000|q\u0000~\u0000\u00a0q\u0000~\u0000\u0007q\u0000~\u0000\tq\u0000~\u0000\u000bq\u0000~\u0000Dq\u0000~\u0000lq\u0000~\u0000\u0014q\u0000~\u0000Mq\u0000~\u0000aq\u0000~"
+"\u0000uq\u0000~\u0000\u0080q\u0000~\u0000\rq\u0000~\u0000\u0006q\u0000~\u0000\u0019q\u0000~\u0000Hq\u0000~\u0000Pq\u0000~\u0000\u0016q\u0000~\u0000Gq\u0000~\u0000Oq\u0000~\u0000\\q\u0000~\u0000[q\u0000~"
+"\u0000dx"));
        }
                ...
                switch (state) {
                    ...
                    case  23 :
                        ...
                        if (("EncryptionProperty" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptionProperties = ((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl.class), 24, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptionProperty" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptionProperties = ((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl.class), 24, ___uri, ___local, ___qname, __atts));
                    ...
                    case  19 :
                        if (("CipherValue" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _CipherData = ((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherDataTypeImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherDataTypeImpl.class), 20, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  18 :
                        if (("CipherData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _CipherData = ((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherDataElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherDataElementImpl.class), 21, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("CipherData" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                    ...
                    case  21 :
                        if (("EncryptionProperties" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            _EncryptionProperties = ((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesElementImpl.class), 22, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("EncryptionProperties" == ___local)&&("http://www.w3.org/2001/04/xmlenc#" == ___uri)) {
                            context.pushAttributes(__atts, false);
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  23 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _EncryptionProperties = ((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.xmlenc.impl.EncryptionPropertiesTypeImpl.class), 24, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  22 :
