...
+"\u0000Oq\u0000~\u0000\u000eq\u0000~\u0000&q\u0000~\u0000Iq\u0000~\u0000Qq\u0000~\u0000+q\u0000~\u0000Vq\u0000~\u0000Zq\u0000~\u0000\u0011q\u0000~\u0000\'q\u0000~\u0000Jq\u0000~\u0000Rq\u0000~"
+"\u0000\tq\u0000~\u0000Gq\u0000~\u0000gq\u0000~\u0000\u0005q\u0000~\u0000Fq\u0000~\u0000\u0007q\u0000~\u0000\u0006x"));
        }
                ...
                switch (state) {
                    ...
                    case  6 :
                        if (("Extension" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _Extension = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ExtensionElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ExtensionElementImpl.class), 9, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Extension" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                    ...
                    case  7 :
                        if (!(("" == ___uri)||("urn:liberty:disco:2003-08" == ___uri))) {
                            _Extension = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ExtensionTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ExtensionTypeImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.StatusTypeImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                }
