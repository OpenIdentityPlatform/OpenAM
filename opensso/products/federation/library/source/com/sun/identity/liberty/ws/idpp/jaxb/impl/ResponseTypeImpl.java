...
+"/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0017\u0001pq\u0000~\u0000%q\u0000~\u0000Qq\u0000~\u0000\u000fq\u0000~\u0000\'q\u0000~\u0000"
+"Kq\u0000~\u0000Sq\u0000~\u0000,q\u0000~\u0000Xq\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000(q\u0000~\u0000Lq\u0000~\u0000Tq\u0000~\u0000\nq\u0000~\u0000Iq\u0000~\u0000\u0006q\u0000~\u0000"
+"\u0007q\u0000~\u0000\u0005q\u0000~\u0000xq\u0000~\u0000iq\u0000~\u0000\\q\u0000~\u0000Hq\u0000~\u0000Gx"));
        }
                ...
                switch (state) {
                    ...
                    case  14 :
                        if (!(("" == ___uri)||("urn:liberty:id-sis-pp:2003-08" == ___uri))) {
                            _getExtension().add(((com.sun.identity.liberty.ws.idpp.jaxb.impl.ExtensionTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.idpp.jaxb.impl.ExtensionTypeImpl.class), 15, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
                    ...
                    case  9 :
                        if (("Status" == ___local)&&("urn:liberty:id-sis-pp:2003-08" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.idpp.jaxb.impl.StatusElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.idpp.jaxb.impl.StatusElementImpl.class), 12, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Status" == ___local)&&("urn:liberty:id-sis-pp:2003-08" == ___uri)) {
                            context.pushAttributes(__atts, false);
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.idpp.jaxb.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.idpp.jaxb.impl.StatusTypeImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                }
