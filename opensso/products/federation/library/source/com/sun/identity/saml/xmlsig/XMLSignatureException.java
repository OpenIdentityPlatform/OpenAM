 ...
 *
 * $Id: XMLSignatureException.java,v 1.3 2008/06/25 05:47:39 qcheng Exp $
 *
 */
...
public class XMLSignatureException extends SAMLException {
    ...
    /**
     * Constructs an <code>XMLSignatureException</code> with given
     * <code>Throwable</code>.
     *
     * @param t Exception nested in the new exception.
     *
     */
    public XMLSignatureException(Throwable t) {
        super(t);
    }

    /**
     * Constructs a new <code>XMLSignatureException</code> without a nested
     * <code>Throwable</code>.
     ...
     *
     */
    public XMLSignatureException(String rbName, String errorCode, Object[] args)
    {
