                ...
                switch (state) {
                    case  5 :
                        ...
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                    ...
                    case  4 :
                        if (("Reference" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _getReference().add(((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceElementImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Reference" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                ...
                switch (state) {
                    case  5 :
                        if (("Id" == ___local)&&("" == ___uri)) {
                            _getReference().add(((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.ReferenceTypeImpl.class), 6, ___uri, ___local, ___qname)));
                            return ;
                        }
