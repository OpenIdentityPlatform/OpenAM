...
+"sionPool;xp\u0000\u0000\u0000\"\u0001pq\u0000~\u0000\'q\u0000~\u0000^q\u0000~\u0000sq\u0000~\u0000\u0011q\u0000~\u0000)q\u0000~\u0000Jq\u0000~\u0000Pq\u0000~\u0000Xq\u0000~"
+"\u0000`q\u0000~\u0000mq\u0000~\u0000uq\u0000~\u0000.q\u0000~\u0000eq\u0000~\u0000zq\u0000~\u0000\u000bq\u0000~\u0000\u0014q\u0000~\u0000*q\u0000~\u0000Kq\u0000~\u0000Qq\u0000~\u0000Yq\u0000~"
+"\u0000aq\u0000~\u0000nq\u0000~\u0000vq\u0000~\u0000\fq\u0000~\u0000Vq\u0000~\u0000kq\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\nq\u0000~\u0000Uq\u0000~\u0000\u0006q\u0000~\u0000jq\u0000~"
+"\u0000\u0007q\u0000~\u0000ix"));
        }
                ...
                switch (state) {
                    ...
                    case  8 :
                        if (("AuthorityBinding" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _getAuthorityBinding().add(((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.AuthorityBindingElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.AuthorityBindingElementImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AuthorityBinding" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                    ...
                    case  7 :
                        if (("SubjectLocality" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityElementImpl.class), 8, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("SubjectLocality" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            context.pushAttributes(__atts, false);
                    ...
                    case  12 :
                        ...
                        _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl.class), 13, ___uri, ___local, ___qname, __atts));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl) spawnChildFromLeaveElement((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl.class), 13, ___uri, ___local, ___qname));
                        return ;
                    case  11 :
                        if (("AuthorityBinding" == ___local)&&("urn:oasis:names:tc:SAML:1.0:assertion" == ___uri)) {
                            context.popAttributes();
                ...
                switch (state) {
                    ...
                    case  10 :
                        if (("AuthorityKind" == ___local)&&("" == ___uri)) {
                            _getAuthorityBinding().add(((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.AuthorityBindingTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.AuthorityBindingTypeImpl.class), 11, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  6 :
                    ...
                    case  12 :
                        if (("DNSAddress" == ___local)&&("" == ___uri)) {
                            _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl.class), 13, ___uri, ___local, ___qname));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl) spawnChildFromLeaveAttribute((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl.class), 13, ___uri, ___local, ___qname));
                        return ;
                    case  2 :
                        if (("AuthenticationInstant" == ___local)&&("" == ___uri)) {
                            state = 3;
                ...
                try {
                    switch (state) {
                        ...
                        case  12 :
                            ...
                            _SubjectLocality = ((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl) spawnChildFromText((com.sun.identity.liberty.ws.common.jaxb.assertion.impl.SubjectLocalityTypeImpl.class), 13, value));
                            return ;
                        case  1 :
                            state = 2;
                            eatText1(value);
