                ...
                switch (state) {
                    ...
                    case  6 :
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _Transforms = ((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsElementImpl.class), 7, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Transforms" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                    ...
                    case  8 :
                        if (("Transform" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _Transforms = ((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Transform" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            _Transforms = ((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.TransformsTypeImpl.class), 9, ___uri, ___local, ___qname, __atts));
