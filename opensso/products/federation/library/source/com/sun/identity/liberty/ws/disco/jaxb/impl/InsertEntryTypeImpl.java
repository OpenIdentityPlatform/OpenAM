                ...
                switch (state) {
                    case  3 :
                        ...
                        if (("ResourceID" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _ResourceOffering = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 4, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("ResourceID" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _ResourceOffering = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 4, ___uri, ___local, ___qname, __atts));
                    ...
                    case  0 :
                        if (("ResourceOffering" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                            _ResourceOffering = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingElementImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("ResourceOffering" == ___local)&&("urn:liberty:disco:2003-08" == ___uri)) {
                ...
                switch (state) {
                    case  3 :
                        if (("entryID" == ___local)&&("" == ___uri)) {
                            _ResourceOffering = ((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.disco.jaxb.impl.ResourceOfferingTypeImpl.class), 4, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  1 :
