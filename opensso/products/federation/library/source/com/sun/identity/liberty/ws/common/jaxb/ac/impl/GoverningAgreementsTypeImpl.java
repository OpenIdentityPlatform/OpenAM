                ...
                switch (state) {
                    case  0 :
                        if (("GoverningAgreementRef" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                            _getGoverningAgreementRef().add(((com.sun.identity.liberty.ws.common.jaxb.ac.impl.GoverningAgreementRefElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ac.impl.GoverningAgreementRefElementImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("GoverningAgreementRef" == ___local)&&("urn:liberty:ac:2003-08" == ___uri)) {
                ...
                switch (state) {
                    case  2 :
                        if (("governingAgreementRef" == ___local)&&("" == ___uri)) {
                            _getGoverningAgreementRef().add(((com.sun.identity.liberty.ws.common.jaxb.ac.impl.GoverningAgreementRefTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.ac.impl.GoverningAgreementRefTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  1 :
