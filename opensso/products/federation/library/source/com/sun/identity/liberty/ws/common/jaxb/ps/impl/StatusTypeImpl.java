                ...
                switch (state) {
                    case  9 :
                        if (("Status" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.common.jaxb.ps.impl.StatusElementImpl) spawnChildFromEnterElement((com.sun.identity.liberty.ws.common.jaxb.ps.impl.StatusElementImpl.class), 12, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Status" == ___local)&&("urn:liberty:iff:2003-08" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  10 :
                        if (("code" == ___local)&&("" == ___uri)) {
                            _Status = ((com.sun.identity.liberty.ws.common.jaxb.ps.impl.StatusTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.liberty.ws.common.jaxb.ps.impl.StatusTypeImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  3 :
