...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0002\u0001pq\u0000~\u0000\tq\u0000~\u00001x"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        if (("HMACOutputLength" == ___local)&&("http://www.w3.org/2000/09/xmldsig#" == ___uri)) {
                            spawnHandlerFromEnterElement(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (!(("" == ___uri)||("http://www.w3.org/2000/09/xmldsig#" == ___uri))) {
                            spawnHandlerFromEnterElement(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        continue outer;
                    case  3 :
                        spawnHandlerFromLeaveElement(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, ___uri, ___local, ___qname);
                        return ;
                    case  6 :
                        state = 7;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        continue outer;
                    case  3 :
                        spawnHandlerFromEnterAttribute(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, ___uri, ___local, ___qname);
                        return ;
                    case  6 :
                        state = 7;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        continue outer;
                    case  3 :
                        spawnHandlerFromLeaveAttribute(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, ___uri, ___local, ___qname);
                        return ;
                    case  6 :
                        state = 7;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  7 :
                            ...
                            continue outer;
                        case  3 :
                            spawnHandlerFromText(new com.sun.identity.liberty.ws.common.jaxb.xmlsig.impl.SignatureMethodTypeImpl.Unmarshaller.Interleave1(), 9, value);
                            return ;
                        case  6 :
                            state = 7;
                            continue outer;
