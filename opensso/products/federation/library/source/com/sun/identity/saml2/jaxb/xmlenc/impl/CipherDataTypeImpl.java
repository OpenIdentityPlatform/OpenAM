                ...
                switch (state) {
                    case  2 :
                        if (("URI" == ___local)&&("" == ___uri)) {
                            _CipherReference = ((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherReferenceTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.xmlenc.impl.CipherReferenceTypeImpl.class), 3, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  1 :
