 ...
 *
 * $Id: OrgDeleteGroupReq.java,v 1.2 2008/06/25 05:52:29 qcheng Exp $
 *
 */
...
class OrgDeleteGroupReq extends AddDeleteReq {
    ...
    /**
     * Constructs a new OrgDeleteGroupReq .
     *
     * @param  targetDN the Organization DN. 
     */        
    OrgDeleteGroupReq (String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(bundle.getString("requestdescription31") +
            targetDN);
