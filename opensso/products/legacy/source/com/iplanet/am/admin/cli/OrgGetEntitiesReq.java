 ...
 *
 * $Id: OrgGetEntitiesReq.java,v 1.2 2008/06/25 05:52:30 qcheng Exp $
 *
 */
    ...
    extends SearchReq
{
     ...
     *
     * @param targetDN Organization distinguished name.
     */
    OrgGetEntitiesReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription90") +
            " " + targetDN);
    ...
    /**
     * This method prints all the Entity information for an Organization 
     * based on if DNsOnly is true than it prints only the DNs of the 
     * entities else it prints all the information of the all the entities. 
     *
     * @param dpConnection AMStoreConnection.
     * @throws AdminException if unable to retrieve the entities.
     */
        ...
        throws AdminException
    {
        ...
        try {
            ...
            if (entityDNs.isEmpty()) {
                entityDNs = searchEntities(dpConnection, type.getType());
            } else {
                needValidation = true;
            }
    ...
    private Set searchEntities(AMStoreConnection dpConnection, int type)
        throws AMException, SSOException
    {
        Set results = null;
        AMOrganization org = dpConnection.getOrganization(targetDN);
            
        if ((org != null) && org.isExists()) {
            AMSearchControl searchCtrl = createSearchControl(
                AMConstants.SCOPE_ONE);
            AMSearchResults searchResults = org.searchEntities(type,
                filter, new HashMap(), searchCtrl);
