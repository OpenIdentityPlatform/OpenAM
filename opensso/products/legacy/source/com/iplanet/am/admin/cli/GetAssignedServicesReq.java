 ...
 *
 * $Id: GetAssignedServicesReq.java,v 1.2 2008/06/25 05:52:27 qcheng Exp $
 *
 */
...
class GetAssignedServicesReq extends AdminReq {
    private boolean includeMandatory = false;
    private String realmPath = null;

    /**
     * Constructs a new GetAssignedServicesReq.
     *
     * @param  targetDN the Realm to delete. 
     */        
    GetAssignedServicesReq(String targetDN) {
        //
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription104") +
            " " + targetDN);
        prnWriter.flush();
    ...
    /**
     *  Sets the value for true or false for including mandatory services
     *
     *  @param incMandatory
     */
    void setIncMandatory(boolean incMandatory) {
        includeMandatory = incMandatory;
    }
        ...
        throws AdminException
    {
        AdminReq.writer.println(bundle.getString("realm") + "\n" +
            bundle.getString("getAssignedSvcs") + " " + targetDN +
        ...
        try {
            ...
            //
            //  getAssignedServices() is the same as
            //  getAssignedServices(true).  right now, the xml default
            //  is "false".
            //
            Set gaSet = ocm.getAssignedServices(includeMandatory);
            ...
            AdminReq.writer.println(bundle.getString("getAssignedSvcs") +
                " " + targetDN +
