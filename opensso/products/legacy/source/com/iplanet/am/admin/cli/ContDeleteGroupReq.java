 ...
 *
 * $Id: ContDeleteGroupReq.java,v 1.2 2008/06/25 05:52:25 qcheng Exp $
 *
 */
...
class ContDeleteGroupReq extends AddDeleteReq {
    private boolean recursiveDelete = false;

    /**
     * Constructs a new ContDeleteGroupReq .
     *
     * @param targetDN the Container DN. 
     */        
    ContDeleteGroupReq (String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription7") +
            " " +targetDN);
