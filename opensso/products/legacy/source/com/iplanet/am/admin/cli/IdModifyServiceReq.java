 ...
 *
 * $Id: IdModifyServiceReq.java,v 1.2 2008/06/25 05:52:28 qcheng Exp $
 *
 */
...
class IdModifyServiceReq extends AdminReq {
    ...
    /**
     * Constructs a new IdModifyServiceReq.
     *
     * @param  targetDN the parent Realm DN. 
     */        
    IdModifyServiceReq(String targetDN) {
        super(targetDN);
        realmPath = targetDN;
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription132") +
            " " + targetDN);
        ...
        throws AdminException
    {
        AdminReq.writer.println(bundle.getString("identity") + "\n" +
            bundle.getString("modServiceId") + " " + serviceName + " " +
        ...
        try {
            ...
            doLog(args, AdminUtils.MODIFY_SERVICE_IDENTITY_ATTEMPT);
            ai2use.modifyService(serviceName, serviceAttrMap);
            doLog(args, AdminUtils.MODIFY_SERVICE_IDENTITY);
