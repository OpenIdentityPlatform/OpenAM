 ...
 *
 * $Id: OrgModifyEntityReq.java,v 1.2 2008/06/25 05:52:30 qcheng Exp $
 *
 */
    ...
    extends AdminReq
{
    ...
    /**
     * Constructs a new handle for modifying entity in a organization.
     *
     * @param targetDN organization DN. 
     */        
    OrgModifyEntityReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription89") +
            " "  + targetDN + "\n" + "  " + entityDN); 
