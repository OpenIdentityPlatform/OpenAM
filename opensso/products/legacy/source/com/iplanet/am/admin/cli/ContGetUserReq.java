 ...
 *
 * $Id: ContGetUserReq.java,v 1.2 2008/06/25 05:52:25 qcheng Exp $
 *
 */
...
class ContGetUserReq extends GetUserReq {
    /**
     * Constructs a new ContGetUserReq.
     *
     * @param targetDN  the Container DN.
     */
    ContGetUserReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription18") +
            " " + targetDN);
    ...
    /**
     * Prints all the Users information for an Container based on
        ...
        throws AdminException
    {
        ...
        try {
            ...
            if (userDNs.isEmpty()) {
                ...
                AMSearchResults searchResults = orgUnit.searchUsers(
                    filter, searchCtrl);
