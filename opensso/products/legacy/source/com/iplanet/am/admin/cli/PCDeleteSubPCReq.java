 ...
 *
 * $Id: PCDeleteSubPCReq.java,v 1.2 2008/06/25 05:52:31 qcheng Exp $
 *
 */
...
class PCDeleteSubPCReq extends AddDeleteReq {
    private boolean recursiveDelete = false;
    
    /**
     * Constructs a new PCDeleteSubPCReq.
     * @param targetDN the PeopleContainer DN. 
     */        
    PCDeleteSubPCReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription48") +
            " "  + targetDN);
...
//                doLog(pc, "delete-pc");
            ...
            if (AdminUtils.logEnabled()) {
                AdminUtils.log(bundle.getString("peoplecontainer") + " " +
                    targetDN + "\n" +
                    bundle.getString("deletedsubpeoplecontainers"));
            }
