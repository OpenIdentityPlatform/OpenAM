 ...
 *
 * $Id: ContModifyPCReq.java,v 1.2 2008/06/25 05:52:26 qcheng Exp $
 *
 */
...
class ContModifyPCReq extends AdminReq {
    private Map pcReq;
    private String pcDN;        

    /**
     * Constructs a new ContModifyPCReq.
     *
     * @param targetDN the Container DN. 
     */        
    ContModifyPCReq(String targetDN) {
        super(targetDN);
    }

    /**
     * adds the subCont DN and its avPair Map to the PCReq Map.
     *
     * @param modifyDN the PC DN
