 ...
 *
 * $Id: FilteredRoleGetUserReq.java,v 1.2 2008/06/25 05:52:27 qcheng Exp $
 *
 */
...
class FilteredRoleGetUserReq extends RoleGetUserReq {

    FilteredRoleGetUserReq(String targetDN) {
        super(targetDN);
    }
