 ...
 *
 * $Id: OrgDeletePCReq.java,v 1.2 2008/06/25 05:52:29 qcheng Exp $
 *
 */
...
class OrgDeletePCReq extends AddDeleteReq {
    private boolean recursiveDelete = false;

    /**
     * Constructs a new OrgDeletePCReq.
     *
     * @param targetDN the Organization DN. 
     */        
    OrgDeletePCReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(bundle.getString("requestdescription32") + targetDN);
