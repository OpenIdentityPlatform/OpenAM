 ...
 *
 * $Id: OrgDeleteEntitiesReq.java,v 1.2 2008/06/25 05:52:29 qcheng Exp $
 *
 */
...
class OrgDeleteEntitiesReq
    extends AddDeleteReq
{
    private String entityType = null;

    /**
     * Constructs a new handle to remove entities from organization.
     *
     * @param targetDN organization distinguished name.
     */        
    OrgDeleteEntitiesReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription88") +
            " "  + targetDN);
        ...
        throws AdminException
    {
        ...
        writer.println(bundle.getString("organization") + " " +
            targetDN + "\n" + localizedStr);
        ...
        try {
            ...
            AMOrganization org =
                dpConnection.getOrganization(targetDN);

            for (Iterator iter = DNSet.iterator(); iter.hasNext(); ) {
                String dn = (String)iter.next();

                if (deleteEntity(dpConnection, org, dn)) {
                    deletedEntities.add(dn);
                }
            }

//            doLogStringSetForEntity(
//                deletedEntities, "delete-entity", localizedName);
            doLogStringSetForEntity(
                deletedEntities, AdminUtils.DELETE_ENTITY, localizedName);
    ...
    ) throws AdminException
    {
        ...
        if (entity != null) {
            ...
            throw new AdminException(MessageFormat.format(msg, arr));
        }
