 ...
 *
 * $Id: ContRemoveServiceTemplateAttrValuesReq.java,v 1.2 2008/06/25 05:52:26 qcheng Exp $
 *
 */
...
class ContRemoveServiceTemplateAttrValuesReq
    extends RemoveServiceTemplateAttrValuesReq
{
    /**
     * Constructs a new instance.
     *
     * @param targetDN distinguished name of Container. 
     */        
    ContRemoveServiceTemplateAttrValuesReq(String targetDN) {
        super(targetDN);
    }

    String getDescriptionString() {
        return "requestdescription77";
    }
        ...
        throws AdminException
    {
        ...
        try {
            if (scope.equalsIgnoreCase("SCOPE_ONE")) {
                ...
                AMOrganizationalUnit ou = dpConnection.getOrganizationalUnit(
                    targetDN);
