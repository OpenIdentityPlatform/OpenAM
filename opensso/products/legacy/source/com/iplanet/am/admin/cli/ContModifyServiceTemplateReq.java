 ...
 *
 * $Id: ContModifyServiceTemplateReq.java,v 1.2 2008/06/25 05:52:26 qcheng Exp $
 *
 */
...
class ContModifyServiceTemplateReq extends AdminReq {
    ...
    /**
     * Constructs a new empty ContModifyServiceTemplateReq.
     */
    ContModifyServiceTemplateReq() {
        super();
    }

    /**
     * Constructs a new ContModifyServiceTemplateReq.
     *
     * @param  targetDN the Organization DN. 
     */        
    ContModifyServiceTemplateReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription66") +
            " " + targetDN);
        prnWriter.flush();
        ...
        throws AdminException
    {
        try {
            ...
            try {
                ...
                /* The exception is ignored becuase COSManager.getDifinition
            ...
            if (cosDefinition != null) {
                ...
                while (newAttrItr.hasNext()) {
                    ...
                    if (!valueExists) {
                        ...
                        cosDefinition.addCOSAttribute(
                            newAttr, convertCosQualifier(name));
                        cosDefinition.save();
                    }
                }
            }

            AMOrganizationalUnit ou = dpConnection.getOrganizationalUnit(dn);
            AMTemplate tmpl = ou.getTemplate(serviceName, stype);
...
//                      doLog(tmpl, "modify-servtemplate");
    ...
    if (qual.equalsIgnoreCase("default"))
        return ICOSDefinition.DEFAULT;
    if (qual.equalsIgnoreCase("override"))
        return ICOSDefinition.OVERRIDE;
    if (qual.equalsIgnoreCase("merge-schemes"))
        return ICOSDefinition.MERGE_SCHEMES;
    if (qual.equalsIgnoreCase("operational"))
        return ICOSDefinition.OPERATIONAL;
    return ICOSDefinition.DEFAULT;
    }
