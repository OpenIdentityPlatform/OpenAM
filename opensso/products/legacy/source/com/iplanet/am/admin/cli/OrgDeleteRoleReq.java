 ...
 *
 * $Id: OrgDeleteRoleReq.java,v 1.2 2008/06/25 05:52:30 qcheng Exp $
 *
 */
...
class OrgDeleteRoleReq extends AddDeleteReq {
    /**
     * Constructs a new OrgDeleteRoleReq.
     */        
    OrgDeleteRoleReq() {
        super();
    }
     ...
     */        
    OrgDeleteRoleReq(String targetDN) {
        super(targetDN);
    }
    ...
    public String toString() {
        ...
        prnWriter.println("Request Description: Delete Roles in Organization " +
            targetDN);
