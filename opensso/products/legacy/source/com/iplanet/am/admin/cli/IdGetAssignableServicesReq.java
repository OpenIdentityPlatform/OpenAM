 ...
 *
 * $Id: IdGetAssignableServicesReq.java,v 1.2 2008/06/25 05:52:28 qcheng Exp $
 *
 */
...
class IdGetAssignableServicesReq extends AdminReq {
    private String realmPath = null;
    private String idName = null;
    private IdType idType = IdType.USER;

    /**
     * Constructs a new IdGetAssignableServicesReq.
     *
     * @param  targetDN the parent Realm DN. 
     */        
    IdGetAssignableServicesReq(String targetDN) {
        super(targetDN);
        realmPath = targetDN;
    }
    ...
    public String toString() {
        ...
        prnWriter.println(AdminReq.bundle.getString("requestdescription120") +
            " " + targetDN);
        prnWriter.flush();
        ...
        throws AdminException
    {
        AdminReq.writer.println(bundle.getString("identity") + "\n" +
            bundle.getString("getAssignableSvcId") + " " + idName + " " +
        ...
        try {
            ...
            Set aoSet = ai2use.getAssignableServices();
