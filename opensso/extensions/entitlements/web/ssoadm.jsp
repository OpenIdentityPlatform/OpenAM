<%--
   ...
   $Id: ssoadm.jsp,v 1.1 2009/06/12 00:02:35 veiming Exp $
...
<%
    try {
        ...
        WebCLIHelper helper = new WebCLIHelper(request,
            "com.sun.identity.federation.cli.FederationManager,com.sun.identity.cli.AccessManager,com.sun.identity.entitlement.opensso.cli.EntitlementManager",
