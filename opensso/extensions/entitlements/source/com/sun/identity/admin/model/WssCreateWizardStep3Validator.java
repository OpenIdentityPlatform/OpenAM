 ...
 *
 * $Id: WssCreateWizardStep3Validator.java,v 1.2 2009/07/23 20:46:54 ggennaro Exp $
 */
...
public class WssCreateWizardStep3Validator extends WizardStepValidator {
    ...
    public WssCreateWizardStep3Validator(WizardBean wizardBean) {
        super(wizardBean);
    }
    ...
    private boolean validServiceName() {
        WssCreateWizardBean wizardBean = (WssCreateWizardBean) getWizardBean();
        String serviceName = wizardBean.getWscServiceName();
        ...
        wizardBean.setWscServiceNameInputEffect(e);

        e = new MessageErrorEffect();
        wizardBean.setWscServiceNameMessageEffect(e);
