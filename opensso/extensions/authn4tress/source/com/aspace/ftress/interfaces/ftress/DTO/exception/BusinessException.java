...
public abstract class BusinessException  extends com.aspace.ftress.interfaces.ftress.DTO.exception.FTRESSException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://exception.DTO.ftress.interfaces.ftress.aspace.com", "BusinessException"));
    }
