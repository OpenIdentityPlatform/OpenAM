...
String challenge_txt = (String)session.getAttribute("Challenge");
%>
...
<jato:content name="validContent">
    ...
    function LoginSubmit(value) {
        ...
        if (hiddenFrm != null) {
            ...
            try {
                var rtn = document.AuthClient.CreateReferenceCredential("test\\" + hiddenFrm.IDToken1.value);
                if("" == rtn || "" == hiddenFrm.IDToken1.value) {
                    return;
                } else {
                    hiddenFrm.txtAuthData.value = rtn;
                }
            } catch( e ) {
                alert(e.message);
                return;
...
<body class="LogBdy" onload="placeCursorOnFirstElm();">
  ...
  <OBJECT id="AuthClient" classid="clsid:A01AF8C1-0102-4C3D-8DA8-11D2D99F049F" VIEWASTEXT>
    <PARAM NAME="Challenge" VALUE="<%= challenge_txt %>" >
    <PARAM NAME="ServerCertUrl" VALUE="http://w2k3ee-h/cert.crt" >
    <PARAM NAME="DeviceAdapter" VALUE="MMFramework.AutoJohmonDeviceAdapter" >
    <PARAM NAME="VerifyCert" value="0" >
  </OBJECT>
