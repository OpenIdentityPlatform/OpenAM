...
public class AuthnAuthorityDescriptorTypeImpl
    extends com.sun.identity.saml2.jaxb.metadata.impl.RoleDescriptorTypeImpl
    implements com.sun.identity.saml2.jaxb.metadata.AuthnAuthorityDescriptorType, com.sun.xml.bind.JAXBObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallableObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.XMLSerializable, com.sun.identity.saml2.jaxb.assertion.impl.runtime.ValidatableObject
{
    ...
    protected com.sun.xml.bind.util.ListImpl _AuthnQueryService;
    public final static Class version = (com.sun.identity.saml2.jaxb.metadata.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.saml2.jaxb.metadata.AuthnAuthorityDescriptorType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getAuthnQueryService() {
        if (_AuthnQueryService == null) {
            _AuthnQueryService = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _AuthnQueryService;
    }

    public java.util.List getAuthnQueryService() {
        return _getAuthnQueryService();
    }
    ...
    public com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.saml2.jaxb.metadata.impl.AuthnAuthorityDescriptorTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx3 = 0;
        final int len3 = ((_AuthnQueryService == null)? 0 :_AuthnQueryService.size());
        super.serializeBody(context);
        while (idx3 != len3) {
            if (_AuthnQueryService.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _AuthnQueryService.get(idx3 ++)), "AuthnQueryService");
            } else {
                context.startElement("urn:oasis:names:tc:SAML:2.0:metadata", "AuthnQueryService");
                int idx_0 = idx3;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _AuthnQueryService.get(idx_0 ++)), "AuthnQueryService");
                context.endNamespaceDecls();
                int idx_1 = idx3;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _AuthnQueryService.get(idx_1 ++)), "AuthnQueryService");
        ...
        while (idx1 != len1) {
            ...
            context.endAttributes();
            try {
                context.text(((String) _NameIDFormat.get(idx1 ++)), "NameIDFormat");
            } catch (Exception e) {
                com.sun.identity.saml2.jaxb.assertion.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx3 != len3) {
            if (_AuthnQueryService.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _AuthnQueryService.get(idx3 ++)), "AuthnQueryService");
            } else {
                idx3 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx3 != len3) {
            if (_AuthnQueryService.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) _AuthnQueryService.get(idx3 ++)), "AuthnQueryService");
            } else {
                idx3 += 1;
            }
        }
...
+"%q\u0000~\u0000\'sq\u0000~\u0000(t\u0000=com.sun.identity.saml2.jaxb.metadata.AuthnQue"
+"ryServiceElementq\u0000~\u0000,sq\u0000~\u0000\u0016pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0016pp\u0000sq\u0000~\u0000\u0011ppsq\u0000~\u0000"
+"\u001bq\u0000~\u0000\u0015psq\u0000~\u0000\u001eq\u0000~\u0000\u0015pq\u0000~\u0000!q\u0000~\u0000%q\u0000~\u0000\'sq\u0000~\u0000(t\u00001com.sun.identity."
+"saml2.jaxb.metadata.EndpointTypeq\u0000~\u0000,sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001eq\u0000~\u0000\u0015pq\u0000~"
+"\u0000:q\u0000~\u0000Jq\u0000~\u0000\'sq\u0000~\u0000(t\u0000\u0011AuthnQueryServiceq\u0000~\u0000dsq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001bq\u0000~"
+"\u0000\u0015psq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001bq\u0000~\u0000\u0015psq\u0000~\u0000\u001eq\u0000~\u0000\u0015p"
+"q\u0000~\u0000!q\u0000~\u0000%q\u0000~\u0000\'sq\u0000~\u0000(t\u0000Ecom.sun.identity.saml2.jaxb.metadata"
+".AssertionIDRequestServiceElementq\u0000~\u0000,sq\u0000~\u0000\u0016q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0000pps"
+"q\u0000~\u0000\u0016pp\u0000sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001bq\u0000~\u0000\u0015psq\u0000~\u0000\u001eq\u0000~\u0000\u0015pq\u0000~\u0000!q\u0000~\u0000%q\u0000~\u0000\'sq\u0000~\u0000"
+"(q\u0000~\u0000\u00b2q\u0000~\u0000,sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001eq\u0000~\u0000\u0015pq\u0000~\u0000:q\u0000~\u0000Jq\u0000~\u0000\'sq\u0000~\u0000(t\u0000\u0019Asser"
+"tionIDRequestServiceq\u0000~\u0000dq\u0000~\u0000\'sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001bq\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000"
+"\u0015p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u00007q\u0000~\u0000\u0015psr\u0000#com.sun.msv.datatype.xsd.AnyURITy"
+"pe\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000<q\u0000~\u0000At\u0000\u0006anyURIq\u0000~\u0000Eq\u0000~\u0000Gsq\u0000~\u0000Hq\u0000~\u0000\u00d2q\u0000~\u0000As"
+"q\u0000~\u0000\u0011ppsq\u0000~\u0000\u001eq\u0000~\u0000\u0015pq\u0000~\u0000:q\u0000~\u0000Jq\u0000~\u0000\'sq\u0000~\u0000(t\u0000\fNameIDFormatq\u0000~\u0000d"
...
+"alidxq\u0000~\u0000<q\u0000~\u0000At\u0000\u0002IDq\u0000~\u0000E\u0000q\u0000~\u0000Gsq\u0000~\u0000Hq\u0000~\u0000\u00e0q\u0000~\u0000Asq\u0000~\u0000(t\u0000\u0002IDt\u0000"
+"\u0000q\u0000~\u0000\'sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001eq\u0000~\u0000\u0015psq\u0000~\u00007ppsr\u0000%com.sun.msv.datatype.x"
+"sd.DurationType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000<q\u0000~\u0000At\u0000\bdurationq\u0000~\u0000Eq\u0000~\u0000Gsq"
+"\u0000~\u0000Hq\u0000~\u0000\u00eaq\u0000~\u0000Asq\u0000~\u0000(t\u0000\rcacheDurationq\u0000~\u0000\u00e4q\u0000~\u0000\'sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001e"
+"q\u0000~\u0000\u0015pq\u0000~\u0000\u00cfsq\u0000~\u0000(t\u0000\berrorURLq\u0000~\u0000\u00e4q\u0000~\u0000\'sq\u0000~\u0000\u001eppsq\u0000~\u00007ppsr\u0000!co"
+"m.sun.msv.datatype.xsd.ListType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bitemTypet\u0000)Lcom"
+"/sun/msv/datatype/xsd/XSDatatypeImpl;xq\u0000~\u0000=q\u0000~\u0000dt\u0000\u000eanyURILis"
+"tTypeq\u0000~\u0000Eq\u0000~\u0000\u00d1q\u0000~\u0000Gpsq\u0000~\u0000(t\u0000\u001aprotocolSupportEnumerationq\u0000~\u0000"
+"\u00e4sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u001eq\u0000~\u0000\u0015psq\u0000~\u00007ppsr\u0000%com.sun.msv.datatype.xsd.Da"
+"teTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype.xsd.DateTimeBa"
+"seType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000<q\u0000~\u0000At\u0000\bdateTimeq\u0000~\u0000Eq\u0000~\u0000Gsq\u0000~\u0000Hq\u0000~\u0001\u0000"
+"q\u0000~\u0000Asq\u0000~\u0000(t\u0000\nvalidUntilq\u0000~\u0000\u00e4q\u0000~\u0000\'sr\u0000\"com.sun.msv.grammar.Ex"
...
+"\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000O\u0001pq\u0000~\u0000~q\u0000~\u0000rq\u0000~\u0000"
+"jq\u0000~\u0000\\q\u0000~\u0000Tq\u0000~\u00001q\u0000~\u0000\u001dq\u0000~\u0000\u00c4q\u0000~\u0000\u000bq\u0000~\u0000\u00cbq\u0000~\u0000\bq\u0000~\u0000\tq\u0000~\u0000\u00eeq\u0000~\u0000\u00a3q\u0000~\u0000"
+"\u008fq\u0000~\u0000fq\u0000~\u0000\u00b8q\u0000~\u0000\u00bbq\u0000~\u0000\u00aeq\u0000~\u0000\u00a6q\u0000~\u0000\u009aq\u0000~\u0000\u0092q\u0000~\u0000\u0085q\u0000~\u0000}q\u0000~\u0000qq\u0000~\u0000iq\u0000~\u0000"
+"[q\u0000~\u0000Sq\u0000~\u00000q\u0000~\u0000\u001aq\u0000~\u0000\u00c3q\u0000~\u0000\u00d8q\u0000~\u0000\u00e5q\u0000~\u0000\u00acq\u0000~\u0000\u0098q\u0000~\u0000\u0083q\u0000~\u0000oq\u0000~\u0000Yq\u0000~\u0000"
+".q\u0000~\u0000\u00c1q\u0000~\u0000zq\u0000~\u0000Pq\u0000~\u0000\u0012q\u0000~\u0000\u008eq\u0000~\u0000eq\u0000~\u0000\u00b7q\u0000~\u0000\u00a4q\u0000~\u0000\u0090q\u0000~\u0000{q\u0000~\u0000gq\u0000~\u0000"
+"Qq\u0000~\u0000\u0013q\u0000~\u0000\u00b9q\u0000~\u0000\u0005q\u0000~\u0000\u0007q\u0000~\u0000\fq\u0000~\u0000\u0006q\u0000~\u0000\u00b3q\u0000~\u0000\u009fq\u0000~\u0000\u008aq\u0000~\u0000vq\u0000~\u0000`q\u0000~\u0000"
+"5q\u0000~\u0000\u00c7q\u0000~\u0000\u00d4q\u0000~\u0000\nq\u0000~\u0000\rq\u0000~\u0000\u0010q\u0000~\u0000\u000eq\u0000~\u0000\u00ceq\u0000~\u0000\u000fq\u0000~\u0000\u00faq\u0000~\u0000\u00ccq\u0000~\u0000\u00bcq\u0000~\u0000"
+"\u00afq\u0000~\u0000\u00a7q\u0000~\u0000\u009bq\u0000~\u0000\u0093q\u0000~\u0000\u0086x"));
        }
        ...
        extends com.sun.identity.saml2.jaxb.assertion.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public Object owner() {
            return com.sun.identity.saml2.jaxb.metadata.impl.AuthnAuthorityDescriptorTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  5 :
                        if (("AssertionIDRequestService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            _getAssertionIDRequestService().add(((com.sun.identity.saml2.jaxb.metadata.impl.AssertionIDRequestServiceElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.metadata.impl.AssertionIDRequestServiceElementImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AssertionIDRequestService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                    ...
                    case  2 :
                        if (("AuthnQueryService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            _getAuthnQueryService().add(((com.sun.identity.saml2.jaxb.metadata.impl.AuthnQueryServiceElementImpl) spawnChildFromEnterElement((com.sun.identity.saml2.jaxb.metadata.impl.AuthnQueryServiceElementImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("AuthnQueryService" == ___local)&&("urn:oasis:names:tc:SAML:2.0:metadata" == ___uri)) {
                            context.pushAttributes(__atts, false);
                ...
                switch (state) {
                    case  3 :
                        if (("Binding" == ___local)&&("" == ___uri)) {
                            _getAssertionIDRequestService().add(((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl.class), 4, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
                        if (("ID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.sun.identity.saml2.jaxb.metadata.impl.RoleDescriptorTypeImpl)com.sun.identity.saml2.jaxb.metadata.impl.AuthnAuthorityDescriptorTypeImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                            return ;
                        }
                    ...
                    case  9 :
                        if (("Binding" == ___local)&&("" == ___uri)) {
                            _getAuthnQueryService().add(((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl) spawnChildFromEnterAttribute((com.sun.identity.saml2.jaxb.metadata.impl.EndpointTypeImpl.class), 10, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  8 :
