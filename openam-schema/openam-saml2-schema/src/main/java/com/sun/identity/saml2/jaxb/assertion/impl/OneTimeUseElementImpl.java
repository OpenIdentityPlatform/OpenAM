...
public class OneTimeUseElementImpl
    extends com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl
    implements com.sun.identity.saml2.jaxb.assertion.OneTimeUseElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallableObject, com.sun.identity.saml2.jaxb.assertion.impl.runtime.XMLSerializable, com.sun.identity.saml2.jaxb.assertion.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sun.identity.saml2.jaxb.assertion.OneTimeUseElement.class);
    }
    ...
    public com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sun.identity.saml2.jaxb.assertion.impl.runtime.UnmarshallingContext context) {
        return new com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.sun.identity.saml2.jaxb.assertion.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("urn:oasis:names:tc:SAML:2.0:assertion", "OneTimeUse");
...
+"%urn:oasis:names:tc:SAML:2.0:assertionsr\u0000\"com.sun.msv.gramma"
...
+"entt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0001\u0001pq\u0000~\u0000\tx"));
        ...
        extends com.sun.identity.saml2.jaxb.assertion.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromEnterElement((((com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl)com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl)com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl)com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl)com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseTypeImpl)com.sun.identity.saml2.jaxb.assertion.impl.OneTimeUseElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
