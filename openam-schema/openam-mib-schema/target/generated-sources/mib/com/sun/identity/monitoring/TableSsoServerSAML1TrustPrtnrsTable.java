 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.16.3.
 */
public class TableSsoServerSAML1TrustPrtnrsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerSAML1TrustPrtnrsTable".
     ...
     */
    public TableSsoServerSAML1TrustPrtnrsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerSAML1TrustPrtnrsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerSAML1TrustPrtnrsEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerSAML1TrustPrtnrsEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerSAML1TrustPrtnrsTable");
    }
    ...
    public synchronized void addEntry(SsoServerSAML1TrustPrtnrsEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerSAML1TrustPrtnrsEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerSAML1TrustPrtnrsEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerSAML1TrustPrtnrsEntryMBean[] result = new SsoServerSAML1TrustPrtnrsEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerSAML1TrustPrtnrsEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySAML1TrustPrtnrIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML1TrustPrtnrsTable:name=com.sun.identity.monitoring.SsoServerSAML1TrustPrtnrsEntry" + ",SAML1TrustPrtnrIndex=" + _keySAML1TrustPrtnrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerSAML1TrustPrtnrsEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSAML1TrustPrtnrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSAML1TrustPrtnrsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSAML1TrustPrtnrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSAML1TrustPrtnrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerSAML1TrustPrtnrsEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerSAML1TrustPrtnrsEntryMBean"
     * interface.
    ...
    public Object createSsoServerSAML1TrustPrtnrsEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSAML1TrustPrtnrIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerSAML1TrustPrtnrsEntry entry = new SsoServerSAML1TrustPrtnrsEntry(theMib);
        entry.SAML1TrustPrtnrIndex = aSAML1TrustPrtnrIndex;
        return entry;
    }
