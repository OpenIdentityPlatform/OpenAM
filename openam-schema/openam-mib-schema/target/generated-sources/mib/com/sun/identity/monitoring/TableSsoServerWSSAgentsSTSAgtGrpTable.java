 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.22.6.
 */
public class TableSsoServerWSSAgentsSTSAgtGrpTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerWSSAgentsSTSAgtGrpTable".
     ...
     */
    public TableSsoServerWSSAgentsSTSAgtGrpTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerWSSAgentsSTSAgtGrpTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerWSSAgentsSTSAgtGrpEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerWSSAgentsSTSAgtGrpEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerWSSAgentsSTSAgtGrpTable");
    }
    ...
    public synchronized void addEntry(SsoServerWSSAgentsSTSAgtGrpEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerWSSAgentsSTSAgtGrpEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerWSSAgentsSTSAgtGrpEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerWSSAgentsSTSAgtGrpEntryMBean[] result = new SsoServerWSSAgentsSTSAgtGrpEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerWSSAgentsSTSAgtGrpEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyWssAgentsSTSAgtGrpIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerWSSAgentsSTSAgtGrpTable:name=com.sun.identity.monitoring.SsoServerWSSAgentsSTSAgtGrpEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",WssAgentsSTSAgtGrpIndex=" + _keyWssAgentsSTSAgtGrpIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerWSSAgentsSTSAgtGrpEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getWssAgentsSTSAgtGrpIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerWSSAgentsSTSAgtGrpEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aWssAgentsSTSAgtGrpIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aWssAgentsSTSAgtGrpIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerWSSAgentsSTSAgtGrpEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerWSSAgentsSTSAgtGrpEntryMBean"
     * interface.
    ...
    public Object createSsoServerWSSAgentsSTSAgtGrpEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aWssAgentsSTSAgtGrpIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerWSSAgentsSTSAgtGrpEntry entry = new SsoServerWSSAgentsSTSAgtGrpEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.WssAgentsSTSAgtGrpIndex = aWssAgentsSTSAgtGrpIndex;
        return entry;
    }
