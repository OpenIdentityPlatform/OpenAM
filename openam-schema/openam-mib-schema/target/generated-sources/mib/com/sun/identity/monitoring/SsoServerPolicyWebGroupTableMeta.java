 ...
 */
public class SsoServerPolicyWebGroupTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerPolicyWebGroupTableMeta".
     ...
     */
    public SsoServerPolicyWebGroupTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerPolicyWebGroupEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerPolicyWebGroupTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerPolicyWebGroupEntry" conceptual row (SsoServerPolicyWebGroupEntryMeta)
     * 
     **/
    protected SsoServerPolicyWebGroupEntryMeta createSsoServerPolicyWebGroupEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerPolicyWebGroupEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerPolicyWebGroupEntryMetaNode("SsoServerPolicyWebGroupEntry", "SsoServerPolicyWebGroupTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerPolicyWebGroupEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerPolicyWebGroupTable" + "\" must implement the \"" + 
                           "SsoServerPolicyWebGroupEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerPolicyWebGroupEntryMBean entry = (SsoServerPolicyWebGroupEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerPolicyWebGroupEntryMeta node;
