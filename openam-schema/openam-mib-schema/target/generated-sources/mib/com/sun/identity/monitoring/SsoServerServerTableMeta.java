 ...
 */
public class SsoServerServerTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerServerTableMeta".
     ...
     */
    public SsoServerServerTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerServerEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerServerTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerServerEntry" conceptual row (SsoServerServerEntryMeta)
     * 
     **/
    protected SsoServerServerEntryMeta createSsoServerServerEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerServerEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerServerEntryMetaNode("SsoServerServerEntry", "SsoServerServerTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerServerEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerServerTable" + "\" must implement the \"" + 
                           "SsoServerServerEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerServerEntryMBean entry = (SsoServerServerEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerServerEntryMeta node;
