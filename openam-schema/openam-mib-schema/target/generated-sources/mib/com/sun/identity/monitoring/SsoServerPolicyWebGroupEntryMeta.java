 ...
 */
public class SsoServerPolicyWebGroupEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerPolicyWebGroupEntry".
     */
    public SsoServerPolicyWebGroupEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpString(node.getPolicyWebGroupServerURL());

            case 2:
                return new SnmpString(node.getPolicyWebGroupName());
     ...
     */
    protected void setInstance(SsoServerPolicyWebGroupEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerPolicyWebGroupEntryMBean node;
