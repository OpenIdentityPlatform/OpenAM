 ...
 */
public class SsoServerWSSAgentsWSPAgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsWSPAgentTableMeta".
     ...
     */
    public SsoServerWSSAgentsWSPAgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsWSPAgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsWSPAgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsWSPAgentEntry" conceptual row (SsoServerWSSAgentsWSPAgentEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsWSPAgentEntryMeta createSsoServerWSSAgentsWSPAgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsWSPAgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsWSPAgentEntryMetaNode("SsoServerWSSAgentsWSPAgentEntry", "SsoServerWSSAgentsWSPAgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsWSPAgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsWSPAgentTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsWSPAgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsWSPAgentEntryMBean entry = (SsoServerWSSAgentsWSPAgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsWSPAgentEntryMeta node;
