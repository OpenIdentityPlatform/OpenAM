 ...
 */
public class SsoServerWSSAgentsWSPAgtGrpEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsWSPAgtGrpEntry".
     */
    public SsoServerWSSAgentsWSPAgtGrpEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsWSPAgtGrpSvcEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsWSPAgtGrpProxy());

            case 2:
                return new SnmpString(node.getWssAgentsWSPAgtGrpName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsWSPAgtGrpEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsWSPAgtGrpEntryMBean node;
