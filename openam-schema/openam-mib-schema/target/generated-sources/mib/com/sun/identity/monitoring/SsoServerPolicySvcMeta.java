 ...
 */
public class SsoServerPolicySvcMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerPolicySvc".
     */
    public SsoServerPolicySvcMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter64(node.getPolicyEvalsOut());

            case 2:
                return new SnmpCounter64(node.getPolicyEvalsIn());

            case 1:
                return new SnmpString(node.getPolicyStatus());
     ...
     */
    protected void setInstance(SsoServerPolicySvcMBean var) {
        node = var;
    }
    ...
    protected SsoServerPolicySvcMBean node;
