 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.12.11.
 */
public class TableSsoServerLoggingHdlrTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerLoggingHdlrTable".
     ...
     */
    public TableSsoServerLoggingHdlrTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerLoggingHdlrTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerLoggingHdlrEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerLoggingHdlrEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerLoggingHdlrTable");
    }
    ...
    public synchronized void addEntry(SsoServerLoggingHdlrEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerLoggingHdlrEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerLoggingHdlrEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerLoggingHdlrEntryMBean[] result = new SsoServerLoggingHdlrEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerLoggingHdlrEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyLoggingHdlrIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerLoggingHdlrTable:name=com.sun.identity.monitoring.SsoServerLoggingHdlrEntry" + ",LoggingHdlrIndex=" + _keyLoggingHdlrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerLoggingHdlrEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getLoggingHdlrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerLoggingHdlrEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aLoggingHdlrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aLoggingHdlrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerLoggingHdlrEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerLoggingHdlrEntryMBean"
     * interface.
    ...
    public Object createSsoServerLoggingHdlrEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aLoggingHdlrIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerLoggingHdlrEntry entry = new SsoServerLoggingHdlrEntry(theMib);
        entry.LoggingHdlrIndex = aLoggingHdlrIndex;
        return entry;
    }
