 ...
 */
public class SsoServerWSSAgentsSTSAgentEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsSTSAgentEntry".
     */
    public SsoServerWSSAgentsSTSAgentEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsSTSAgentSvcMEXEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsSTSAgentSvcTokenEndPoint());

            case 2:
                return new SnmpString(node.getWssAgentsSTSAgentName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsSTSAgentEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsSTSAgentEntryMBean node;
