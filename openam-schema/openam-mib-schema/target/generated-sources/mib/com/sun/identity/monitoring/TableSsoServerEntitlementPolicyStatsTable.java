 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.23.6.
 */
public class TableSsoServerEntitlementPolicyStatsTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerEntitlementPolicyStatsTable".
     ...
     */
    public TableSsoServerEntitlementPolicyStatsTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerEntitlementPolicyStatsTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerEntitlementPolicyStatsEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerEntitlementPolicyStatsEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerEntitlementPolicyStatsTable");
    }
    ...
    public synchronized void addEntry(SsoServerEntitlementPolicyStatsEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerEntitlementPolicyStatsEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerEntitlementPolicyStatsEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerEntitlementPolicyStatsEntryMBean[] result = new SsoServerEntitlementPolicyStatsEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerEntitlementPolicyStatsEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyEntitlementPolicyStatsIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerEntitlementPolicyStatsTable:name=com.sun.identity.monitoring.SsoServerEntitlementPolicyStatsEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",EntitlementPolicyStatsIndex=" + _keyEntitlementPolicyStatsIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerEntitlementPolicyStatsEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getEntitlementPolicyStatsIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerEntitlementPolicyStatsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aEntitlementPolicyStatsIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aEntitlementPolicyStatsIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerEntitlementPolicyStatsEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerEntitlementPolicyStatsEntryMBean"
     * interface.
    ...
    public Object createSsoServerEntitlementPolicyStatsEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aEntitlementPolicyStatsIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerEntitlementPolicyStatsEntry entry = new SsoServerEntitlementPolicyStatsEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.EntitlementPolicyStatsIndex = aEntitlementPolicyStatsIndex;
        return entry;
    }
