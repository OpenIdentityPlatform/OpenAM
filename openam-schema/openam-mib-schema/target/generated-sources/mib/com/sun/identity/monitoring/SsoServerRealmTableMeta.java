 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.9.
 */
public class SsoServerRealmTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerRealmTableMeta".
     ...
     */
    public SsoServerRealmTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerRealmEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerRealmTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerRealmEntry" conceptual row (SsoServerRealmEntryMeta)
     * 
     **/
    protected SsoServerRealmEntryMeta createSsoServerRealmEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerRealmEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerRealmEntryMetaNode("SsoServerRealmEntry", "SsoServerRealmTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerRealmEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerRealmTable" + "\" must implement the \"" + 
                           "SsoServerRealmEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerRealmEntryMBean entry = (SsoServerRealmEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerRealmEntryMeta node;
