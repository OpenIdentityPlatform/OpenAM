 ...
 */
public class SsoServerEntitlementExecStatsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerEntitlementExecStatsTableMeta".
     ...
     */
    public SsoServerEntitlementExecStatsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
    ...
    /**
     * Factory method for "SsoServerEntitlementExecStatsEntry" entry metadata class.
     * 
     * You can redefine this method if you need to replace the default
     * generated metadata class with your own customized class.
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerEntitlementExecStatsEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerEntitlementExecStatsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerEntitlementExecStatsEntry" conceptual row (SsoServerEntitlementExecStatsEntryMeta)
     * 
     **/
    protected SsoServerEntitlementExecStatsEntryMeta createSsoServerEntitlementExecStatsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerEntitlementExecStatsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerEntitlementExecStatsEntryMetaNode("SsoServerEntitlementExecStatsEntry", "SsoServerEntitlementExecStatsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerEntitlementExecStatsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerEntitlementExecStatsTable" + "\" must implement the \"" + 
                           "SsoServerEntitlementExecStatsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerEntitlementExecStatsEntryMBean entry = (SsoServerEntitlementExecStatsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerEntitlementExecStatsEntryMeta node;
