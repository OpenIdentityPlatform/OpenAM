 ...
 */
public class SsoServerSAML1EndPointEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerSAML1EndPointEntry".
     */
    public SsoServerSAML1EndPointEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpCounter64(node.getSAML1EndPointRqtFailed());

            case 5:
                return new SnmpCounter64(node.getSAML1EndPointRqtOut());

            case 4:
                return new SnmpCounter64(node.getSAML1EndPointRqtIn());

            case 3:
                return new SnmpString(node.getSAML1EndPointStatus());

            case 2:
                return new SnmpString(node.getSAML1EndPointName());

            case 1:
                throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
            case 7:
                return new SnmpCounter64(node.getSAML1EndPointRqtAborted());
     ...
     */
    protected void setInstance(SsoServerSAML1EndPointEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerSAML1EndPointEntryMBean node;
