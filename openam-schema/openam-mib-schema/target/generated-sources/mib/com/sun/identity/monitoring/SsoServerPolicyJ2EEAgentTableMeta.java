 ...
 */
public class SsoServerPolicyJ2EEAgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerPolicyJ2EEAgentTableMeta".
     ...
     */
    public SsoServerPolicyJ2EEAgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerPolicyJ2EEAgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerPolicyJ2EEAgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerPolicyJ2EEAgentEntry" conceptual row (SsoServerPolicyJ2EEAgentEntryMeta)
     * 
     **/
    protected SsoServerPolicyJ2EEAgentEntryMeta createSsoServerPolicyJ2EEAgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerPolicyJ2EEAgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerPolicyJ2EEAgentEntryMetaNode("SsoServerPolicyJ2EEAgentEntry", "SsoServerPolicyJ2EEAgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerPolicyJ2EEAgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerPolicyJ2EEAgentTable" + "\" must implement the \"" + 
                           "SsoServerPolicyJ2EEAgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerPolicyJ2EEAgentEntryMBean entry = (SsoServerPolicyJ2EEAgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerPolicyJ2EEAgentEntryMeta node;
