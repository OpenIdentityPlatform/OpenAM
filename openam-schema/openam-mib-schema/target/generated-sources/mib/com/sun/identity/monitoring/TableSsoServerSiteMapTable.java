 ...
 */
public class TableSsoServerSiteMapTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerSiteMapTable".
     ...
     */
    public TableSsoServerSiteMapTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerSiteMapTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerSiteMapEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerSiteMapEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerSiteMapTable");
    }
    ...
    public synchronized void addEntry(SsoServerSiteMapEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerSiteMapEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerSiteMapEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerSiteMapEntryMBean[] result = new SsoServerSiteMapEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerSiteMapEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySiteMapIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSiteMapTable:name=com.sun.identity.monitoring.SsoServerSiteMapEntry" + ",SiteMapIndex=" + _keySiteMapIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerSiteMapEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[1];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSiteMapIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSiteMapEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSiteMapIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSiteMapIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerSiteMapEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerSiteMapEntryMBean"
     * interface.
    ...
    public Object createSsoServerSiteMapEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSiteMapIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerSiteMapEntry entry = new SsoServerSiteMapEntry(theMib);
        entry.SiteMapIndex = aSiteMapIndex;
        return entry;
    }
