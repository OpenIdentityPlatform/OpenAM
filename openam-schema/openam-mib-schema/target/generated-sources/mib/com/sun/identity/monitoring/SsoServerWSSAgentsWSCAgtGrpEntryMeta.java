 ...
 */
public class SsoServerWSSAgentsWSCAgtGrpEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsWSCAgtGrpEntry".
     */
    public SsoServerWSSAgentsWSCAgtGrpEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsWSCAgtGrpSvcEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsWSCAgtGrpProxy());

            case 2:
                return new SnmpString(node.getWssAgentsWSCAgtGrpName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsWSCAgtGrpEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsWSCAgtGrpEntryMBean node;
