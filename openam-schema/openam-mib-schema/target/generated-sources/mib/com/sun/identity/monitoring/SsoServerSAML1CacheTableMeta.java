 ...
 */
public class SsoServerSAML1CacheTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerSAML1CacheTableMeta".
     ...
     */
    public SsoServerSAML1CacheTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerSAML1CacheEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerSAML1CacheTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerSAML1CacheEntry" conceptual row (SsoServerSAML1CacheEntryMeta)
     * 
     **/
    protected SsoServerSAML1CacheEntryMeta createSsoServerSAML1CacheEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerSAML1CacheEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerSAML1CacheEntryMetaNode("SsoServerSAML1CacheEntry", "SsoServerSAML1CacheTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerSAML1CacheEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerSAML1CacheTable" + "\" must implement the \"" + 
                           "SsoServerSAML1CacheEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerSAML1CacheEntryMBean entry = (SsoServerSAML1CacheEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerSAML1CacheEntryMeta node;
