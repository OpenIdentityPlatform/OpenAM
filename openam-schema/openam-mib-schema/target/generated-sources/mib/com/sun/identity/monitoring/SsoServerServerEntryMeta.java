 ...
 */
public class SsoServerServerEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerServerEntry".
     */
    public SsoServerServerEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 5:
                return new SnmpInt(node.getServerStatus());

            case 4:
                return new SnmpInt(node.getServerPort());

            case 3:
                return new SnmpString(node.getServerHostName());

            case 2:
                return new SnmpString(node.getServerProtocol());
     ...
     */
    protected void setInstance(SsoServerServerEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerServerEntryMBean node;
