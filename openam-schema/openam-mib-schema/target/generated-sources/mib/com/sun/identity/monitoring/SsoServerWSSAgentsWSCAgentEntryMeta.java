 ...
 */
public class SsoServerWSSAgentsWSCAgentEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsWSCAgentEntry".
     */
    public SsoServerWSSAgentsWSCAgentEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsWSCAgentSvcEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsWSCAgentProxy());

            case 2:
                return new SnmpString(node.getWssAgentsWSCAgentName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsWSCAgentEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsWSCAgentEntryMBean node;
