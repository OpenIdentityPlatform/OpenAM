 ...
 */
public class SsoServerLoggingHdlrTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerLoggingHdlrTableMeta".
     ...
     */
    public SsoServerLoggingHdlrTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerLoggingHdlrEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerLoggingHdlrTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerLoggingHdlrEntry" conceptual row (SsoServerLoggingHdlrEntryMeta)
     * 
     **/
    protected SsoServerLoggingHdlrEntryMeta createSsoServerLoggingHdlrEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerLoggingHdlrEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerLoggingHdlrEntryMetaNode("SsoServerLoggingHdlrEntry", "SsoServerLoggingHdlrTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerLoggingHdlrEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerLoggingHdlrTable" + "\" must implement the \"" + 
                           "SsoServerLoggingHdlrEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerLoggingHdlrEntryMBean entry = (SsoServerLoggingHdlrEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerLoggingHdlrEntryMeta node;
