 ...
 */
public class SsoServerFedEntitiesEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerFedEntitiesEntry".
     */
    public SsoServerFedEntitiesEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 5:
                return new SnmpString(node.getFedEntityType());

            case 4:
                return new SnmpString(node.getFedEntityLoc());

            case 3:
                return new SnmpString(node.getFedEntityProto());

            case 2:
                return new SnmpString(node.getFedEntityName());
     ...
     */
    protected void setInstance(SsoServerFedEntitiesEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerFedEntitiesEntryMBean node;
