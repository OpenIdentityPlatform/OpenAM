 ...
 */
public class SsoServerEntitlementPolicyStatsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerEntitlementPolicyStatsTableMeta".
     ...
     */
    public SsoServerEntitlementPolicyStatsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerEntitlementPolicyStatsEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerEntitlementPolicyStatsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerEntitlementPolicyStatsEntry" conceptual row (SsoServerEntitlementPolicyStatsEntryMeta)
     * 
     **/
    protected SsoServerEntitlementPolicyStatsEntryMeta createSsoServerEntitlementPolicyStatsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerEntitlementPolicyStatsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerEntitlementPolicyStatsEntryMetaNode("SsoServerEntitlementPolicyStatsEntry", "SsoServerEntitlementPolicyStatsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerEntitlementPolicyStatsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerEntitlementPolicyStatsTable" + "\" must implement the \"" + 
                           "SsoServerEntitlementPolicyStatsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerEntitlementPolicyStatsEntryMBean entry = (SsoServerEntitlementPolicyStatsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerEntitlementPolicyStatsEntryMeta node;
