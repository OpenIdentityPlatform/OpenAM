 ...
 */
public class SsoServerIDFFSvcMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerIDFFSvc".
     */
    public SsoServerIDFFSvcMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpCounter64(node.getIDFFIdLocalSessToken());

            case 5:
                return new SnmpCounter64(node.getIDFFIdAuthnRqt());

            case 4:
                return new SnmpCounter64(node.getIDFFUserIDSessionList());

            case 3:
                return new SnmpCounter64(node.getIDFFArtifacts());

            case 2:
                return new SnmpCounter64(node.getIDFFAssertions());

            case 1:
                return new SnmpString(node.getIDFFStatus());

            case 8:
                return new SnmpCounter64(node.getIDFFRelayState());

            case 7:
                return new SnmpCounter64(node.getIDFFIdDestn());
     ...
     */
    protected void setInstance(SsoServerIDFFSvcMBean var) {
        node = var;
    }
    ...
    protected SsoServerIDFFSvcMBean node;
