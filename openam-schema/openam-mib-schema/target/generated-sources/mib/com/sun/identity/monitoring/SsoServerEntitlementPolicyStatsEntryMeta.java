 ...
 */
public class SsoServerEntitlementPolicyStatsEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerEntitlementPolicyStatsEntry".
     */
    public SsoServerEntitlementPolicyStatsEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpInt(node.getEntitlementReferralCaches());

            case 3:
                return new SnmpInt(node.getEntitlementPolicyCaches());

            case 2:
                return new SnmpString(node.getEntitlementPolicyStatsRealmName());
     ...
     */
    protected void setInstance(SsoServerEntitlementPolicyStatsEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerEntitlementPolicyStatsEntryMBean node;
