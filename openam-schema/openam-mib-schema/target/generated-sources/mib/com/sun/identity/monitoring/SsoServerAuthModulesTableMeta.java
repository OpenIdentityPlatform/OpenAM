 ...
 */
public class SsoServerAuthModulesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerAuthModulesTableMeta".
     ...
     */
    public SsoServerAuthModulesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerAuthModulesEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerAuthModulesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerAuthModulesEntry" conceptual row (SsoServerAuthModulesEntryMeta)
     * 
     **/
    protected SsoServerAuthModulesEntryMeta createSsoServerAuthModulesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerAuthModulesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerAuthModulesEntryMetaNode("SsoServerAuthModulesEntry", "SsoServerAuthModulesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerAuthModulesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerAuthModulesTable" + "\" must implement the \"" + 
                           "SsoServerAuthModulesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerAuthModulesEntryMBean entry = (SsoServerAuthModulesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerAuthModulesEntryMeta node;
