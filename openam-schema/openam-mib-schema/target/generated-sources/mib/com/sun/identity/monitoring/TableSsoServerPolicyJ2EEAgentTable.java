 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.21.3.
 */
public class TableSsoServerPolicyJ2EEAgentTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerPolicyJ2EEAgentTable".
     ...
     */
    public TableSsoServerPolicyJ2EEAgentTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerPolicyJ2EEAgentTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerPolicyJ2EEAgentEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerPolicyJ2EEAgentEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerPolicyJ2EEAgentTable");
    }
    ...
    public synchronized void addEntry(SsoServerPolicyJ2EEAgentEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerPolicyJ2EEAgentEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerPolicyJ2EEAgentEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerPolicyJ2EEAgentEntryMBean[] result = new SsoServerPolicyJ2EEAgentEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerPolicyJ2EEAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPolicyJ2EEAgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyJ2EEAgentTable:name=com.sun.identity.monitoring.SsoServerPolicyJ2EEAgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",PolicyJ2EEAgentIndex=" + _keyPolicyJ2EEAgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerPolicyJ2EEAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getPolicyJ2EEAgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyJ2EEAgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aPolicyJ2EEAgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aPolicyJ2EEAgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerPolicyJ2EEAgentEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerPolicyJ2EEAgentEntryMBean"
     * interface.
    ...
    public Object createSsoServerPolicyJ2EEAgentEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aPolicyJ2EEAgentIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerPolicyJ2EEAgentEntry entry = new SsoServerPolicyJ2EEAgentEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.PolicyJ2EEAgentIndex = aPolicyJ2EEAgentIndex;
        return entry;
    }
