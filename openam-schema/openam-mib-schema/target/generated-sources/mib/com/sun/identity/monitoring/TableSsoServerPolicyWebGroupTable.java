 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.21.2.
 */
public class TableSsoServerPolicyWebGroupTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerPolicyWebGroupTable".
     ...
     */
    public TableSsoServerPolicyWebGroupTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerPolicyWebGroupTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerPolicyWebGroupEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerPolicyWebGroupEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerPolicyWebGroupTable");
    }
    ...
    public synchronized void addEntry(SsoServerPolicyWebGroupEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerPolicyWebGroupEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerPolicyWebGroupEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerPolicyWebGroupEntryMBean[] result = new SsoServerPolicyWebGroupEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerPolicyWebGroupEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyPolicyWebGroupIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyWebGroupTable:name=com.sun.identity.monitoring.SsoServerPolicyWebGroupEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",PolicyWebGroupIndex=" + _keyPolicyWebGroupIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerPolicyWebGroupEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getPolicyWebGroupIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyWebGroupEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aPolicyWebGroupIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aPolicyWebGroupIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerPolicyWebGroupEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerPolicyWebGroupEntryMBean"
     * interface.
    ...
    public Object createSsoServerPolicyWebGroupEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aPolicyWebGroupIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerPolicyWebGroupEntry entry = new SsoServerPolicyWebGroupEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.PolicyWebGroupIndex = aPolicyWebGroupIndex;
        return entry;
    }
