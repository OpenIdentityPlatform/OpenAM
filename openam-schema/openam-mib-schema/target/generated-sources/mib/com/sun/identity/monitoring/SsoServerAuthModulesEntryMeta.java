 ...
 */
public class SsoServerAuthModulesEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerAuthModulesEntry".
     */
    public SsoServerAuthModulesEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 5:
                return new SnmpCounter64(node.getAuthModuleFailureCount());

            case 4:
                return new SnmpCounter64(node.getAuthModuleSuccessCount());

            case 3:
                return new SnmpString(node.getAuthModuleType());

            case 2:
                return new SnmpString(node.getAuthModuleName());
     ...
     */
    protected void setInstance(SsoServerAuthModulesEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerAuthModulesEntryMBean node;
