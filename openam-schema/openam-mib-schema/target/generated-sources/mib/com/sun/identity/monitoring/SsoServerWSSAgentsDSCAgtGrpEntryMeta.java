 ...
 */
public class SsoServerWSSAgentsDSCAgtGrpEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsDSCAgtGrpEntry".
     */
    public SsoServerWSSAgentsDSCAgtGrpEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsDSCAgtGrpWebSvcEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsDSCAgtGrpSvcEndPoint());

            case 2:
                return new SnmpString(node.getWssAgentsDSCAgtGrpName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsDSCAgtGrpEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsDSCAgtGrpEntryMBean node;
