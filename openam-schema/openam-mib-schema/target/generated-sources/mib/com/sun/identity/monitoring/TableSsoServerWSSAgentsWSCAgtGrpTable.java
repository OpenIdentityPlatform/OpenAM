 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.22.2.
 */
public class TableSsoServerWSSAgentsWSCAgtGrpTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerWSSAgentsWSCAgtGrpTable".
     ...
     */
    public TableSsoServerWSSAgentsWSCAgtGrpTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerWSSAgentsWSCAgtGrpTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerWSSAgentsWSCAgtGrpEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerWSSAgentsWSCAgtGrpEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerWSSAgentsWSCAgtGrpTable");
    }
    ...
    public synchronized void addEntry(SsoServerWSSAgentsWSCAgtGrpEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerWSSAgentsWSCAgtGrpEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerWSSAgentsWSCAgtGrpEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerWSSAgentsWSCAgtGrpEntryMBean[] result = new SsoServerWSSAgentsWSCAgtGrpEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerWSSAgentsWSCAgtGrpEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyWssAgentsWSCAgtGrpIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerWSSAgentsWSCAgtGrpTable:name=com.sun.identity.monitoring.SsoServerWSSAgentsWSCAgtGrpEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",WssAgentsWSCAgtGrpIndex=" + _keyWssAgentsWSCAgtGrpIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerWSSAgentsWSCAgtGrpEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getWssAgentsWSCAgtGrpIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerWSSAgentsWSCAgtGrpEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aWssAgentsWSCAgtGrpIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aWssAgentsWSCAgtGrpIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerWSSAgentsWSCAgtGrpEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerWSSAgentsWSCAgtGrpEntryMBean"
     * interface.
    ...
    public Object createSsoServerWSSAgentsWSCAgtGrpEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aWssAgentsWSCAgtGrpIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerWSSAgentsWSCAgtGrpEntry entry = new SsoServerWSSAgentsWSCAgtGrpEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.WssAgentsWSCAgtGrpIndex = aWssAgentsWSCAgtGrpIndex;
        return entry;
    }
