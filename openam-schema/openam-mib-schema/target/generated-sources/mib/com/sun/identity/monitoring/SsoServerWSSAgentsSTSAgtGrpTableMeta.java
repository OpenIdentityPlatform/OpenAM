 ...
 */
public class SsoServerWSSAgentsSTSAgtGrpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsSTSAgtGrpTableMeta".
     ...
     */
    public SsoServerWSSAgentsSTSAgtGrpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsSTSAgtGrpEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsSTSAgtGrpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsSTSAgtGrpEntry" conceptual row (SsoServerWSSAgentsSTSAgtGrpEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsSTSAgtGrpEntryMeta createSsoServerWSSAgentsSTSAgtGrpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsSTSAgtGrpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsSTSAgtGrpEntryMetaNode("SsoServerWSSAgentsSTSAgtGrpEntry", "SsoServerWSSAgentsSTSAgtGrpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsSTSAgtGrpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsSTSAgtGrpTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsSTSAgtGrpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsSTSAgtGrpEntryMBean entry = (SsoServerWSSAgentsSTSAgtGrpEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsSTSAgtGrpEntryMeta node;
