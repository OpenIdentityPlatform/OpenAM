 ...
 */
public class SsoServerPolicyJ2EEGroupEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerPolicyJ2EEGroupEntry".
     */
    public SsoServerPolicyJ2EEGroupEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpString(node.getPolicyJ2EEGroupServerURL());

            case 2:
                return new SnmpString(node.getPolicyJ2EEGroupName());
     ...
     */
    protected void setInstance(SsoServerPolicyJ2EEGroupEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerPolicyJ2EEGroupEntryMBean node;
