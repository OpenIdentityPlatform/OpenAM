...
public class TableSsoServerWSSAgentsDSCAgentTable extends SnmpTableSupport implements Serializable {
    ...
    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerWSSAgentsDSCAgentTable".
     ...
     */
    public TableSsoServerWSSAgentsDSCAgentTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerWSSAgentsDSCAgentTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerWSSAgentsDSCAgentEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerWSSAgentsDSCAgentEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerWSSAgentsDSCAgentTable");
    }
    ...
    public synchronized void addEntry(SsoServerWSSAgentsDSCAgentEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerWSSAgentsDSCAgentEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerWSSAgentsDSCAgentEntryMBean[] getEntries() {
        ...
        SsoServerWSSAgentsDSCAgentEntryMBean[] result = new SsoServerWSSAgentsDSCAgentEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerWSSAgentsDSCAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyWssAgentsDSCAgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerWSSAgentsDSCAgentTable:name=com.sun.identity.monitoring.SsoServerWSSAgentsDSCAgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",WssAgentsDSCAgentIndex=" + _keyWssAgentsDSCAgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerWSSAgentsDSCAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getWssAgentsDSCAgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerWSSAgentsDSCAgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aWssAgentsDSCAgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aWssAgentsDSCAgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerWSSAgentsDSCAgentEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerWSSAgentsDSCAgentEntryMBean"
     * interface.
    ...
    public Object createSsoServerWSSAgentsDSCAgentEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aWssAgentsDSCAgentIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerWSSAgentsDSCAgentEntry entry = new SsoServerWSSAgentsDSCAgentEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.WssAgentsDSCAgentIndex = aWssAgentsDSCAgentIndex;
        return entry;
    }
