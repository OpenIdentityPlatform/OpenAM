 ...
 */
public class SsoServerWSSAgentsWSCAgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsWSCAgentTableMeta".
     ...
     */
    public SsoServerWSSAgentsWSCAgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsWSCAgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsWSCAgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsWSCAgentEntry" conceptual row (SsoServerWSSAgentsWSCAgentEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsWSCAgentEntryMeta createSsoServerWSSAgentsWSCAgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsWSCAgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsWSCAgentEntryMetaNode("SsoServerWSSAgentsWSCAgentEntry", "SsoServerWSSAgentsWSCAgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsWSCAgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsWSCAgentTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsWSCAgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsWSCAgentEntryMBean entry = (SsoServerWSSAgentsWSCAgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsWSCAgentEntryMeta node;
