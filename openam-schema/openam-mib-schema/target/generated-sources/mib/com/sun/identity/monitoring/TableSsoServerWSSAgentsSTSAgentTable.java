 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.22.5.
 */
public class TableSsoServerWSSAgentsSTSAgentTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerWSSAgentsSTSAgentTable".
     ...
     */
    public TableSsoServerWSSAgentsSTSAgentTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerWSSAgentsSTSAgentTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerWSSAgentsSTSAgentEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerWSSAgentsSTSAgentEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerWSSAgentsSTSAgentTable");
    }
    ...
    public synchronized void addEntry(SsoServerWSSAgentsSTSAgentEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerWSSAgentsSTSAgentEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerWSSAgentsSTSAgentEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerWSSAgentsSTSAgentEntryMBean[] result = new SsoServerWSSAgentsSTSAgentEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerWSSAgentsSTSAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyWssAgentsSTSAgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerWSSAgentsSTSAgentTable:name=com.sun.identity.monitoring.SsoServerWSSAgentsSTSAgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",WssAgentsSTSAgentIndex=" + _keyWssAgentsSTSAgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerWSSAgentsSTSAgentEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getWssAgentsSTSAgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerWSSAgentsSTSAgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aWssAgentsSTSAgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aWssAgentsSTSAgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerWSSAgentsSTSAgentEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerWSSAgentsSTSAgentEntryMBean"
     * interface.
    ...
    public Object createSsoServerWSSAgentsSTSAgentEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aWssAgentsSTSAgentIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerWSSAgentsSTSAgentEntry entry = new SsoServerWSSAgentsSTSAgentEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.WssAgentsSTSAgentIndex = aWssAgentsSTSAgentIndex;
        return entry;
    }
