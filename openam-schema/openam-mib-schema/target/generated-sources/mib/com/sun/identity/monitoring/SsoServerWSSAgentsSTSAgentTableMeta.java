 ...
 */
public class SsoServerWSSAgentsSTSAgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsSTSAgentTableMeta".
     ...
     */
    public SsoServerWSSAgentsSTSAgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsSTSAgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsSTSAgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsSTSAgentEntry" conceptual row (SsoServerWSSAgentsSTSAgentEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsSTSAgentEntryMeta createSsoServerWSSAgentsSTSAgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsSTSAgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsSTSAgentEntryMetaNode("SsoServerWSSAgentsSTSAgentEntry", "SsoServerWSSAgentsSTSAgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsSTSAgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsSTSAgentTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsSTSAgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsSTSAgentEntryMBean entry = (SsoServerWSSAgentsSTSAgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsSTSAgentEntryMeta node;
