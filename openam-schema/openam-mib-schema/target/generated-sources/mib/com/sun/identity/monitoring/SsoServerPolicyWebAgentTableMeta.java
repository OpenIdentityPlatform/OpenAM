 ...
 */
public class SsoServerPolicyWebAgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerPolicyWebAgentTableMeta".
     ...
     */
    public SsoServerPolicyWebAgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerPolicyWebAgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerPolicyWebAgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerPolicyWebAgentEntry" conceptual row (SsoServerPolicyWebAgentEntryMeta)
     * 
     **/
    protected SsoServerPolicyWebAgentEntryMeta createSsoServerPolicyWebAgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerPolicyWebAgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerPolicyWebAgentEntryMetaNode("SsoServerPolicyWebAgentEntry", "SsoServerPolicyWebAgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerPolicyWebAgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerPolicyWebAgentTable" + "\" must implement the \"" + 
                           "SsoServerPolicyWebAgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerPolicyWebAgentEntryMBean entry = (SsoServerPolicyWebAgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerPolicyWebAgentEntryMeta node;
