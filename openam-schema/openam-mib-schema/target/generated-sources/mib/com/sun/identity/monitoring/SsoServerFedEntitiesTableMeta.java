 ...
 */
public class SsoServerFedEntitiesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerFedEntitiesTableMeta".
     ...
     */
    public SsoServerFedEntitiesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerFedEntitiesEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerFedEntitiesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerFedEntitiesEntry" conceptual row (SsoServerFedEntitiesEntryMeta)
     * 
     **/
    protected SsoServerFedEntitiesEntryMeta createSsoServerFedEntitiesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerFedEntitiesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerFedEntitiesEntryMetaNode("SsoServerFedEntitiesEntry", "SsoServerFedEntitiesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerFedEntitiesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerFedEntitiesTable" + "\" must implement the \"" + 
                           "SsoServerFedEntitiesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerFedEntitiesEntryMBean entry = (SsoServerFedEntitiesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerFedEntitiesEntryMeta node;
