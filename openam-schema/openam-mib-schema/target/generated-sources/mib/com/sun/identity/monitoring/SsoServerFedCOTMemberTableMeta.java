 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.18.2.
 */
public class SsoServerFedCOTMemberTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerFedCOTMemberTableMeta".
     ...
     */
    public SsoServerFedCOTMemberTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerFedCOTMemberEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerFedCOTMemberTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerFedCOTMemberEntry" conceptual row (SsoServerFedCOTMemberEntryMeta)
     * 
     **/
    protected SsoServerFedCOTMemberEntryMeta createSsoServerFedCOTMemberEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerFedCOTMemberEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerFedCOTMemberEntryMetaNode("SsoServerFedCOTMemberEntry", "SsoServerFedCOTMemberTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerFedCOTMemberEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerFedCOTMemberTable" + "\" must implement the \"" + 
                           "SsoServerFedCOTMemberEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerFedCOTMemberEntryMBean entry = (SsoServerFedCOTMemberEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerFedCOTMemberEntryMeta node;
