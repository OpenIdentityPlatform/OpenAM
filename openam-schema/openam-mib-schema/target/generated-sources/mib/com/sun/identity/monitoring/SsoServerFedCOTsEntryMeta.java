 ...
 */
public class SsoServerFedCOTsEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerFedCOTsEntry".
     */
    public SsoServerFedCOTsEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 2:
                return new SnmpString(node.getFedCOTName());
     ...
     */
    protected void setInstance(SsoServerFedCOTsEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerFedCOTsEntryMBean node;
