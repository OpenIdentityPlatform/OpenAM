 ...
 */
public class SsoServerSAML1TrustPrtnrsEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerSAML1TrustPrtnrsEntry".
     */
    public SsoServerSAML1TrustPrtnrsEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 2:
                return new SnmpString(node.getSAML1TrustPrtnrName());
     ...
     */
    protected void setInstance(SsoServerSAML1TrustPrtnrsEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerSAML1TrustPrtnrsEntryMBean node;
