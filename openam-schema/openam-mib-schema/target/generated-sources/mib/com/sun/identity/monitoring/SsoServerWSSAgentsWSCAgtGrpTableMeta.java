 ...
 */
public class SsoServerWSSAgentsWSCAgtGrpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsWSCAgtGrpTableMeta".
     ...
     */
    public SsoServerWSSAgentsWSCAgtGrpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsWSCAgtGrpEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsWSCAgtGrpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsWSCAgtGrpEntry" conceptual row (SsoServerWSSAgentsWSCAgtGrpEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsWSCAgtGrpEntryMeta createSsoServerWSSAgentsWSCAgtGrpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsWSCAgtGrpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsWSCAgtGrpEntryMetaNode("SsoServerWSSAgentsWSCAgtGrpEntry", "SsoServerWSSAgentsWSCAgtGrpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsWSCAgtGrpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsWSCAgtGrpTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsWSCAgtGrpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsWSCAgtGrpEntryMBean entry = (SsoServerWSSAgentsWSCAgtGrpEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsWSCAgtGrpEntryMeta node;
