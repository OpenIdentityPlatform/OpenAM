 ...
 */
public class SsoServerSAML2SPEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerSAML2SPEntry".
     */
    public SsoServerSAML2SPEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 5:
                return new SnmpCounter64(node.getSAML2SPInvalidArtifactsRcvd());

            case 4:
                return new SnmpCounter64(node.getSAML2SPValidAssertionsRcvd());

            case 3:
                return new SnmpCounter64(node.getSAML2SPRqtsSent());

            case 2:
                return new SnmpString(node.getSAML2SPName());
     ...
     */
    protected void setInstance(SsoServerSAML2SPEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerSAML2SPEntryMBean node;
