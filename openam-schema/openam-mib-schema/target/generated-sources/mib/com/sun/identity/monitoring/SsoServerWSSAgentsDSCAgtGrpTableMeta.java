 ...
 */
public class SsoServerWSSAgentsDSCAgtGrpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsDSCAgtGrpTableMeta".
     ...
     */
    public SsoServerWSSAgentsDSCAgtGrpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsDSCAgtGrpEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsDSCAgtGrpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsDSCAgtGrpEntry" conceptual row (SsoServerWSSAgentsDSCAgtGrpEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsDSCAgtGrpEntryMeta createSsoServerWSSAgentsDSCAgtGrpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsDSCAgtGrpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsDSCAgtGrpEntryMetaNode("SsoServerWSSAgentsDSCAgtGrpEntry", "SsoServerWSSAgentsDSCAgtGrpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsDSCAgtGrpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsDSCAgtGrpTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsDSCAgtGrpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsDSCAgtGrpEntryMBean entry = (SsoServerWSSAgentsDSCAgtGrpEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsDSCAgtGrpEntryMeta node;
