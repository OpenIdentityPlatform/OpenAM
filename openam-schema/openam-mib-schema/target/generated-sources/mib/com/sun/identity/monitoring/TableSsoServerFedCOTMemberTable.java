 ...
 */
public class TableSsoServerFedCOTMemberTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerFedCOTMemberTable".
     ...
     */
    public TableSsoServerFedCOTMemberTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerFedCOTMemberTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerFedCOTMemberEntryMBean"
            // interface.
            //
            final Object entry =
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerFedCOTMemberTable");
    }
    ...
    public synchronized void addEntry(SsoServerFedCOTMemberEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerFedCOTMemberEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerFedCOTMemberEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerFedCOTMemberEntryMBean[] result = new SsoServerFedCOTMemberEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerFedCOTMemberEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
     ...
     *         "SsoServerFedCOTMemberEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerFedCOTMemberEntryMBean"
     * interface.
