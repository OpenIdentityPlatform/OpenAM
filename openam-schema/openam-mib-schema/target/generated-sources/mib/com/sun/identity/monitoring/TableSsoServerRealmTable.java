 ...
 */
public class TableSsoServerRealmTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerRealmTable".
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerRealmEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerRealmEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger());
            if (server != null) {
    ...
    public synchronized void addEntry(SsoServerRealmEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerRealmEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public void removeEntry(SsoServerRealmEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerRealmEntryMBean entry)
        throws SnmpStatusException {
     ...
     * Build index for "SsoServerRealmEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
     ...
     *         "SsoServerRealmEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerRealmEntryMBean"
     * interface.
    ...
    public Object createSsoServerRealmEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerRealmEntry entry = new SsoServerRealmEntry(theMib);
