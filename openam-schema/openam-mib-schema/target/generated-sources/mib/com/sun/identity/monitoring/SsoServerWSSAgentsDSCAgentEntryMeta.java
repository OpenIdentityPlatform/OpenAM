 ...
 */
public class SsoServerWSSAgentsDSCAgentEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsDSCAgentEntry".
     */
    public SsoServerWSSAgentsDSCAgentEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsDSCAgentWebSvcEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsDSCAgentSvcEndPoint());

            case 2:
                return new SnmpString(node.getWssAgentsDSCAgentName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsDSCAgentEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsDSCAgentEntryMBean node;
