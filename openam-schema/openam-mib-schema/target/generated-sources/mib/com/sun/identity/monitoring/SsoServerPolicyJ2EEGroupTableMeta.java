 ...
 */
public class SsoServerPolicyJ2EEGroupTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerPolicyJ2EEGroupTableMeta".
     ...
     */
    public SsoServerPolicyJ2EEGroupTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerPolicyJ2EEGroupEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerPolicyJ2EEGroupTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerPolicyJ2EEGroupEntry" conceptual row (SsoServerPolicyJ2EEGroupEntryMeta)
     * 
     **/
    protected SsoServerPolicyJ2EEGroupEntryMeta createSsoServerPolicyJ2EEGroupEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerPolicyJ2EEGroupEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerPolicyJ2EEGroupEntryMetaNode("SsoServerPolicyJ2EEGroupEntry", "SsoServerPolicyJ2EEGroupTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerPolicyJ2EEGroupEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerPolicyJ2EEGroupTable" + "\" must implement the \"" + 
                           "SsoServerPolicyJ2EEGroupEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerPolicyJ2EEGroupEntryMBean entry = (SsoServerPolicyJ2EEGroupEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerPolicyJ2EEGroupEntryMeta node;
