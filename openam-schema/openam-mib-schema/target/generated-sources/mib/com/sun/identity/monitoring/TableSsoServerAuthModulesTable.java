 ...
 * The group is defined with the following oid: 1.3.6.1.4.1.42.2.230.3.1.1.2.1.10.5.
 */
public class TableSsoServerAuthModulesTable extends SnmpTableSupport implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "TableSsoServerAuthModulesTable".
     ...
     */
    public TableSsoServerAuthModulesTable(SnmpMib myMib) {
        super(myMib);
    }
     ...
     */
    public TableSsoServerAuthModulesTable(SnmpMib myMib, MBeanServer server) {
        this(myMib);
        this.server = server;
    }
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid,
        ...
        try  {
            ...
            // the returned object must implement the "SsoServerAuthModulesEntryMBean"
            // interface.
            //
            final Object entry =
                 createSsoServerAuthModulesEntryMBean(req, rowOid, depth, objname, meta,
                    oid0.toInteger(),
                    oid1.toInteger());
            if (server != null) {
    ...
    protected SnmpMibTable getRegisteredTableMeta(SnmpMib mib)  {
        return mib.getRegisteredTableMeta("SsoServerAuthModulesTable");
    }
    ...
    public synchronized void addEntry(SsoServerAuthModulesEntryMBean entry)
        throws SnmpStatusException {
    ...
    public synchronized void addEntry(SsoServerAuthModulesEntryMBean entry, ObjectName name)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public synchronized SsoServerAuthModulesEntryMBean[] getEntries() {
        Object[] array = getBasicEntries();
        SsoServerAuthModulesEntryMBean[] result = new SsoServerAuthModulesEntryMBean[array.length];
    ...
    public void removeEntry(SsoServerAuthModulesEntryMBean entry)
        throws SnmpStatusException {
        SnmpIndex index = buildSnmpIndex(entry);
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keyAuthModuleIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerAuthModulesTable:name=com.sun.identity.monitoring.SsoServerAuthModulesEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",AuthModuleIndex=" + _keyAuthModuleIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
     ...
     */
    public SnmpIndex buildSnmpIndex(SsoServerAuthModulesEntryMBean entry)
        throws SnmpStatusException {
        SnmpOid[] oids = new SnmpOid[2];
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerRealmIndex());
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getAuthModuleIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerAuthModulesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aAuthModuleIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aAuthModuleIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
     ...
     *         "SsoServerAuthModulesEntry" conceptual row.
     * 
     * Note that when using standard metadata,
     * the returned object must implement the "SsoServerAuthModulesEntryMBean"
     * interface.
    ...
    public Object createSsoServerAuthModulesEntryMBean(SnmpMibSubRequest req,
                SnmpOid rowOid, int depth, ObjectName entryObjName,
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aAuthModuleIndex)
            throws SnmpStatusException  {
        ...
        // interface.
        //
        SsoServerAuthModulesEntry entry = new SsoServerAuthModulesEntry(theMib);
        entry.SsoServerRealmIndex = aSsoServerRealmIndex;
        entry.AuthModuleIndex = aAuthModuleIndex;
        return entry;
    }
