 ...
 */
public class SsoServerSitesTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerSitesTableMeta".
     ...
     */
    public SsoServerSitesTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerSitesEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerSitesTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerSitesEntry" conceptual row (SsoServerSitesEntryMeta)
     * 
     **/
    protected SsoServerSitesEntryMeta createSsoServerSitesEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerSitesEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerSitesEntryMetaNode("SsoServerSitesEntry", "SsoServerSitesTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerSitesEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerSitesTable" + "\" must implement the \"" + 
                           "SsoServerSitesEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerSitesEntryMBean entry = (SsoServerSitesEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerSitesEntryMeta node;
