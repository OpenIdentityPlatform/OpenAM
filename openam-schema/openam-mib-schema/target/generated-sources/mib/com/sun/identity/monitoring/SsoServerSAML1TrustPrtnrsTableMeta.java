 ...
 */
public class SsoServerSAML1TrustPrtnrsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerSAML1TrustPrtnrsTableMeta".
     ...
     */
    public SsoServerSAML1TrustPrtnrsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerSAML1TrustPrtnrsEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerSAML1TrustPrtnrsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerSAML1TrustPrtnrsEntry" conceptual row (SsoServerSAML1TrustPrtnrsEntryMeta)
     * 
     **/
    protected SsoServerSAML1TrustPrtnrsEntryMeta createSsoServerSAML1TrustPrtnrsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerSAML1TrustPrtnrsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerSAML1TrustPrtnrsEntryMetaNode("SsoServerSAML1TrustPrtnrsEntry", "SsoServerSAML1TrustPrtnrsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerSAML1TrustPrtnrsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerSAML1TrustPrtnrsTable" + "\" must implement the \"" + 
                           "SsoServerSAML1TrustPrtnrsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerSAML1TrustPrtnrsEntryMBean entry = (SsoServerSAML1TrustPrtnrsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerSAML1TrustPrtnrsEntryMeta node;
