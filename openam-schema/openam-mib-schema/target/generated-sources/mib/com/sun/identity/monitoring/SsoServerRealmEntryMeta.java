 ...
 */
public class SsoServerRealmEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerRealmEntry".
     */
    public SsoServerRealmEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 2:
                return new SnmpString(node.getSsoServerRealmName());
     ...
     */
    protected void setInstance(SsoServerRealmEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerRealmEntryMBean node;
