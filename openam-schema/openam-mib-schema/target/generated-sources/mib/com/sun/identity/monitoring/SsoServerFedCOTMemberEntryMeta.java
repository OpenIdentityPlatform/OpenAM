 ...
 */
public class SsoServerFedCOTMemberEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerFedCOTMemberEntry".
     */
    public SsoServerFedCOTMemberEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpString(node.getFedCOTMemberType());

            case 2:
                return new SnmpString(node.getFedCOTMemberName());
     ...
     */
    protected void setInstance(SsoServerFedCOTMemberEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerFedCOTMemberEntryMBean node;
