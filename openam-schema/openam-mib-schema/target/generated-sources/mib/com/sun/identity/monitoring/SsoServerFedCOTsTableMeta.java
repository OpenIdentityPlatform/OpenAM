 ...
 */
public class SsoServerFedCOTsTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerFedCOTsTableMeta".
     ...
     */
    public SsoServerFedCOTsTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerFedCOTsEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerFedCOTsTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerFedCOTsEntry" conceptual row (SsoServerFedCOTsEntryMeta)
     * 
     **/
    protected SsoServerFedCOTsEntryMeta createSsoServerFedCOTsEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerFedCOTsEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerFedCOTsEntryMetaNode("SsoServerFedCOTsEntry", "SsoServerFedCOTsTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerFedCOTsEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerFedCOTsTable" + "\" must implement the \"" + 
                           "SsoServerFedCOTsEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerFedCOTsEntryMBean entry = (SsoServerFedCOTsEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerFedCOTsEntryMeta node;
