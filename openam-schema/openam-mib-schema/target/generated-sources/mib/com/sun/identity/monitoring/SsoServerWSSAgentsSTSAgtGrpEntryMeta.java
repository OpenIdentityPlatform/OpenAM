 ...
 */
public class SsoServerWSSAgentsSTSAgtGrpEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerWSSAgentsSTSAgtGrpEntry".
     */
    public SsoServerWSSAgentsSTSAgtGrpEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 4:
                return new SnmpString(node.getWssAgentsSTSAgtGrpSvcMEXEndPoint());

            case 3:
                return new SnmpString(node.getWssAgentsSTSAgtGrpSvcEndPoint());

            case 2:
                return new SnmpString(node.getWssAgentsSTSAgtGrpName());
     ...
     */
    protected void setInstance(SsoServerWSSAgentsSTSAgtGrpEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerWSSAgentsSTSAgtGrpEntryMBean node;
