 ...
 */
public class SsoServerPolicy22AgentEntryMeta extends SnmpMibEntry
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerPolicy22AgentEntry".
     */
    public SsoServerPolicy22AgentEntryMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 2:
                return new SnmpString(node.getPolicy22AgentName());
     ...
     */
    protected void setInstance(SsoServerPolicy22AgentEntryMBean var) {
        node = var;
    }
    ...
    protected SsoServerPolicy22AgentEntryMBean node;
