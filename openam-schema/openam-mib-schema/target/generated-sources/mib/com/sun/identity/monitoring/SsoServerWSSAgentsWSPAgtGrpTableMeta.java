 ...
 */
public class SsoServerWSSAgentsWSPAgtGrpTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerWSSAgentsWSPAgtGrpTableMeta".
     ...
     */
    public SsoServerWSSAgentsWSPAgtGrpTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerWSSAgentsWSPAgtGrpEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerWSSAgentsWSPAgtGrpTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerWSSAgentsWSPAgtGrpEntry" conceptual row (SsoServerWSSAgentsWSPAgtGrpEntryMeta)
     * 
     **/
    protected SsoServerWSSAgentsWSPAgtGrpEntryMeta createSsoServerWSSAgentsWSPAgtGrpEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerWSSAgentsWSPAgtGrpEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerWSSAgentsWSPAgtGrpEntryMetaNode("SsoServerWSSAgentsWSPAgtGrpEntry", "SsoServerWSSAgentsWSPAgtGrpTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerWSSAgentsWSPAgtGrpEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerWSSAgentsWSPAgtGrpTable" + "\" must implement the \"" + 
                           "SsoServerWSSAgentsWSPAgtGrpEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerWSSAgentsWSPAgtGrpEntryMBean entry = (SsoServerWSSAgentsWSPAgtGrpEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerWSSAgentsWSPAgtGrpEntryMeta node;
