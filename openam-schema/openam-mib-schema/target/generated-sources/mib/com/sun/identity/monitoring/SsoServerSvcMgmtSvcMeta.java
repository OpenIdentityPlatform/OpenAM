 ...
 */
public class SsoServerSvcMgmtSvcMeta extends SnmpMibGroup
     implements Serializable, SnmpStandardMetaServer {

    /**
     * Constructor for the metadata associated to "SsoServerSvcMgmtSvc".
     */
    public SsoServerSvcMgmtSvcMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpString(node.getSvcMgmtRepositorySSL());

            case 5:
                return new SnmpString(node.getSvcMgmtRepositoryOrgDN());

            case 4:
                return new SnmpString(node.getSvcMgmtRepositoryBindDN());

            case 3:
                return new SnmpString(node.getSvcMgmtRepositoryHostPort());

            case 2:
                return new SnmpString(node.getSvcMgmtRepositoryType());

            case 1:
                return new SnmpString(node.getSvcMgmtStatus());
     ...
     */
    protected void setInstance(SsoServerSvcMgmtSvcMBean var) {
        node = var;
    }
    ...
    protected SsoServerSvcMgmtSvcMBean node;
