 ...
 */
public class SsoServerPolicy22AgentTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerPolicy22AgentTableMeta".
     ...
     */
    public SsoServerPolicy22AgentTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerPolicy22AgentEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerPolicy22AgentTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerPolicy22AgentEntry" conceptual row (SsoServerPolicy22AgentEntryMeta)
     * 
     **/
    protected SsoServerPolicy22AgentEntryMeta createSsoServerPolicy22AgentEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerPolicy22AgentEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerPolicy22AgentEntryMetaNode("SsoServerPolicy22AgentEntry", "SsoServerPolicy22AgentTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerPolicy22AgentEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerPolicy22AgentTable" + "\" must implement the \"" + 
                           "SsoServerPolicy22AgentEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerPolicy22AgentEntryMBean entry = (SsoServerPolicy22AgentEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerPolicy22AgentEntryMeta node;
