 ...
 */
public class SsoServerSAML1EndPointTableMeta extends SnmpMibTable implements Serializable {

    /**
     * Constructor for the table. Initialize metadata for "SsoServerSAML1EndPointTableMeta".
     ...
     */
    public SsoServerSAML1EndPointTableMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib);
     ...
     * 
     * @param snmpEntryName Name of the SNMP Entry object (conceptual row) ("SsoServerSAML1EndPointEntry")
     * @param tableName Name of the table in which the entries are registered ("SsoServerSAML1EndPointTable")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "SsoServerSAML1EndPointEntry" conceptual row (SsoServerSAML1EndPointEntryMeta)
     * 
     **/
    protected SsoServerSAML1EndPointEntryMeta createSsoServerSAML1EndPointEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib, MBeanServer server)  {
        return new SsoServerSAML1EndPointEntryMeta(mib, objectserver);
    }
    ...
    public void registerEntryNode(SnmpMib mib, MBeanServer server)  {
        node = createSsoServerSAML1EndPointEntryMetaNode("SsoServerSAML1EndPointEntry", "SsoServerSAML1EndPointTable", mib, server);
    }
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname,
                 Object entry)
        throws SnmpStatusException {
        if (! (entry instanceof SsoServerSAML1EndPointEntryMBean) )
            throw new ClassCastException("Entries for Table \"" + 
                           "SsoServerSAML1EndPointTable" + "\" must implement the \"" + 
                           "SsoServerSAML1EndPointEntryMBean" + "\" interface.");
    ...
    public void get(SnmpMibSubRequest req, SnmpOid rowOid, int depth)
        throws SnmpStatusException {
        SsoServerSAML1EndPointEntryMBean entry = (SsoServerSAML1EndPointEntryMBean) getEntry(rowOid);
        synchronized (this) {
     ...
     */
    private SsoServerSAML1EndPointEntryMeta node;
