...
public class X509DataType {
    ...
    /**
     * Compatibility shim for JAXB 1.x X509Certificate element.
     * In JAXB 4.x XJC, X509Certificate is handled via JAXBElement factory methods.
     * This inner class provides JAXB 1.x source-level compatibility.
     */
    @jakarta.xml.bind.annotation.XmlRootElement(name = "X509Certificate", namespace = "http://www.w3.org/2000/09/xmldsig#")
