...
public class ObjectFactory {
    ...
    public X509DataElement createX509DataElement() { return new X509DataElement(); }

    /** No-arg override of the XJC method; creates an X509DataType.X509Certificate inner-class shim. */
