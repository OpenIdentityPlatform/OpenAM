...
[NOTE]
====
OpenAM 13.0.0 introduces a new Audit Logging Service, which is an audit logging framework common across all Open Identity Platform products. Both logging services are available in OpenAM 13.5.2-15, but the classic Logging Service will be deprecated in a future release.
====
