...
* xref:#fr-authenticator-oath-service-configuration["ForgeRock Authenticator (OATH) Service"]

* xref:#fr-authenticator-push-service-configuration["ForgeRock Authenticator (Push) Service"]
...
[#fr-authenticator-oath-service-configuration]
