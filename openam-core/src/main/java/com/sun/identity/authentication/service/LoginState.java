...
public class LoginState {
    ...
    private static Set<String> SHARED_STATE_ATTRIBUTES = new HashSet<String>();
    ...
    static {
        ...
        SHARED_STATE_ATTRIBUTES.add( ISAuthConstants.SHARED_STATE_USERNAME);
        SHARED_STATE_ATTRIBUTES.add( ISAuthConstants.SHARED_STATE_PASSWORD);
     ...
     * List of principals.
     */
    private StringBuffer principalState = new StringBuffer();
    ...
    /**
     * Save the principalList that is generated by succesful authenticationto the requestMap.
     */
    public void saveSubjectState() {
        if (principalList != null) {
            requestMap.put(ISAuthConstants.PRINCIPALS, principalList);
        }
    }

    /**
     * Saves the principals currently presenent in the authentication chain. This is differnt from the principal list
     * that is generated by the complete logincontext as these are only generated when all modules have been completed.
     * 
     * @param principalName
     */
    public void savePrincipalState(String principalName) {
        if (!containsToken(principalState, principalName)) {
            if (principalState.length() > 0){
                principalState.append("|");
            }
            principalState.append(principalName);
            // store in the requestmap
            requestMap.put(ISAuthConstants.PRINCIPALSTATE, principalState.toString());
        }
    }
