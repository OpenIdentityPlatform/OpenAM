    ...
    public void perform() throws UpgradeException {
        try {
            ...
            for (Entry<String, String> serverProperty : propertiesToModify.entrySet()) {
                ...
                Map<String, String> newValues = new HashMap<String, String>(1);
                newValues.put(CoreTokenConstants.CTS_STORE_HOSTNAME, serverProperty.getValue());
                // add new values to existing values
                existingServerProperties.putAll(newValues);
