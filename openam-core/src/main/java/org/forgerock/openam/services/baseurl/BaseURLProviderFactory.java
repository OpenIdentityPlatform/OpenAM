...
public class BaseURLProviderFactory {
    ...
    private final class SettingsChangeListener implements ServiceListener {
        ...
        public void schemaChanged(String serviceName, String version) {
            debug.warning("The schemaChanged ServiceListener method was invoked for service " + serviceName
                    + ". This is unexpected.");
        }
        ...
        public void organizationConfigChanged(String serviceName, String version, String orgName, String groupName,
            ...
            switch(type) {
                ...
                case ServiceListener.MODIFIED:
                    debug.message("BaseURLProviderFactory: Removing stale service configuration state for realm "
                            + orgName);
