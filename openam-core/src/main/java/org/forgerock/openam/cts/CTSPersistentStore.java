...
public interface CTSPersistentStore {
     ...
     * has failed.
     * @throws org.forgerock.openam.cts.exceptions.QueueTimeoutException If the asynchronous operation couldn't be
    ...
    /**
     * Delete a collection of Tokens from the Token Store synchronously using a filter to narrow down the Tokens to be
     * deleted.
     *
     ...
     * @throws org.forgerock.openam.cts.exceptions.QueueTimeoutException If the asynchronous operations couldn't be
     * scheduled for later execution.
     */
    ...
    /**
     * Performs a specialised synchronous Query whereby PartialTokens are returned. This is an optimisation which allows
     * the caller to specify just the fields that are being returned.
     *
     * As stated in the PartialToken class, this is not a full Token and should not be treated as one. Instead it is a
     * way of getting specific access to parts of the Token data.
     *
