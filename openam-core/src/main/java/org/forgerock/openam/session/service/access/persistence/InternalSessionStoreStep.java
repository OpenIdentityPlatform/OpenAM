...
/**
 * A step in persisting a session. Each method has access to a following step to continue if necessary.
 *
 */
public interface InternalSessionStoreStep {
    /**
     ...
     */
    InternalSession getBySessionID(SessionID sessionID, InternalSessionStore next) throws SessionPersistenceException;
     ...
     * @return an Internal Session
     */
    InternalSession getByHandle(String sessionHandle, InternalSessionStore next) throws SessionPersistenceException;
     ...
     */
    InternalSession getByRestrictedID(SessionID sessionID, InternalSessionStore next) throws SessionPersistenceException;
     ...
     * @exception SessionPersistenceException If the storage operation failed.
     */
    void create(InternalSession session, InternalSessionStore next) throws SessionPersistenceException;

    void update(InternalSession session, InternalSessionStore next) throws SessionPersistenceException;
