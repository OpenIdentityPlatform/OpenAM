...
public class SMSConnectionModule extends LdapDataLayerConnectionModule {

    public SMSConnectionModule() {
        super(null, false);
    }

    @Override
    protected Class<? extends LdapDataLayerConfiguration> getLdapConfigurationType() {
        return SMSDataLayerConfiguration.class;
    }

    @Override
    protected void configureTaskExecutor(PrivateBinder binder) {
        // No-op - don't need this for the SMS data layer.
    }
}
