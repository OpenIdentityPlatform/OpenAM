 ...
 * } </pre>
 *
 * <h2><a id="dataprovider"></a>DataProvider</h2>
 ...
 * <code>large data sets</code> use a {@link PagingDataProvider}
 * instead. See the section <a href="#large-datasets">large data sets</a> for
 * details.
 *
 * <h2><a id="resources"></a>CSS and JavaScript resources</h2>
 *
 ...
 * &lt;/html&gt; </pre>
 *
 * <h2><a id="styles"></a>Table Styles</h2>
 *
 ...
 *
 * <h2><a id="sorting"></a>Sorting</h2>
 * Table also has built in column sorting.
 * <p>
 * To enable/disable sorting use {@link #setSortable(boolean)}.
 *
 * <h2><a id="custom-parameters"></a>Custom Parameters - preserve state when paging and sorting</h2>
 *
 ...
 * } </pre>
 *
 * <h2><a id="row-attributes"></a>Row Attributes</h2>
 *
 ...
 *
 * <h2><a id="large-datasets"></a>Large Datasets</h2>
 *
