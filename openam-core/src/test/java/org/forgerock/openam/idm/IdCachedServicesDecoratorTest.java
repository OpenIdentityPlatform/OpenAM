...
public class IdCachedServicesDecoratorTest {

    private IdCachedServices mockDelegate;
    private IdCachedServicesDecorator decorator;

    @BeforeMethod
    public void setupMocks() {
        mockDelegate = mock(IdCachedServices.class);
        decorator = new IdCachedServicesDecorator(mockDelegate);
    }
    ...
    public Iterator<Object[]> getIdServicesMethods() {
        return getDeclaredMethods(IdCachedServices.class);
    }
