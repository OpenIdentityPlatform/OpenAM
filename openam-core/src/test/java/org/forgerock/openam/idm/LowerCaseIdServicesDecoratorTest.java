...
public class LowerCaseIdServicesDecoratorTest {
    ...
    private LowerCaseIdServicesDecorator decorator;

    @BeforeMethod
    public void setupMocks() {
        mockDelegate = mock(IdServices.class);
        decorator = new LowerCaseIdServicesDecorator(mockDelegate);
    }

    @Test(expectedExceptions = NullPointerException.class)
    public void shouldRejectNullDelegate() {
        new LowerCaseIdServicesDecorator(null);
    }
