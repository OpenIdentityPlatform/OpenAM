...
public class LdapFilterConversionTest {
    ...
    public void shouldCreateAndFilter() {
        new LdapFilterConversion(mockFactory).convert(new TokenFilterBuilder().and().build());
        verify(mockAndBuilder).build();
    }

    @Test
    public void shouldCreateOrFilter() {
        new LdapFilterConversion(mockFactory).convert(new TokenFilterBuilder().or().build());
    ...
    public void shouldIncludeAttributes() {
        ...
        // When
        new LdapFilterConversion(mockFactory).convert(tokenFilter);
