...
public class IdentityRestServiceTest {
    ...
    public void setUp() {
        ...
        identityRestService = new IdentityRestService(restAuthenticationHandler) {
            @Override
    ...
    public void shouldInitiateAuthenticationViaGET() {
        ...
        //When
        Response resp = identityRestService.authenticate(headers, request, response, authIndexType, authIndexValue);
