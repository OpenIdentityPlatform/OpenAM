...
public class TokenInfoServiceImpl implements TokenInfoService {
    ...
    /**
     * Since the token info request is realm agnostic the token realm needs to be set
     * on the request to check if the client to which token is issued still exists
     *
     * {@inheritDoc}
     */
     ...
     */
    private void assertTokenIsValid(TokenState headerToken, TokenState queryToken) throws InvalidTokenException {
     ...
     */
    private void ensureSingleTokenInRequest(TokenState headerToken, TokenState queryToken) throws InvalidRequestException {
        if (headerToken.isValid() && queryToken.isValid()) {
