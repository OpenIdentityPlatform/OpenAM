...
public class ScriptedConfigurator  implements ServiceListener {
    ...
    public static final String SCRIPT_EVALUATOR_NAME = "OIDCClaimsScriptEvaluator";
    public static final String ATTR_NAME_PREFIX = "forgerock-oauth2-provider-oidc-script-";
        ...
        if (!initialised) {
            ...
            try {
                ...
                final ServiceConfigManager serviceConfigManager =
                        new ServiceConfigManager(adminToken, OAuth2Constants.OAuth2ProviderService.NAME,
    ...
    public void globalConfigChanged(final String serviceName, final String version, final String groupName,
        ...
        if (!(OAuth2Constants.OAuth2ProviderService.NAME.equals(serviceName)
    ...
    private void updateConfig() {
        ...
        final Map<String, Set<String>> config = AuthUtils.getGlobalAttributes(
