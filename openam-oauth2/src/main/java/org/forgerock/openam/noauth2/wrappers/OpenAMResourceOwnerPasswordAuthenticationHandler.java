 ...
 * @since 12.0.0
 */
public class OpenAMResourceOwnerPasswordAuthenticationHandler implements ResourceOwnerPasswordAuthenticationHandler {
    ...
    public OpenAMResourceOwnerPasswordAuthenticationHandler(final String username, final char[] password,
            final String realm, final HttpServletRequest request) {
    ...
    public boolean equals(Object o) {
        ...
        OpenAMResourceOwnerPasswordAuthenticationHandler that = (OpenAMResourceOwnerPasswordAuthenticationHandler) o;
    ...
    public ResourceOwner authenticate() {
