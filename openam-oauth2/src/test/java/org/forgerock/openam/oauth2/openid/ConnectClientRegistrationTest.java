...
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.APPLICATION_TYPE;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_DESCRIPTION;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_ID;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_NAME;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_SECRET;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_SESSION_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_TYPE;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CLIENT_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.CONTACTS;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.DEFAULT_ACR_VALUES;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.DEFAULT_MAX_AGE;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.DEFAULT_SCOPES;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.DISPLAY_NAME;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.GRANT_TYPES;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.ID_TOKEN_ENCRYPTED_RESONSE_ENC;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.ID_TOKEN_ENCRYPTED_RESPONSE_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.ID_TOKEN_SIGNED_RESPONSE_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.INITIATE_LOGIN_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.JWKS;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.JWKS_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.LOGO_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.POLICY_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.POST_LOGOUT_REDIRECT_URIS;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REALM;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REDIRECT_URIS;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REGISTRATION_ACCESS_TOKEN;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REQUEST_OBJECT_ENCRYPTION_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REQUEST_OBJECT_ENCRYPTION_ENC;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REQUEST_OBJECT_SIGNING_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REQUEST_URIS;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.REQUIRE_AUTH_TIME;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.RESPONSE_TYPES;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.SCOPES;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.SECTOR_IDENTIFIER_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.SUBJECT_TYPE;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.TOKEN_ENDPOINT_AUTH_METHOD;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.TOKEN_ENDPOINT_AUTH_SIGNING_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.TOS_URI;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.USERINFO_ENCRYPTED_RESONSE_ENC;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.USERINFO_ENCRYPTED_RESPONSE_ALG;
import static com.sun.identity.shared.OAuth2Constants.ShortClientAttributeNames.USERINFO_SIGNED_RESPONSE_ALG;
...
@PrepareForTest({OAuth2Utils.class, ChallengeResponse.class, OpenAMClientDAO.class, SSOToken.class})
public class ConnectClientRegistrationTest extends PowerMockTestCase {
    ...
    public void testShouldCreateClient() throws IOException {
        ...
        //given
        OAuth2ConfigurationFactory configurationFactory = Mockito.mock(OAuth2ConfigurationFactory.class);
        ...
        PowerMockito.when(AccessController.doPrivileged(Matchers.any(AdminTokenAction.class))).thenReturn(token);
        ...
        PowerMockito.when(representation.getMediaType()).thenReturn(MediaType.APPLICATION_JSON);

        BDDMockito.given(configurationFactory.newClientDAO(Matchers.anyString(), Matchers.<Request>anyObject(), Matchers.anyObject()))
                .willReturn(openAMClientDAO);
        PowerMockito.doNothing().when(openAMClientDAO).create(Matchers.any(Client.class));
        ...
        when(OAuth2Utils.getRealm(Matchers.any(Request.class))).thenReturn("/");
        BDDMockito.given(configurationFactory.getOAuth2ProviderSettings(Matchers.<Request>anyObject()))
                .willReturn(oAuth2ProviderSettings);

        PowerMockito.when(request.getChallengeResponse()).thenReturn(challengeResponse);
        PowerMockito.when(challengeResponse.getRawValue()).thenReturn("ACCESS_TOKEN");
