...
public class OpenAMClientDAOTest extends PowerMockTestCase {
    ...
    public void testShouldCreateAClientInTheRepository() {
        ...
        try {
            ...
            PowerMockito.when(AMIdentityRepositoryFactory.createAMIdentityRepository(any(SSOToken.class), anyString()))
                    .thenReturn(amIdentityRepository);
            PowerMockito.when(amIdentityRepository.createIdentity(any(IdType.class), anyString(), attributeCaptor.capture()))
    ...
    public void testShouldReadAClientFromTheRepository() {
        ...
        try {
            ...
            PowerMockito.when(AMIdentityRepositoryFactory.createAMIdentityRepository(any(SSOToken.class), anyString()))
                    .thenReturn(amIdentityRepository);
            PowerMockito.when(amIdentityRepository.searchIdentities(any(IdType.class), anyString(), any(IdSearchControl.class)))
                    .thenReturn(searchResults);
            PowerMockito.when(searchResults.getSearchResults()).thenReturn(resultSet);
            PowerMockito.when(amIdentity.getAttributes()).thenReturn(attributeMap);
            PowerMockito.when(amIdentity.isActive()).thenReturn(true);
        } catch (Exception e) {
            throw new TestException("FAIL", e);
        }
