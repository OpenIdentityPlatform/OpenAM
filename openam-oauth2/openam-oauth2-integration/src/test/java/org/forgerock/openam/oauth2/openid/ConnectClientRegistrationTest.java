...
public class ConnectClientRegistrationTest extends PowerMockTestCase {
    ...
    public void testShouldCreateClient() throws IOException {
        ...
        given(configurationFactory.newClientDAO(anyString(), Matchers.<Request>anyObject(), anyObject()))
        ...
        given(configurationFactory.getOAuth2ProviderSettings(Matchers.<Request>anyObject()))
