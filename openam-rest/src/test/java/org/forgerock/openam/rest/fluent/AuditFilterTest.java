...
public class AuditFilterTest {
    ...
    private RequestHandler filterChain;
    ...
    protected void setUp() throws Exception {
        ...
        AuditEventFactory auditEventFactory = mockAuditEventFactory();
        auditFilter = new AuditFilter(mockDebug, auditEventPublisher, auditEventFactory);
    ...
    @DataProvider(name = "filteredCrudpaqOperations")
    public Object[][] filteredCrudpaqOperations() throws IllegalAccessException, InstantiationException {
        return new Object[][] {
                {new Runnable() {
                    @Override
                    public void run() {
    ...
    public void publishesAccessAndSuccessAuditEventsForSuccessfulReadRequests(Runnable filteredOp) throws Exception {
        // Given
    ...
    @Test(dataProvider = "filteredCrudpaqOperations")
    public void publishesAccessAndFailureAuditEventsForUnsuccessfulReadRequests(Runnable filteredOp) throws Exception {
        // Given
        givenAccessAuditingEnabled();
    ...
    private ServerContext fakeServerContext() throws Exception {
