...
public class PolicyGraphTest {
    ...
    private static final List<Resource> VALID_POLICIES = asList(
    ...
    private PolicyGraph makePolicyGraph(List<Resource> policies) {
        PolicyGraph graph = new PolicyGraph(RESOURCE_SET);
    ...
    private static Resource makePolicy(String owner, String subject, boolean active, String... scopes) {
        ...
        return new Resource(policyId, String.valueOf(policyId.hashCode()), policy);
    }

    private static List<Resource> excludePolicies(String owner, String subject) {
        List<Resource> resources = new ArrayList<>(VALID_POLICIES);
