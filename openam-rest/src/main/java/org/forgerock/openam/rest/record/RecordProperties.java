...
public class RecordProperties {
    ...
    public boolean equals(Object o) {
        ...
        if (autoStopEnable != that.autoStopEnable) {
            return false;
        }
        if (autoStopFileSizeEnable != that.autoStopFileSizeEnable) {
            return false;
        }
        if (autoStopFileSizedInKB != that.autoStopFileSizedInKB) {
            return false;
        }
        if (autoStopTimeEnable != that.autoStopTimeEnable) {
            return false;
        }
        if (autoStopTimeInMS != that.autoStopTimeInMS) {
            return false;
        }
        if (configExportEnable != that.configExportEnable) {
            return false;
        }
        if (configExportSharePassword != that.configExportSharePassword) {
            return false;
        }
        if (issueID != that.issueID) {
            return false;
        }
        if (threadDumpDelayInSeconds != that.threadDumpDelayInSeconds) {
            return false;
        }
        if (threadDumpEnable != that.threadDumpEnable) {
            return false;
        }
        if (zipEnable != that.zipEnable) {
            return false;
        }
        if (configExportPassword != null ? !configExportPassword.equals(that.configExportPassword) : that
                .configExportPassword != null) {
            return false;
        }
        if (debugLevel != that.debugLevel) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (zipEnable ? 1 : 0);
        result = 31 * result + (threadDumpEnable ? 1 : 0);
        result = 31 * result + (int) (threadDumpDelayInSeconds ^ (threadDumpDelayInSeconds >>> 32));
        result = 31 * result + (configExportEnable ? 1 : 0);
        result = 31 * result + (configExportPassword != null ? configExportPassword.hashCode() : 0);
        result = 31 * result + (configExportSharePassword ? 1 : 0);
        result = 31 * result + (debugLevel != null ? debugLevel.hashCode() : 0);
        result = 31 * result + (autoStopEnable ? 1 : 0);
        result = 31 * result + (autoStopTimeEnable ? 1 : 0);
        result = 31 * result + (int) (autoStopTimeInMS ^ (autoStopTimeInMS >>> 32));
        result = 31 * result + (autoStopFileSizeEnable ? 1 : 0);
        result = 31 * result + (int) (autoStopFileSizedInKB ^ (autoStopFileSizedInKB >>> 32));
        return result;
    }
}
