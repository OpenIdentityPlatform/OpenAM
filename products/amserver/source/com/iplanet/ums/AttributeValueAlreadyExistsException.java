 ...
 *
 * $Id: AttributeValueAlreadyExistsException.java,v 1.2 2008/06/25 05:41:44 qcheng Exp $
 *
 */
...
public class AttributeValueAlreadyExistsException extends UMSException {
     ...
     */
    public AttributeValueAlreadyExistsException(String msg) {
        super(msg);
    }
     ...
     */
    public AttributeValueAlreadyExistsException(String msg, Throwable t) {
        super(msg, t);
    }
