<%--
   ...
   $Id: ReferralEdit.jsp,v 1.3 2008/06/25 05:44:44 qcheng Exp $

--%>



<%@ page info="ReferralEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.ReferralEditViewBean"
...
<cc:form name="ReferralEdit" method="post" defaultCommandChild="/btnFilter">
