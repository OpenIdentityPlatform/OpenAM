<%--
   ...
   $Id: PolicyReferralEdit.jsp,v 1.2 2008/06/25 05:44:43 qcheng Exp $

--%>



<%@ page info="PolicyReferralEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.PolicyReferralEditViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('PolicyReferralEdit',
	    'PolicyReferralEdit.' + tblName,
	    counterName, 'PolicyReferralEdit.' + btn, trigger);
    }
</script>

<cc:form name="PolicyReferralEdit" method="post" defaultCommandChild="/button1">
<script language="javascript">
