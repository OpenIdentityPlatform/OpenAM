<%--
   ...
   $Id: NewGroupContainer.jsp,v 1.4 2008/06/25 05:44:38 qcheng Exp $

--%>

<%@ page info="NewGroupContainer" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.NewGroupContainerViewBean"
...
<cc:form name="NewGroupContainer" method="post" defaultCommandChild="/button1">
...
<cc:pagetitle name="pgtitleTwoBtns" 
    bundleID="amConsole" 
    pageTitleText="page.title.group.container.create" 
