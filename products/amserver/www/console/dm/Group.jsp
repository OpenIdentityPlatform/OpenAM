<%--
   ...
   $Id: Group.jsp,v 1.5 2008/07/22 21:39:08 babysunil Exp $

--%>

<%@ page info="Group" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.dm.GroupViewBean"
...
<cc:form name="Group" method="post" defaultCommandChild="/btnSearch">
...
<cc:pagetitle name="pgtitle" 
    bundleID="amConsole" 
    pageTitleText="page.title.groups" 
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><cc:button name="btnSearch" bundleID="amConsole" defaultValue="button.search" type="primary" onClick="document.forms['Group'].submit();" /></td>
    </tr>
</table>
...
<cc:actiontable
    name="tblSearch"
    title="table.group.title.name"
    bundleID="amConsole"
    summary="table.group.summary"
    empty="table.group.empty.message"
    ...
    selectionJavascript="toggleTblButtonState('Group', 'Group.tblSearch', 'tblButton', 'Group.tblButtonDelete', this)"
