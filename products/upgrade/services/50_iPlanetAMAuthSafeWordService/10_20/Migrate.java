 ...
 *
 * $Id: Migrate.java,v 1.2 2008/06/25 05:53:31 qcheng Exp $
 *
 */
...
/**
 * Updates <code>iPlanetAMAuthSafeWordService</code> service schema.
...
public class Migrate implements MigrateTasks {
    ...
    final static String SERVICE_NAME = "iPlanetAMAuthSafeWordService";
    final static String SERVICE_DIR = "50_iPlanetAMAuthSafeWordService/10_20";
    final static String SCHEMA_FILE1 = "amAuthSafeWord_del.xml";
    final static String SCHEMA_FILE2 = "amAuthSafeWord_add.xml";

    /**
     * Updates the <code>iPlanetAMAuthSafeWordService<code> service schema.
     *
