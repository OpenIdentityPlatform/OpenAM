<%--
   ...
   $Id: RealmResourceOfferingEdit.jsp,v 1.2 2008/06/25 05:50:26 qcheng Exp $
--%>


<%@ page info="RealmResourceOfferingEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.realm.RealmResourceOfferingEditViewBean"
...
<script language="javascript">
	...
	toggleTblButtonState('RealmResourceOfferingEdit',
	    'RealmResourceOfferingEdit.SecurityMechID',
	    'securityMechIDCount',
	    'RealmResourceOfferingEdit.tblSecurityMechIDButtonDelete',
	    obj);
    }
</script>

<cc:form name="RealmResourceOfferingEdit" method="post" defaultCommandChild="/button1" >
