 ...
 *
 * $Id: WscCreateWizardStep5Validator.java,v 1.1 2009/10/16 19:39:23 ggennaro Exp $
 */
...
public class WscCreateWizardStep5Validator 
        extends WscCreateWizardStepValidator
{
    public WscCreateWizardStep5Validator(WizardBean wb) {
        super(wb);
    }
    ...
    private boolean validNameIdMapper() {
        ...
        WscProfileBean profileBean = wizardBean.getWscProfileBean();
