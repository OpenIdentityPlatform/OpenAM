 ...
 */
public class ConfigureGoogleAppsWarningViewBean
    extends AMPrimaryMastHeadViewBean
{
    public static final String DEFAULT_DISPLAY_URL =
        "/console/task/ConfigureGoogleAppsWarning.jsp";
    
    public ConfigureGoogleAppsWarningViewBean() {
        super("ConfigureGoogleAppsWarning");
