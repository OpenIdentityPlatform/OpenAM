...
#define AM_COMMON_USE_REDIRECT_FOR_ADVICE AM_COMMON_PROPERTY_PREFIX "use_redirect_for_advice"
#define AM_COMMON_REMOVE_SUNWMETHOD AM_COMMON_PROPERTY_PREFIX "remove_sunwmethod"
