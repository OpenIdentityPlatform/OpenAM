 ...
 *
 * $Id: ConfigFinder.java,v 1.1 2007/04/30 17:29:26 subbae Exp $
 *
...
/**
 * Displays default Apache 22 server instance's config directory.
 */
public class ConfigFinder implements IDefaultValueFinder,
    ...
    private String getDefaultConfigDirectoryPath(IStateAccess state) {
        ...
        if (OSChecker.isWindows()) {
            result = STR_APC22_CONFIG_DIR_WINDOWS;
        } else {
            result = STR_APC22_CONFIG_DIR_UNIX;
        }
        return result;
    }
}
