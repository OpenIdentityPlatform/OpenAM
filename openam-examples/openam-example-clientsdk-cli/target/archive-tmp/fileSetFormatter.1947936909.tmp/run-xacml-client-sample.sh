...
java -classpath resources:lib/openam-clientsdk-10.2.0-SNAPSHOT.jar:lib/servlet-api-2.5.jar:lib/openam-example-clientsdk-cli-10.2.0-SNAPSHOT.jar:lib/jaxb-impl-1.0.6.jar:lib/jaxb-libs-1.0.6.jar samples.xacml.XACMLClientSample xacmlClientSample
