...
public enum ModificationEventType implements EventType {
     ...
     * @return Whether the type is an modification event type.
     */
     ...
     *         The path index.
     * @param realm
     *         The realm for which the path index is associated.
     * @return An event representing the selected type.
     */
    public IndexChangeEvent createEvent(String pathIndex, String realm) {
        return new ModificationEvent(pathIndex, realm, this);
    }
