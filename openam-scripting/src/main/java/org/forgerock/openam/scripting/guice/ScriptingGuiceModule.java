...
public class ScriptingGuiceModule extends AbstractModule {
     ...
     */
    @Provides @Singleton
    ScriptEngineManager getScriptEngineManager(RhinoScriptEngineFactory rhinoScriptEngineFactory) {
        final ScriptEngineManager manager = new ScriptEngineManager();

        manager.registerEngineName(SupportedScriptingLanguage.JAVASCRIPT_ENGINE_NAME, rhinoScriptEngineFactory);
